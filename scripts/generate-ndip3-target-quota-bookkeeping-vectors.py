...
COUNTER_MAX = 2 + 3 + IDENTITY_MAX + 3 + USAGE_MAX + 11 + 4 + MUTATION_MAX + 34 + 11
TOTAL_MAX = 2 + 3 + SCOPE_MAX + 3 + USAGE_MAX + 11 + 4 + MUTATION_MAX + 34 + 11
AGGREGATE_MAX = 2 + 22 + 18 + 3 + USAGE_MAX + 11 + 4 + MUTATION_MAX + 34 + 11
