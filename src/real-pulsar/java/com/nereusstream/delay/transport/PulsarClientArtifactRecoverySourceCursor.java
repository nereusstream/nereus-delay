 ...
 */
public final class PulsarClientArtifactRecoverySourceCursor implements Iterator<SourceReplayEntry>, AutoCloseable {
    ...
    public PulsarClientArtifactRecoverySourceCursor(
        ...
        if (assignment.shardId().partition() < 0
                || !physicalTopic.equals(barrier.physicalTopic())
    ...
    public synchronized boolean hasNext() {
        ...
        try {
            ...
            current = PulsarClientArtifactSourceRecordConsumer.decodeReplayRecord(
                    message,
                    assignment.shardId(),
                    physicalTopic,
                    after.attestation(),
