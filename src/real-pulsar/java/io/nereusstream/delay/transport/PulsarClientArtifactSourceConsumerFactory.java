...
public final class PulsarClientArtifactSourceConsumerFactory {
    ...
    public static GuardedConsumer<byte[]> create(final PulsarClient client, final TopicResourceGuard guard,
                                                  final String physicalTopic, final String subscriptionName)
