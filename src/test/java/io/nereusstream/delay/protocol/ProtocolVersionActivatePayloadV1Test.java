...
class ProtocolVersionActivatePayloadV1Test {
    ...
    void roundTripsTupleAndBothAuthorityHashes() {
        final ProtocolVersionActivatePayloadV1 payload = new ProtocolVersionActivatePayloadV1(
                ProtocolTupleV1.managedCommandV1(), Bytes.sha256(Bytes.utf8("schema")),
        ...
        assertArrayEquals(Bytes.sha256(Bytes.utf8("eligible-readers")),
    ...
    void rejectsWrongHashLengthAndNonCanonicalFieldOrder() {
        assertThrows(IllegalArgumentException.class,
                () -> new ProtocolVersionActivatePayloadV1(ProtocolTupleV1.managedCommandV1(),
    ...
    private static byte[] controlBody(final ShardId shard, final ControlRef controlRef,
        ...
        final byte[] controlPayload = CanonicalProtobuf.message(output ->
                CanonicalProtobuf.bytes(output, 1, payload.canonicalBytes()));
