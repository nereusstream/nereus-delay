...
class RecoveryCandidateRefV1Test {
    ...
    void enforcesBranchAndDigestRules() {
        assertThrows(IllegalArgumentException.class, () -> new RecoveryCandidateRefV1(
                RecoveryCandidateKindV1.LOCAL_STORE, bytes(16, 1), bytes(16, 2), bytes(32, 3), null));
        assertThrows(IllegalArgumentException.class, () -> new RecoveryCandidateRefV1(
                RecoveryCandidateKindV1.CATALOG_CHECKPOINT, bytes(16, 1), bytes(16, 2), bytes(32, 3), bytes(16, 4)));
