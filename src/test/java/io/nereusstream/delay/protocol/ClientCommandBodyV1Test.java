...
class ClientCommandBodyV1Test {
    ...
    void prepareBodyRoundTripsAndRejectsWrongPayloadPresence() {
        ...
        final ScheduleIntentV1 intent = ScheduleIntentV1.forPrepare(destination(), retryPolicy(), 10, 100,
    ...
    void ordinaryScheduleCannotUsePrepareWithoutPayload() {
        ...
        final ScheduleIntentV1 prepare = ScheduleIntentV1.forPrepare(destination(), retryPolicy(), 1, 2,
