...
class ReadyCertificateV1Test {
    ...
    private static byte[] rewriteGuardGenerations(final byte[] encoded, final long brokerGeneration,
    ...
    private static byte[] rewriteNestedField(final byte[] encoded, final int fieldNumber,
