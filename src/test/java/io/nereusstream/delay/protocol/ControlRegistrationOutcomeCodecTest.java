...
class ControlRegistrationOutcomeCodecTest {
    ...
    void roundTripsAllRegistrationOutcomeBranches() {
        ...
        final ControlNonPersistenceProofV1 conditional = ControlNonPersistenceProofV1.create(
                ControlNonPersistenceProofKindV1.OXIA_CONDITIONAL_REJECTION, operationId, preparedDigest,
                bytes(32, 3), bytes(32, 4));
        final ControlDefinitelyNotRecordedV1 rejected = new ControlDefinitelyNotRecordedV1(preparedDigest, before,
                error);
        final ControlRecordUncertainV1 uncertain = new ControlRecordUncertainV1(operationId, preparedDigest,
                StableErrorV1.of(FailureStageV1.CONTROL, StableCode.SHARD_UNAVAILABLE, null, null, null, null));
        final ControlOperationReceiptV1 receipt = ControlOperationReceiptV1.create(operationId, bytes(32, 5),
                bytes(32, 6), bytes(32, 7), 1, trustedTime(), 2_000);
        ...
        assertEquals(ControlRegistrationOutcomeMessageV1.recorded(receipt),
                ControlRegistrationOutcomeMessageV1.decode(ControlRegistrationOutcomeMessageV1.recorded(receipt)
                        .canonicalBytes()));
        assertEquals(ControlRegistrationOutcomeMessageV1.definitelyNotRecorded(rejected),
                ControlRegistrationOutcomeMessageV1.decode(
                        ControlRegistrationOutcomeMessageV1.definitelyNotRecorded(rejected).canonicalBytes()));
        assertEquals(ControlRegistrationOutcomeMessageV1.recordUncertain(uncertain),
                ControlRegistrationOutcomeMessageV1.decode(
                        ControlRegistrationOutcomeMessageV1.recordUncertain(uncertain).canonicalBytes()));
    }

    @Test
    void rejectsIllegalProofEvidenceAndBranchMismatch() {
        assertThrows(IllegalArgumentException.class, () -> ControlNonPersistenceProofV1.create(
                ControlNonPersistenceProofKindV1.BEFORE_OXIA_OWNERSHIP, bytes(32, 1), bytes(32, 2),
                bytes(32, 3), null));
        assertThrows(IllegalArgumentException.class, () -> ControlNonPersistenceProofV1.create(
                ControlNonPersistenceProofKindV1.OXIA_CONDITIONAL_REJECTION, bytes(32, 1), bytes(32, 2),
                null, bytes(32, 4)));
        ...
        assertThrows(IllegalArgumentException.class, () -> new ControlDefinitelyNotRecordedV1(bytes(32, 7), proof,
                StableErrorV1.of(FailureStageV1.CONTROL, StableCode.UNAUTHORIZED, null, null, null, null)));
        final ControlRecordUncertainV1 uncertain = new ControlRecordUncertainV1(bytes(32, 8), bytes(32, 9),
                StableErrorV1.of(FailureStageV1.CONTROL, StableCode.SHARD_UNAVAILABLE, null, null, null, null));
        ...
        assertThrows(IllegalArgumentException.class,
                () -> ControlRegistrationOutcomeMessageV1.decode(wrongBranch));
    }
