...
class RemainingClientCommandBodyV1Test {
    ...
    void preconditionPresenceIsIndependentAndBodiesRoundTrip() {
        ...
        assertEquals(reschedule, CommandBodies.decodeRescheduleV1(
                CommandBodies.rescheduleV1(messageId, 100, both, 20, 40)));
    }

    @Test
    void rejectsInvalidPresenceTimingAndCanonicalBytes() {
        assertThrows(IllegalArgumentException.class, () -> MessagePreconditionV1.decode(
        ...
        final byte[] badCancel = new CancelCommandBodyV1(messageId, 100, new MessagePreconditionV1(null, null))
                .canonicalBytes();
        badCancel[2] = 3;
