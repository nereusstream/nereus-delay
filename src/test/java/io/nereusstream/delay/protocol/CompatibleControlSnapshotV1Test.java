...
class CompatibleControlSnapshotV1Test {
    ...
    void canonicalSnapshotRoundTripsAndSortsReferences() {
        ...
        final CompatibleControlSnapshotV1 snapshot = new CompatibleControlSnapshotV1(
                ...
                List.of(new ProtocolTupleV1(1, 1, ProtocolTupleV1.SYSTEM_MUTATION, 1, 1),
    ...
    void rejectsDuplicateReferencesShardMismatchAndDigestTampering() {
        ...
        final QuotaGrantRefV1 grant = new QuotaGrantRefV1(bytes(32, 5), 1,
        ...
        final byte[] tampered = new CompatibleControlSnapshotV1(shard, List.of(tuple), List.of(profile), grant)
                .canonicalBytes();
