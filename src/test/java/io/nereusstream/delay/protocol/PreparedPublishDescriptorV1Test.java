...
class PreparedPublishDescriptorV1Test {
    ...
    void admissionDescriptorExposesTheExactTypedProjection() {
        ...
        assertArrayEquals(Bytes.sha256(Bytes.utf8("nereus-delay-prepared-publish-v1\0"), fixture.descriptor()),
    ...
    void reservedMetadataCannotBeRelabeledToAnotherShard() {
        ...
        final ReservedPublishMetadataV1 wrongShard = new ReservedPublishMetadataV1(
                RouteIncarnation.random(), reserved.shardPartition(), reserved.messageId(), reserved.generation(),
                reserved.publishAttemptId(), reserved.destinationProfileSemanticHash(),
                reserved.capabilityProfileSemanticHash(), reserved.deliverAtEpochMs(), reserved.deliveryMode());

        assertThrows(IllegalArgumentException.class, () -> new PreparedPublishDescriptorV1(
                descriptor.adapterKind(), descriptor.destinationLaneId(), descriptor.laneIncarnation(),
                descriptor.destinationProfile(), descriptor.capabilityProfile(), descriptor.targetResource(),
                descriptor.physicalPartition(), descriptor.channel(), descriptor.messageId(), descriptor.generation(),
                descriptor.publishAttemptId(), descriptor.attemptNo(), descriptor.payload(),
                descriptor.businessMetadata(), wrongShard, descriptor.deliverAtEpochMs(), descriptor.expireAtEpochMs(),
