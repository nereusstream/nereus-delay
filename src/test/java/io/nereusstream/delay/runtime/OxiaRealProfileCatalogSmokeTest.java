...
class OxiaRealProfileCatalogSmokeTest {
    ...
    void profileHeadProtectionLeaseAndRotationReopenAgainstRealService() throws Exception {
        ...
        try (OxiaSyncOwnerLeaseBackend.ClientHandle client = connect(endpoint, prefix + "/client")) {
            ...
            assertEquals(6_000, backend.resolveProtection(fixture.profile().ref(), 1)
            ...
            final CredentialUseLeaseV1 shorterLease = reopened.issueCredentialUseLease(fixture.profile().ref(),
                    CredentialUseKindV1.OBJECT_STORE_ADAPTER, id32(30), 1, fixture.binding().bindingDigest(),
                    fixture.fingerprint(), evidence(2_000), 5_000, 1);
            assertEquals(5_000, shorterLease.validUntilEpochMs());
            assertEquals(lease.protectionRevision(), shorterLease.protectionRevision());

            final CredentialBindingV1 nextBinding = binding(fixture.profile(), 2,
                    Bytes.utf8("secret://real-object/v2"), fixture.keyPair());
            final RotateEquivalentSecretRequestV1 rotation = new RotateEquivalentSecretRequestV1(
                    fixture.profile().ref(), 1, 2, Bytes.utf8("secret://real-object/v2"),
                    Bytes.sha256(Bytes.utf8("secret://real-object/v2")), nextBinding.equivalenceAttestation(),
    ...
    private static Fixture fixture() throws Exception {
        final ObjectStoreProfileSemanticV1 semantic = new ObjectStoreProfileSemanticV1(
                ObjectStoreProviderKindV1.S3_COMPATIBLE, id32(1), id32(2), 1,
                true, true, true, true, id32(3), 1 << 20,
                ObjectStoreProfileSemanticV1.SINGLE_PUT, 1, id32(4));
        final ProfileSemanticEnvelopeV1 profile = new ProfileSemanticEnvelopeV1(
                ProfileKindV1.OBJECT_STORE, Bytes.utf8("real-object-store"), 1, semantic);
        ...
        final CredentialEquivalenceAttestationV1 attestation = CredentialEquivalenceAttestationV1.signed(
                ...
                fingerprint, 1, Bytes.utf8("real-verifier"), evidence(1_000), 10_000, id32(6), 1,
                keyPair.getPrivate());
    ...
    private static CredentialBindingV1 binding(final ProfileSemanticEnvelopeV1 profile, final long generation,
        ...
        final CredentialEquivalenceAttestationV1 attestation = CredentialEquivalenceAttestationV1.signed(
                ...
                id32(5 + (int) generation), 1, Bytes.utf8("real-verifier"), evidence(1_000), 10_000,
                id32(7 + (int) generation), 1, keyPair.getPrivate());
