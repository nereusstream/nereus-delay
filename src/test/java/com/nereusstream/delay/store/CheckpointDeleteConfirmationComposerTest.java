...
class CheckpointDeleteConfirmationComposerTest {
    ...
    void composesSignedDeletedConfirmationFromExactProviderReceipt() throws Exception {
        ...
        final SystemMutation mutation = CheckpointDeleteConfirmationComposer.compose(
                fixture.intent(),
                new CheckpointDeleteResult(
                        fixture.resource(), ResourceDeleteConfirmedBody.DeleteOutcome.DELETED, id32(7), id32(8)),
                observedAt,
                confirmedAt,
                9_000,
        ...
        assertArrayEquals(
                observedAt.canonicalBytes(), body.evidence().observedAt().canonicalBytes());
    ...
    void rejectsProviderIdentityThatDiffersFromRetireIntent() throws Exception {
        ...
        final CheckpointResourceV1 different = new CheckpointResourceV1(
                ...
                fixture.resource().container(),
                Bytes.utf8("checkpoint/other"),
                fixture.resource().immutableVersion(),
                fixture.resource().manifestLength(),
                fixture.resource().manifestSha256());

        assertThrows(
                IllegalArgumentException.class,
                () -> CheckpointDeleteConfirmationComposer.compose(
                        fixture.intent(),
                        new CheckpointDeleteResult(
                                different, ResourceDeleteConfirmedBody.DeleteOutcome.DELETED, id32(11), id32(12)),
                        evidence(3_000, 3_000, "observed"),
                        evidence(3_001, 3_001, "confirmed"),
                        9_000,
                        serviceAuthor().canonicalBytes(),
                        1,
                        keyPair.getPrivate()));
        ...
        assertThrows(
                ...
                () -> CheckpointDeleteConfirmationComposer.compose(
                        ...
                        new CheckpointDeleteResult(
                                ...
                                id32(13),
                                id32(14)),
                        evidence(4_000, 4_010, "observed"),
                        evidence(4_005, 4_006, "confirmed"),
                        9_000,
                        serviceAuthor().canonicalBytes(),
                        1,
                        keyPair.getPrivate()));
    ...
    private static Fixture fixture() {
        ...
        final SourcePosition source = new KafkaSourcePosition(
                shard, "cluster", UUID.fromString("00000000-0000-0000-0000-000000000001"), 12, null, 900);
    ...
    private static TrustedUtcIntervalEvidence evidence(final long earliest, final long latest, final String sourceId) {
