...
class WorkerRuntimeSafetyGateTest {
    ...
    void runtimeShrinkIsStickyUntilAnExplicitEmptyDrainActivation() {
        ...
        assertThrows(IllegalStateException.class, () -> gate.observe(observation(800L * 1024 * 1024)));
        ...
        assertThrows(IllegalStateException.class, () -> gate.activateAfterDrain(1, 0, false, healthy));
    ...
    void stagedEnvelopeRequiresExplicitDrainTransition() {
        ...
        assertThrows(IllegalStateException.class, () -> gate.activateAfterDrain(0, 0, true, healthy));

        assertThrows(IllegalStateException.class, () -> gate.activateAfterDrain(0, 0, false, healthy));
    ...
    void sharedResourcesFenceNewOwnershipAfterRuntimeShrink() {
        ...
        try (SharedRocksDbResources resources = new SharedRocksDbResources(config, envelope, healthy)) {
            assertThrows(
                    IllegalStateException.class, () -> resources.revalidateRuntime(observation(800L * 1024 * 1024)));
