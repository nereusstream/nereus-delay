...
class OxiaSyncCheckpointPublicationBackendTest {
    ...
    void atomicallyBindsPublishedIntentAndCatalogManifest() {
        ...
        assertEquals(
                2, backend.publishUploadedCheckpoint(published, manifest, 1).catalogGeneration());
    ...
    void sessionFenceRejectsACommittedPublicationAfterTheMarkerChanges() {
        ...
        final OxiaSyncCheckpointPublicationBackend backend =
                new OxiaSyncCheckpointPublicationBackend(records, "delay/publication-fenced", LIMITS, () -> {
                    if (!sessionAlive.get()) {
    ...
    void rejectsASecondIntentOrManifestForTheSameAtomicIdentity() {
        ...
        final CheckpointUploadIntent conflicting = new CheckpointUploadIntent(
                ...
                pending.parentCheckpointId(),
                pending.parentManifestSha256(),
    ...
    void sessionFenceRejectsACommittedPublicationRecoveryPinReleaseAfterTheMarkerChanges() {
        ...
        final AtomicBoolean sessionAlive = new AtomicBoolean(true);
        final OxiaSyncCheckpointPublicationBackend fenced = new OxiaSyncCheckpointPublicationBackend(
                records, "delay/fenced-publication-pin-release", LIMITS, () -> {
                    if (!sessionAlive.get()) {
                        throw new IllegalStateException("simulated Oxia session fence");
                    }
                });
    ...
    private static CheckpointManifest parentManifest(final CheckpointUploadIntent pending) {
        ...
        final CheckpointManifest.FileEntry file = new CheckpointManifest.FileEntry(
                "CURRENT", 1, id32(39), Bytes.utf8("object/parent"), Bytes.utf8("version/parent"), null);
        return new CheckpointManifest(
                ...
                new CheckpointManifest.CreatedAt(
                        900, 901, "CERTIFIED_HOST_CLOCK", id32(38), 1, 0, 0, id32(37), 0, null),
                shard,
                id32(36),
                uuid(pending.sourceStoreIncarnation()),
                1,
                0,
                position,
                id32(35),
    ...
    private static CheckpointManifest manifest(final CheckpointUploadIntent pending, final CheckpointManifest parent) {
        ...
        final CheckpointManifest.FileEntry file = new CheckpointManifest.FileEntry(
                "CURRENT", 1, id32(40), Bytes.utf8("object/current"), Bytes.utf8("version/current"), null);
        return new CheckpointManifest(
                pending.checkpointId(),
                pending.recoveryLineageId(),
                1,
                ...
                new CheckpointManifest.CreatedBy(
                        ...
                        pending.owner().ownerEpoch()),
                new CheckpointManifest.CreatedAt(
                        1_000, 1_001, "CERTIFIED_HOST_CLOCK", id32(41), 1, 1, 1, id32(42), 0, null),
                shard,
                id32(43),
                uuid(pending.sourceStoreIncarnation()),
                1,
    ...
    private static final class FakeRecordClient implements OxiaSyncCheckpointPublicationBackend.RecordClient {
        ...
        public PutResult put(final String key, final byte[] value, final Set<PutOption> options)
            ...
            final Version version =
                    new Version(nextVersion++, 0, 0, 1, Optional.of(101L), Optional.of("fake-publication-session"));
