...
class ResourceGcGuardTest {
    ...
    void checkpointGcFailsClosedWhenRecoveryPinStateCannotBeRead() {
        ...
        final RecoveryCatalogAuthority catalog =
                authority(fixture.floor(), null, new UnsupportedOperationException("pin read unavailable"));

        assertEquals(
                ResourceGcGuard.Decision.RECOVERY_PIN_STATE_UNAVAILABLE,
    ...
    void checkpointGcFailsClosedWhenRecoveryPinReadThrowsFatalError() {
        final Fixture fixture = fixture();
        final RecoveryCatalogAuthority catalog =
                authority(fixture.floor(), null, new AssertionError("pin read failed fatally"));
    ...
    void retireIntentRecordRequiresCanonicalProtectionSet() {
        ...
        assertThrows(
                ...
                () -> new ResourceRetireIntentRecord(
                        fixture.intent().mutationId(),
                        fixture.intent().mutationHash(),
                        fixture.intent().resourceKind(),
                        fixture.intent().resourceIdentity(),
                        fixture.intent().resourceIdentityHash(),
                        fixture.intent().expectedResourceStateVersion(),
                        fixture.intent().appliedMutationSequence(),
                        Bytes.utf8("not-a-protection-set"),
                        fixture.intent().appliedSourcePosition()));
    }

    @Test
    void retireIntentRecordRejectsProtectionSourceFromAnotherShard() {
        final Fixture fixture = fixture();
        final ShardId foreignShard =
                new ShardId(RouteIncarnation.random(), fixture.shard().partition());
        assertThrows(
                IllegalArgumentException.class,
                () -> new ResourceRetireIntentRecord(
                        fixture.intent().mutationId(),
                        ...
                        fixture.intent().expectedResourceStateVersion(),
                        fixture.intent().appliedMutationSequence(),
                        protectionSetWithSource(foreignShard),
                        fixture.intent().appliedSourcePosition()));
    }
    ...
    void durableDeletedCheckpointEvidenceCannotOmitPinnedVersion() {
        ...
        assertThrows(
                IllegalArgumentException.class,
                () -> new ResourceDeleteConfirmedRecord(
                        fixture.confirmation().confirmationMutationId(),
                        fixture.confirmation().confirmationMutationHash(),
                        fixture.intent(),
                        com.nereusstream.delay.protocol.ResourceDeleteConfirmedBody.DeleteOutcome.DELETED,
                        fixture.confirmation().appliedMutationSequence(),
                        fixture.confirmation().providerRequestIdHash(),
                        new byte[0],
                        new byte[0],
                        fixture.confirmation().responseHash(),
                        fixture.confirmation().observedAt(),
                        fixture.confirmation().confirmedAt(),
    ...
    void durableDeleteConfirmationRequiresConfirmationAfterObservation() {
        ...
        final TrustedUtcIntervalEvidence observedAt = new TrustedUtcIntervalEvidence(
                ...
                0,
                null);
        final TrustedUtcIntervalEvidence confirmedAt = new TrustedUtcIntervalEvidence(
                1_005,
                1_006,
                TrustedUtcIntervalEvidence.Source.CERTIFIED_HOST_CLOCK,
                Bytes.utf8("confirmed-order"),
                1,
                2,
                1,
                id32(19),
        ...
        assertThrows(
                ...
                () -> new ResourceDeleteConfirmedRecord(
                        ...
                        fixture.confirmation().confirmationMutationHash(),
                        fixture.intent(),
                        fixture.confirmation().outcome(),
                        fixture.confirmation().appliedMutationSequence(),
                        fixture.confirmation().providerRequestIdHash(),
                        fixture.confirmation().observedImmutableVersion(),
                        fixture.confirmation().observedEtag(),
                        fixture.confirmation().responseHash(),
                        observedAt.canonicalBytes(),
                        confirmedAt.canonicalBytes(),
                        fixture.confirmation().appliedSourcePosition()));
    }
    ...
    void deleteConfirmationMustCarryByteIdenticalRetireIntent() {
        ...
        assertEquals(
                ResourceGcGuard.Decision.INTENT_REFERENCE_MISMATCH,
    ...
    void deleteConfirmationSourcePositionMustMatchRetireIntentSource() {
        final Fixture fixture = fixture();
        final KafkaSourcePosition foreignSource = new KafkaSourcePosition(
                fixture.shard(), "cluster", UUID.fromString("00000000-0000-0000-0000-000000000002"), 2, null, 1_002);
        assertThrows(
                IllegalArgumentException.class,
                () -> new ResourceDeleteConfirmedRecord(
                        fixture.confirmation().confirmationMutationId(),
        ...
        final ShardId foreignShard =
                new ShardId(RouteIncarnation.random(), fixture.shard().partition());
        final KafkaSourcePosition foreignShardSource = new KafkaSourcePosition(
                foreignShard, "cluster", UUID.fromString("00000000-0000-0000-0000-000000000001"), 2, null, 1_002);
        assertThrows(
                IllegalArgumentException.class,
                () -> new ResourceDeleteConfirmedRecord(
                        fixture.confirmation().confirmationMutationId(),
    ...
    void checkpointGcRetainsCheckpointPinnedAsCandidateOrObservedFloor() {
        ...
        assertEquals(
                ...
                ResourceGcGuard.evaluate(
                        fixture.intent(),
                        fixture.confirmation(),
                        authority(fixture.floor(), candidatePin, null),
                        fixture.floor().checkpointId()));
        ...
        assertEquals(
                ...
                ResourceGcGuard.evaluate(
                        fixture.intent(),
                        fixture.confirmation(),
                        authority(fixture.floor(), floorPin, null),
                        fixture.floor().checkpointId()));
    }
    ...
    void checkpointGcFailsClosedWhenRecoveryFloorCannotBeRead() {
        ...
        assertEquals(
                ...
                ResourceGcGuard.evaluate(
                        ...
                        fixture.confirmation(),
                        authority(
                                fixture.floor(), null, null, new IllegalStateException("floor read unavailable"), null),
                        fixture.floor().checkpointId()));
    }
    ...
    void checkpointGcFailsClosedWhenRecoveryFloorReadThrowsFatalError() {
        ...
        assertEquals(
                ...
                ResourceGcGuard.evaluate(
                        fixture.intent(),
                        fixture.confirmation(),
                        authority(fixture.floor(), null, null, new AssertionError("floor read failed fatally"), null),
                        fixture.floor().checkpointId()));
    }
    ...
    void checkpointGcFailsClosedWhenFloorCoverageThrowsFatalError() {
        ...
        assertEquals(
                ...
                ResourceGcGuard.evaluate(
                        fixture.intent(),
                        fixture.confirmation(),
                        authority(fixture.floor(), null, null, null, new AssertionError("floor proof failed fatally")),
                        fixture.floor().checkpointId()));
    }
    ...
    private static Fixture fixture() {
        ...
        final ResourceRetireIntentRecord intent = new ResourceRetireIntentRecord(
                ...
                Long.MIN_VALUE,
                Long.MIN_VALUE,
                protectionSet(id32(17)),
                intentPosition.canonicalBytes());
        final TrustedUtcIntervalEvidence evidence = evidence();
        final TrustedUtcIntervalEvidence confirmationEvidence = new TrustedUtcIntervalEvidence(
                1_002,
                1_003,
                TrustedUtcIntervalEvidence.Source.CERTIFIED_HOST_CLOCK,
                Bytes.utf8("confirmation-clock"),
                1,
                2,
                1,
                id32(20),
        ...
        final ResourceDeleteConfirmedRecord confirmation = new ResourceDeleteConfirmedRecord(
                ...
                id32(6),
                intent,
                com.nereusstream.delay.protocol.ResourceDeleteConfirmedBody.DeleteOutcome.ALREADY_ABSENT,
                -1L,
                id32(7),
                new byte[0],
                new byte[0],
                ...
                confirmationEvidence.canonicalBytes(),
                confirmationPosition.canonicalBytes());
        final RecoveryFloor floor =
                RecoveryFloor.create(id16(9), checkpointId, manifestHash, 4, confirmationPosition, -1L, id32(10));
    ...
    private static byte[] checkpointIdentity(final byte[] checkpointId, final byte[] manifestHash) {
        ...
        return CanonicalProtobuf.message(
                output -> CanonicalProtobuf.bytes(output, ResourceKind.CHECKPOINT.wireValue(), branch));
    }
    ...
    private static KafkaSourcePosition position(final ShardId shard, final long offset, final long appendTime) {
        return new KafkaSourcePosition(
                shard, "cluster", UUID.fromString("00000000-0000-0000-0000-000000000001"), offset, null, appendTime);
    }
    ...
    private record Fixture(
            ShardId shard,
            ResourceRetireIntentRecord intent,
            ResourceDeleteConfirmedRecord confirmation,
            RecoveryFloor floor) {}
}
