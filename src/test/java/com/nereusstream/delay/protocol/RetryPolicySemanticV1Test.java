...
class RetryPolicySemanticV1Test {
    ...
    void roundTripsAndDerivesThePinnedReferenceHash() {
        final RetryPolicySemanticV1 policy = new RetryPolicySemanticV1(
                ...
                5,
                60_000,
                UncertainPolicyV1.BOUNDED_RETRY_POSSIBLE_DUPLICATE,
                2,
    ...
    void computesCheckedExponentialCapAndRegistryJitterDeterministically() {
        ...
        final long sample = Bytes.readU64be(
                Bytes.sha256(
                        Bytes.utf8("nereus-delay-retry-v1"),
                        Bytes.u8(1),
                        messageId.bytes(),
                        Bytes.u32be(0),
                        Bytes.u32be(2)),
        ...
        final RetryPolicySemanticV1 zeroBackoff = new RetryPolicySemanticV1(
    ...
    void computesDlqBackoffCapAndFencesThePolicyAttemptBudget() {
        ...
        final RetryPolicySemanticV1 disabled = new RetryPolicySemanticV1(
    ...
    void jitterAcceptsUnsignedHighBitGenerationAndAttemptBits() {
        final DelayMessageId messageId = DelayMessageId.random(new ShardId(RouteIncarnation.random(), 9));
        final long expected =
                RetryJitterV1.delayMs(RetryJitterV1.MESSAGE_PUBLISH, messageId, 0x8000_0000L, 0x8000_0000L, 10_000);
        assertEquals(
                expected,
                RetryJitterV1.delayMs(RetryJitterV1.MESSAGE_PUBLISH, messageId, 0x8000_0000L, 0x8000_0000L, 10_000));
    }
