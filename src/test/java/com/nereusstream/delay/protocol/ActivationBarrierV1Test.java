...
class ActivationBarrierV1Test {
    ...
    void roundTripsKafkaAndPulsarBranches() {
        final BrokerResourceIdentityV1 kafka =
        ...
        final ActivationBarrierV1 pulsarBarrier = ActivationBarrierV1.pulsar(pulsar, 4, 5, 6, 1, 3, 9, bytes(32, 2));
    ...
    void preservesUnsignedPartitionAndBatchFields() {
        ...
        final ActivationBarrierV1 pulsarBarrier = ActivationBarrierV1.pulsar(
                ...
                bytes(32, 2));
        assertEquals(pulsarBarrier, ActivationBarrierV1.decode(pulsarBarrier.canonicalBytes()));
        final ActivationBarrierV1 emptyPulsar = ActivationBarrierV1.empty(pulsar, -1, Long.MIN_VALUE, bytes(32, 3));
    ...
    void enforcesResourceBranchAndGuardPairing() {
        ...
        assertThrows(IllegalArgumentException.class, () -> ActivationBarrierV1.empty(kafka, 0, 1L, null));
        final BrokerResourceIdentityV1 pulsar = BrokerResourceIdentityV1.pulsar(
                new PulsarBrokerResourceIdentityV1("cluster", bytes(32, 5), "topic", 1));
        assertThrows(IllegalArgumentException.class, () -> ActivationBarrierV1.empty(pulsar, 0, null, null));
        assertThrows(
                IllegalArgumentException.class,
                () -> ActivationBarrierV1.pulsar(
    ...
    void projectsSignedRouteBarrierToExactSourceIdentity() {
        ...
        final KafkaBrokerResourceIdentityV1 kafkaResource =
                new KafkaBrokerResourceIdentityV1("cluster", UUID.randomUUID());
        final ActivationBarrierV1 kafka =
                ActivationBarrierV1.kafka(BrokerResourceIdentityV1.kafka(kafkaResource), 3, 11, 12);
        ...
        final PulsarBrokerResourceIdentityV1 pulsarResource =
                new PulsarBrokerResourceIdentityV1("cluster", bytes(32, 20), "persistent://tenant/ns/topic", 21);
