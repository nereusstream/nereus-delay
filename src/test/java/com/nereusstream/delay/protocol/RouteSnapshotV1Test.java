...
class RouteSnapshotV1Test {
    ...
    void signedKafkaRouteRoundTripsAndRejectsTampering() throws Exception {
        ...
        assertThrows(IllegalArgumentException.class, () -> RouteSnapshotV1.decode(tampered, keyPair.getPublic()));
        assertThrows(
                IllegalArgumentException.class,
                () -> RouteSnapshotV1.decode(
                        snapshot.canonicalBytes(), ed25519().getPublic()));
    }
    ...
    void pulsarResourceUsesExactPhysicalPartitionIdentity() {
        ...
        final PulsarIngressRouteResourceV1 resource = new PulsarIngressRouteResourceV1(
                "cluster",
                base,
                List.of(
        ...
        assertThrows(
                IllegalArgumentException.class,
                () -> new PulsarIngressRouteResourceV1(
                        "cluster",
                        base,
    ...
    private static RouteSnapshotV1 kafkaSnapshot(final KeyPair keyPair) {
        ...
        final List<RoutePartitionPolicyV1> partitions =
                List.of(partition(0, broker, quota), partition(1, broker, quota));
    ...
    private static RoutePartitionPolicyV1 partition(
