...
class ChannelResourceIdentityV1Test {
    ...
    void baselineChannelAndLeaseRoundTripCanonically() {
        ...
        final CredentialUseLeaseV1 lease =
                CredentialUseLeaseV1.decode(channel.credentialUseLease().canonicalBytes());
    ...
    void preservesUnsignedChannelAndEvidenceGenerationBits() {
        ...
        final ChannelResourceIdentityV1 channel =
                ChannelResourceIdentityV1.decode(highBitKafkaTransactionalChannel(highBitGeneration));
        ...
        assertArrayEquals(
                ...
                ChannelResourceIdentityV1.decode(channel.canonicalBytes()).canonicalBytes());
    }
