...
class InitialRouteControlActivatePayloadV1Test {
    ...
    void sortsAndRoundTripsTheInitialControlSet() {
        ...
        final ProfileRefV1 firstProfile = new ProfileRefV1(
                Bytes.utf8("profile-b"), 2, Bytes.sha256(Bytes.utf8("profile-b-v2")), ProfileKindV1.DESTINATION);
        final ProfileRefV1 secondProfile = new ProfileRefV1(
                Bytes.utf8("profile-a"),
                1,
                Bytes.sha256(Bytes.utf8("profile-a-v1")),
    ...
    void rejectsDuplicateOrOutOfOrderRepeatedBranches() {
        ...
        assertThrows(
                ...
                () -> new InitialRouteControlActivatePayloadV1(
    ...
    private static byte[] controlBody(
            final ShardId shard, final ControlRef controlRef, final InitialRouteControlActivatePayloadV1 payload) {
