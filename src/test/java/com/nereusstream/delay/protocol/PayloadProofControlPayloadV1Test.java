...
class PayloadProofControlPayloadV1Test {
    ...
    void trustSetControlBranchesRoundTripCanonically() {
        ...
        final PayloadProofTrustSetActivatePayloadV1 activate = new PayloadProofTrustSetActivatePayloadV1(trustSet);
        assertEquals(activate, PayloadProofTrustSetActivatePayloadV1.decode(activate.canonicalBytes()));

        final ControlReasonV1 reason =
                new ControlReasonV1(ControlReasonKindV1.INCIDENT, Bytes.sha256(Bytes.utf8("ticket")), null);
        final PayloadProofIssuanceClosePayloadV1 close = new PayloadProofIssuanceClosePayloadV1(trustSet, 3, reason);
    ...
    void rejectsReasonOptionalOrderAndInvalidProofKeyVersion() {
        ...
        final PayloadProofTrustSetRefV1 trustSet =
                new PayloadProofTrustSetRefV1(1, Bytes.sha256(Bytes.utf8("trust-set")));
        assertThrows(IllegalArgumentException.class, () -> new PayloadProofIssuanceClosePayloadV1(trustSet, 0, reason));
    ...
    void applyShardControlPreservesUnsignedSemanticVersionBits() {
        ...
        final byte[] body = controlBody(
                ...
                CanonicalProtobuf.message(output -> CanonicalProtobuf.bytes(
                        output,
                        1,
                        new PayloadProofTrustSetRefV1(Long.MIN_VALUE, Bytes.sha256(Bytes.utf8("trust-set-high-bit")))
                                .canonicalBytes())),
