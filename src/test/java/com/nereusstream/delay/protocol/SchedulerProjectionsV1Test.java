...
class SchedulerProjectionsV1Test {
    ...
    void closedSchedulerValuesRoundTripWithCanonicalDigests() {
        ...
        final OwnerIdentityV1 owner =
                new OwnerIdentityV1(Bytes.utf8("deployment"), Bytes.utf8("worker"), 7, bytes(32, 9));
        ...
        assertArrayEquals(
                ...
                SchedulerProjectionsV1.ReadyDiscoveryCursor.decode(discovery.canonicalBytes())
                        .canonicalBytes());
        assertArrayEquals(
                ring.canonicalBytes(),
        ...
        assertArrayEquals(
                ...
                SchedulerProjectionsV1.DeficitMap.decode(deficits.canonicalBytes())
                        .canonicalBytes());
        assertArrayEquals(
        ...
        assertArrayEquals(
                ...
                SchedulerProjectionsV1.LastServedMap.decode(served.canonicalBytes())
                        .canonicalBytes());
        assertArrayEquals(
                owner.canonicalBytes(),
                OwnerIdentityV1.decode(owner.canonicalBytes()).canonicalBytes());
    }

    @Test
    void schedulerProjectionDigestAndOrderingAreClosed() {
        final SchedulerProjectionsV1.DeficitMap map = new SchedulerProjectionsV1.DeficitMap(
                List.of(new SchedulerProjectionsV1.DeficitEntry(lane(1), bytes(16, 1), 1, 1)));
        ...
        final SchedulerProjectionsV1.ActiveRing ring = new SchedulerProjectionsV1.ActiveRing(
                1, 0, 0, List.of(new SchedulerProjectionsV1.RingEntry(lane(1), bytes(16, 1), 1)));
    ...
    void schedulerUint64FieldsPreserveCompleteRawBitPatterns() {
        ...
        final OwnerIdentityV1 owner =
                new OwnerIdentityV1(Bytes.utf8("deployment"), Bytes.utf8("worker"), Long.MIN_VALUE, bytes(32, 9));
        final SchedulerProjectionsV1.ReadyDiscoveryCursor discovery =
        ...
        final SchedulerProjectionsV1.ActiveRing ring =
                new SchedulerProjectionsV1.ActiveRing(Long.MIN_VALUE, -1L, 0, List.of(ringEntry));
        final SchedulerProjectionsV1.DeficitMap deficits = new SchedulerProjectionsV1.DeficitMap(
                List.of(new SchedulerProjectionsV1.DeficitEntry(lane, incarnation, -1L, Long.MIN_VALUE)));
        final SchedulerProjectionsV1.Round round = new SchedulerProjectionsV1.Round(-1L, owner, true);
        final SchedulerProjectionsV1.LastServedMap served = new SchedulerProjectionsV1.LastServedMap(
                List.of(new SchedulerProjectionsV1.LastServedEntry(lane, incarnation, -1L, Long.MIN_VALUE)));
