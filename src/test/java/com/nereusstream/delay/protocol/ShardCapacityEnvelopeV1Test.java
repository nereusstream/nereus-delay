...
class ShardCapacityEnvelopeV1Test {
    ...
    void preservesCompleteUnsigned64BitGrantAndEnvelopeVersions() {
        ...
        final QuotaGrantRefV1 logical =
                new QuotaGrantRefV1(Bytes.sha256(Bytes.utf8("high-bit-logical-grant")), Long.MIN_VALUE, limit);
        final ShardCapacityEnvelopeV1 envelope = new ShardCapacityEnvelopeV1(
    ...
    void rejectsWrongGrantKindOverflowAndLogicalProjectionDrift() {
        ...
        assertThrows(
                ...
                () -> new ShardCapacityEnvelopeV1(
                        ...
                        4,
                        logical,
                        new CapacityVectorV1(driftedAmounts),
    ...
    private static CapacityVectorV1 committed(final PublishAdmissionBody.ChargeVector limit, final long extraAmount) {
    ...
    private static CapacityGrantV1 grant(
            final CapacityGrantKindV1 kind, final long controlBytes, final long controlRecords) {
        return grant(kind, controlBytes, controlRecords, 1);
    }

    private static CapacityGrantV1 grant(
            final CapacityGrantKindV1 kind,
