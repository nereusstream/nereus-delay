...
class ProtocolCapabilityDeclarationV1Test {
    ...
    void rejectsDuplicateTuplesAndInvalidEpoch() {
        ...
        assertThrows(
                ...
                () -> new ProtocolCapabilityDeclarationV1(
                        "worker", bytes(32, 1), List.of(tuple, tuple), 1, bytes(32, 2)));
        assertThrows(
                IllegalArgumentException.class,
                () -> new ProtocolCapabilityDeclarationV1("worker", bytes(32, 1), List.of(tuple), 0, bytes(32, 2)));
    }

    private static void assertTrueSupports(
            final ProtocolCapabilityDeclarationV1 declaration, final ProtocolTupleV1 tuple) {
