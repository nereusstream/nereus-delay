...
class RemainingPreparedCommandV1Test {
    ...
    void cancelAndRescheduleV1CommandsRoundTripThroughTheStrictFrameSeam() {
        ...
        final PreparedCommand cancel =
                PreparedCommand.cancelV1(shard, messageId, new MessagePreconditionV1(1L, 2L), 500);
        assertEquals(cancel, CommandCodec.decodeFrameV1(CommandCodec.encodeFrameV1(cancel)));
        final PreparedCommand reschedule =
                PreparedCommand.rescheduleV1(shard, messageId, new MessagePreconditionV1(null, null), 10, 100, 500);
