...
class ControlTargetRefV1Test {
    ...
    void roundTripsAllClosedTargetBranchesAndOptionalMutationIdentity() {
        ...
        final ProfileRefV1 profile =
                new ProfileRefV1(Bytes.utf8("destination"), 2, bytes(32, 20), ProfileKindV1.DESTINATION);
        ...
        final List<ControlTargetRefV1> targets = List.of(
                ...
                new ControlTargetRefV1(
                        1,
                        ControlTargetKindV1.LANE,
                        new LaneControlTargetV1(bytes(32, 1), bytes(16, 2), 3),
                        bytes(32, 3),
                        bytes(32, 4)),
                new ControlTargetRefV1(
                        2,
                        ControlTargetKindV1.MESSAGE,
                        new ControlMessageTargetV1(message, 1, 2, bytes(32, 5)),
                        null,
                        null),
                new ControlTargetRefV1(3, ControlTargetKindV1.ROUTE, route.bytes(), null, null),
                new ControlTargetRefV1(
                        4,
                        ControlTargetKindV1.PROFILE,
                        new ProfileControlTargetV1(profile, 2, bytes(32, 6), Long.MIN_VALUE),
                        null,
                        null),
                new ControlTargetRefV1(5, ControlTargetKindV1.QUOTA_GRANT, quota, null, null));

        for (ControlTargetRefV1 target : targets) {
            assertEquals(target, ControlTargetRefV1.decode(target.canonicalBytes()), "target " + target.targetKind());
        }
    ...
    void rejectsDigestTamperingPartialMutationIdentityAndWrongBranchType() {
        ...
        final ControlTargetRefV1 target =
                new ControlTargetRefV1(1, ControlTargetKindV1.ROUTE, route.bytes(), bytes(32, 1), bytes(32, 2));
        ...
        assertThrows(
                ...
                () -> new ControlTargetRefV1(1, ControlTargetKindV1.ROUTE, route.bytes(), bytes(32, 1), null));
        assertThrows(
                IllegalArgumentException.class,
                () -> new ControlTargetRefV1(1, ControlTargetKindV1.SHARD, route.bytes(), null, null));
