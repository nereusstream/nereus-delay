...
class CanonicalLaneTupleV1Test {
    ...
    void claimProjectionReconstructsExactKafkaAndPulsarLaneIdentity() {
        ...
        final BrokerResourceIdentityV1 kafkaTarget = BrokerResourceIdentityV1.kafka(new KafkaBrokerResourceIdentityV1(
                "fixture-target-cluster", UUID.nameUUIDFromBytes(Bytes.utf8("fixture-lane-topic"))));
        final ClaimMaterializationV1 kafkaClaim = materialization(
                destination,
                capability,
                kafkaTarget,
                3,
        ...
        final BrokerResourceIdentityV1 pulsarTarget =
        ...
        final ClaimMaterializationV1 pulsarClaim = materialization(
                destination,
                capability,
                pulsarTarget,
                5,
    ...
    private static byte[] pulsarTuple(
            final ProfileRefV1 destination, final ProfileRefV1 capability, final byte[] resourceIncarnation) {
        return Bytes.concat(
