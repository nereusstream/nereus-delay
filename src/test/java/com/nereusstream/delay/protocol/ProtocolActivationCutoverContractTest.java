...
class ProtocolActivationCutoverContractTest {
    ...
    void downgradePackageBindsTheActivatedMarkerAndNeverDeletesIt() {
        ...
        final ProtocolActivationStateV1 state = new ProtocolActivationStateV1(
                ...
                List.of(
                        new ProtocolActivationStateV1.Activation(
        ...
        final ProtocolDowngradePackageV1 downgrade =
                new ProtocolDowngradePackageV1(fallback, activated, hash(4), state.stateDigest(), hash(7), hash(8));
        ...
        assertThrows(
                IllegalStateException.class,
                () -> downgrade.validateAgainst(new ProtocolActivationStateV1(
                        new ShardSubjectV1(shardId),
                        List.of(new ProtocolActivationStateV1.Activation(
                                fallback, hash(1), hash(2), fallbackPosition.canonicalBytes(), hash(3))))));
    }
    ...
    void sameCanonicalPayloadWithDifferentProtocolVersionsHasDifferentPackageIdentity() {
        ...
        final ProtocolDowngradePackageV1 v2Package =
                new ProtocolDowngradePackageV1(fallback, v2, hash(10), v2State.stateDigest(), hash(11), hash(12));
        final ProtocolDowngradePackageV1 v3Package =
                new ProtocolDowngradePackageV1(fallback, v3, hash(10), v3State.stateDigest(), hash(11), hash(12));
    ...
    private static ProtocolActivationStateV1 state(
            final ShardId shardId, final ProtocolTupleV1 fallback, final ProtocolTupleV1 activated) {
        return new ProtocolActivationStateV1(
                new ShardSubjectV1(shardId),
                List.of(
                        new ProtocolActivationStateV1.Activation(
