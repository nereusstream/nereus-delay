...
class PreparedCommandV1Test {
    ...
    void scheduleAndPrepareV1CommandsKeepOuterAndBodyIdentityAligned() {
        ...
        final PreparedCommand prepare = PreparedCommand.prepareLargeV1(
                ...
                1000,
                new PayloadProofTrustSetRefV1(1, bytes(32, 5)),
                objectStore(),
                500);
    ...
    void v1DecoderRejectsACommonFieldThatDoesNotMatchTheOuterCommand() {
        ...
        final byte[] mismatch = new ScheduleCommandBodyV1(
        ...
        assertThrows(
                ...
                () -> CommandCodec.decodeEnvelopeV1(CommandCodec.encodeEnvelope(forged)));
    }
    ...
    void managedPreparedSubmissionRejectsACompatibilityBody() {
        ...
        final PreparedCommand legacy = PreparedCommand.schedule(
                ...
                500);
        assertThrows(
                IllegalArgumentException.class, () -> PreparedSubmissionV1.managed(CommandCodec.encodeFrame(legacy)));
    }
