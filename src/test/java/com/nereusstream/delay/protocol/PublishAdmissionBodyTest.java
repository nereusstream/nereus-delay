...
public class PublishAdmissionBodyTest {
    ...
    void canonicalBuilderRoundTripsTheTypedAdmissionProjection() {
        ...
        final List<CanonicalProtobuf.Reader.Field> fields =
                SystemMutationBodyCodec.fields(SystemMutationType.PUBLISH_ADMISSION, fixture.body());
        final long retryUntil = fields.stream()
        ...
        final byte[] rebuilt = PublishAdmissionBody.canonicalBytes(
                ...
                new DelayMessageId(admission.messageId()),
                Integer.toUnsignedLong(admission.generation()),
        ...
        assertArrayEquals(
                admission.descriptor().value().materialization().canonicalBytes(),
    ...
    void preservesHighBitUint32GenerationAndAttemptBits() {
        ...
        final byte[] generationBody =
                tamperOuterAndClaimGeneration(tamperDescriptorScalar(fixture.body(), 12, 0x8000_0000L), 0x8000_0000L);
        ...
        final PublishAdmissionBody attempt =
                PublishAdmissionBody.decode(tamperDescriptorScalar(fixture.body(), 14, 0x8000_0000L));
    ...
    void rejectsMalformedProfileReferenceHashInAdmissionProjection() {
        ...
        assertThrows(
                IllegalArgumentException.class,
                () -> PublishAdmissionBody.decode(Fixture.createWithProfiles(
                                new ShardId(RouteIncarnation.random(), 15),
    ...
    void hashedPartitionValidationPreservesHighBitDestinationProfileVersion() {
        ...
        final DestinationProfileSemanticV1 destinationBody = new DestinationProfileSemanticV1(
                ...
                512,
                1,
                Bytes.utf8("high-bit-hash-destination"),
                0,
                0,
                1,
                bytes(32, 74));
        ...
        final Fixture fixture = Fixture.createWithProfiles(
                new ShardId(RouteIncarnation.random(), 14),
    ...
    void validatesBrokerPersistenceTimeAgainstDecisionAndExpiryBounds() {
        ...
        assertThrows(IllegalArgumentException.class, () -> admission.requireBrokerTiming(Long.MAX_VALUE, 1, 0));
    }
    ...
    void retainsCertifiedHandoffTimingForProfileSemanticValidation() {
        final Fixture fixture = Fixture.createWithActionAt(new ShardId(RouteIncarnation.random(), 6), 1_500);
        final PublishAdmissionBody admission = PublishAdmissionBody.decode(fixture.body());
    ...
    void rejectsActionAfterBusinessVisibilityTimeBeforeProfileLookup() {
        final Fixture fixture = Fixture.createWithActionAt(new ShardId(RouteIncarnation.random(), 7), 2_001);
    ...
    void acceptsOnlyThePinnedPulsarHandoffLead() {
        ...
        final DestinationProfileSemanticV1 encodingMismatchBody = new DestinationProfileSemanticV1(
                ...
                512,
                1,
                Bytes.utf8("pulsar-encoding-mismatch"),
                0,
                0,
                2,
                bytes(32, 50));
        ...
        final DestinationProfileSemanticV1 partitionMismatchBody = new DestinationProfileSemanticV1(
                ...
                512,
                1,
                Bytes.utf8("pulsar-partition-mismatch"),
                0,
                0,
                1,
                bytes(32, 48));
        ...
        assertThrows(
                IllegalArgumentException.class,
                () -> partitionAdmission.requireTimingPolicy(partitionMismatchBody, capabilityBody));
    }
    ...
    void rejectsAProfileHashPartitionThatDoesNotMatchDescriptorMetadata() {
        ...
        final Fixture fixture = Fixture.createWithProfiles(
                new ShardId(RouteIncarnation.random(), 11),
                destination.ref().canonicalBytes(),
                capability.ref().canonicalBytes(),
                target,
                AdapterKindV1.KAFKA,
        ...
        assertThrows(
                IllegalArgumentException.class, () -> admission.requireTimingPolicy(destinationBody, capabilityBody));
    }
    ...
    void rejectsMessageRoutedToDifferentBodyShard() {
        ...
        assertThrows(
                IllegalArgumentException.class,
                () -> PublishAdmissionBody.decode(
                        Fixture.create(shard, messageId).body()));
    }
    ...
    private static byte[] tamperClaimMaterializationProfile(
            final byte[] body, final int profileField, final byte[] replacement) {
        final List<CanonicalProtobuf.Reader.Field> bodyFields = readFields(body);
        final byte[] claim = bodyFields.stream()
                .filter(field -> field.number() == 25)
                .findFirst()
                .orElseThrow()
                .rawValue();
        final List<CanonicalProtobuf.Reader.Field> claimFields = readFields(claim);
        final byte[] materialization = claimFields.stream()
    ...
    private static byte[] tamperDescriptorScalar(final byte[] body, final int descriptorField, final long value) {
        ...
        final byte[] descriptor = outerFields.stream()
                .filter(field -> field.number() == 22)
                .findFirst()
                .orElseThrow()
                .rawValue();
    ...
    private static byte[] tamperOuterAndClaimGeneration(final byte[] body, final long value) {
        ...
        final byte[] claim = outerFields.stream()
                .filter(field -> field.number() == 25)
                .findFirst()
                .orElseThrow()
                .rawValue();
    ...
    public record Fixture(byte[] body, byte[] owner, DelayMessageId messageId, byte[] descriptor, byte[] lane) {
        ...
        public static Fixture create(final ShardId shard, final DelayMessageId messageId) {
            return createInternal(
                    ...
                    messageId,
                    new byte[16],
                    Bytes.sha256(Bytes.utf8("timeline")),
                    1,
                    0,
                    0,
        ...
        public static Fixture createWithProfiles(
                final ShardId shard,
        ...
        public static Fixture createWithProfiles(
            ...
            final byte[] channelPrefix =
                    channelPrefix(adapterKind, lane, laneIncarnation, targetBytes, physicalPartition);
            final byte[] lease = lease(
                    destinationProfile,
                    bindingDigest,
                    fingerprint,
                    time,
            ...
            final byte[] descriptor = descriptor(
                    adapterKind,
                    lane,
                    laneIncarnation,
                    destinationProfile,
            ...
            final byte[] certificate =
                    certificate(owner, shard, lane, laneIncarnation, channel, time, bindingDigest, fingerprint);
        ...
        public static Fixture createForSource(
                final ShardId shard,
            ...
            return createForSource(
                    ...
                    timelineKey,
                    sourceWorkKind,
                    expectedAdmissionsUsed,
                    expectedUncertainRetryAdmissionsUsed,
                    obligationSetDigest,
                    semanticDigest,
                    1,
                    1);
        ...
        public static Fixture createForSourceWithLane(
                final ShardId shard,
                final DelayMessageId messageId,
                final byte[] laneIncarnation,
                final byte[] timelineKey,
        ...
        private static Fixture createInternal(
                final ShardId shard,
                final DelayMessageId messageId,
                final byte[] laneIncarnation,
        ...
        private static byte[] lease(
                final byte[] profile,
                final byte[] bindingDigest,
                final byte[] fingerprint,
                final byte[] issuedAt,
                final byte[] holderScope) {
        ...
        private static byte[] channel(
                final byte[] channelPrefix, final byte[] bindingDigest, final byte[] fingerprint, final byte[] lease) {
            return CanonicalProtobuf.message(output -> {
            ...
            return adapterKind == AdapterKindV1.KAFKA
                    ...
                    : CanonicalProtobuf.message(output -> CanonicalProtobuf.bytes(
                            ...
                            CanonicalProtobuf.message(
                                    inner -> CanonicalProtobuf.bytes(inner, 3, Bytes.utf8("ordering")))));
        }
        ...
        private static byte[] certificate(
            ...
            final byte[] prefix = CanonicalProtobuf.message(output -> {
                ...
                CanonicalProtobuf.bytes(
                        ...
                        7,
                        CanonicalProtobuf.message(
                                barrier -> CanonicalProtobuf.bytes(barrier, 1, CanonicalProtobuf.message(empty -> {
