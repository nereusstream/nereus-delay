...
class ProfileControlRequestV1Test {
    ...
    void roundTripsPublishDeprecateAndRotateRequests() throws Exception {
        ...
        final CredentialBindingV1 firstBinding =
                CredentialBindingV1.create(reference, 1, firstSecret, firstAttestation);

        final PublishDestinationProfileRequestV1 publish =
                new PublishDestinationProfileRequestV1(profile, firstBinding);
        ...
        final DeprecateDestinationProfileRequestV1 deprecate = new DeprecateDestinationProfileRequestV1(
                reference, new ControlReasonV1(ControlReasonKindV1.OPERATOR_REQUEST, bytes(32, 20), null));
    ...
    void rejectsWrongProfileBindingGenerationRotationAndTampering() throws Exception {
        ...
        assertThrows(
                ...
                () -> new PublishDestinationProfileRequestV1(
                        profile,
                        new CredentialBindingV1(
                                reference,
                                2,
                                secret,
                                Bytes.sha256(secret),
        ...
        assertThrows(
                IllegalArgumentException.class,
                () -> new RotateEquivalentSecretRequestV1(
                        reference,
                        1,
                        3,
        ...
        final RotateEquivalentSecretRequestV1 rotate = new RotateEquivalentSecretRequestV1(
                ...
                1,
                2,
                Bytes.utf8("provider://credential/v2"),
                Bytes.sha256(Bytes.utf8("provider://credential/v2")),
                attestation(reference, 2, Bytes.utf8("provider://credential/v2"), keyPair),
                binding.bindingDigest(),
                1);
    ...
    void preservesHighBitSecretGenerationsAcrossRotation() throws Exception {
        ...
        final CredentialEquivalenceAttestationV1 nextAttestation =
