...
class ProfileSemanticEnvelopeV1Test {
    ...
    void roundTripsAllProfileBodyBranchesAndBindsSemanticHash() {
        final ProfileRefV1 capabilityRef =
                new ProfileRefV1(Bytes.utf8("capability"), 2, bytes(32, 1), ProfileKindV1.DELIVERY_CAPABILITY);
        final DestinationProfileSemanticV1 destination = new DestinationProfileSemanticV1(
                ...
                1,
                bytes(32, 3));
        final ProfileSemanticEnvelopeV1 destinationEnvelope =
                new ProfileSemanticEnvelopeV1(ProfileKindV1.DESTINATION, Bytes.utf8("destination"), 7, destination);
        ...
        assertEquals(
                ...
                ProfileRefV1.decode(destinationEnvelope.ref().canonicalBytes()));
        assertArrayEquals(
        ...
        final ObjectStoreProfileSemanticV1 objectStore = new ObjectStoreProfileSemanticV1(
                ...
                1,
                bytes(32, 9));
        final ProfileSemanticEnvelopeV1 objectStoreEnvelope =
                new ProfileSemanticEnvelopeV1(ProfileKindV1.OBJECT_STORE, Bytes.utf8("objects"), 1, objectStore);
        assertEquals(objectStoreEnvelope, ProfileSemanticEnvelopeV1.decode(objectStoreEnvelope.canonicalBytes()));

        final EvidenceVerifierProfileSemanticV1 verifier =
                new EvidenceVerifierProfileSemanticV1(1, 3, bytes(32, 10), bytes(32, 11), 100, 200, bytes(32, 12));
        final ProfileSemanticEnvelopeV1 verifierEnvelope =
                new ProfileSemanticEnvelopeV1(ProfileKindV1.EVIDENCE_VERIFIER, Bytes.utf8("verifier"), 1, verifier);
    ...
    void preservesUnsignedTargetPartitionFields() {
        final ProfileRefV1 capabilityRef = new ProfileRefV1(
                Bytes.utf8("unsigned-capability"), 1, bytes(32, 20), ProfileKindV1.DELIVERY_CAPABILITY);
        final DestinationProfileSemanticV1 destination = new DestinationProfileSemanticV1(
                AdapterKindV1.KAFKA,
                BrokerResourceIdentityV1.kafka(new KafkaBrokerResourceIdentityV1("cluster", UUID.randomUUID())),
                -1,
    ...
    void rejectsProfileBodyAndPartitionSafetyViolations() {
        ...
        assertThrows(
                ...
                () -> new DestinationProfileSemanticV1(
                        AdapterKindV1.KAFKA,
                        target,
                        4,
