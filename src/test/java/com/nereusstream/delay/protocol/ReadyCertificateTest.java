...
class ReadyCertificateTest {
    ...
    void exposesTheAdmissionCertificateThroughOneCanonicalValidator() {
        ...
        final ReadyCertificate decoded = ReadyCertificate.decode(certificate);
        ...
        assertEquals(decoded, ReadyCertificate.decode(decoded.canonicalBytes()));
    }
    ...
    void rejectsCertificateLaneDriftAndDigestTampering() {
        ...
        assertThrows(IllegalArgumentException.class, () -> ReadyCertificate.decode(tampered));
    }
    ...
    void rejectsCertificateThatOutlivesTheChannelLease() {
        ...
        assertThrows(IllegalArgumentException.class, () -> ReadyCertificate.decode(outlivingLease));
    }
    ...
    private static byte[] rewriteValidUntil(final byte[] encoded, final long validUntil) {
        ...
        final byte[] digest = Bytes.sha256(Bytes.utf8("nereus-delay-ready-certificate\0"), prefix);
