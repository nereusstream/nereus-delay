...
class SloAuthoritativeStartFactoryTest {
    ...
    void dueAdmissionPreservesUnsignedGenerationAndExactManagedPathStart() {
        ...
        final SloSampleStartV1 start = SloAuthoritativeStartFactory.dueAdmission(
                objective, messageId, 0x8000_0000L, SloPathV1.MANAGED_PULSAR_HANDOFF, 2_000, evidence);
