...
public final class KafkaClientArtifactWorkerSourceFactory {
    ...
    public static WorkerShardRuntime create(
        ...
        final ConsumerResourceGuard expectedGuard = new ConsumerResourceGuard(
        ...
        final KafkaClientArtifactSourceRecordConsumer source = new KafkaClientArtifactSourceRecordConsumer(
                consumer,
                barrier.authenticatedClusterId(),
        ...
        try {
            final TopicPartition topicPartition =
                    new TopicPartition(topic, assignment.shardId().partition());
    ...
    private static SourceAssignment requireActiveAssignment(
            final SourceAssignment acceptedAssignment, final OwnedDelayShard ownedShard) {
    ...
    private static void closeAfterFailure(
            final KafkaClientArtifactSourceRecordConsumer source, final Throwable failure) {
        try {
            source.close();
