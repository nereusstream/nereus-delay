...
public final class OxiaRouteSnapshotRecordV1 {
    ...
    private OxiaRouteSnapshotRecordV1(
            final long revision,
    ...
    public static OxiaRouteSnapshotRecordV1 create(
            final long revision,
            final long previousRevision,
            final RouteSelectionHint route,
            final RouteSnapshotV1 snapshot) {
    ...
    public static OxiaRouteSnapshotRecordV1 decode(final byte[] encoded, final PublicKey verificationKey) {
        ...
        final RouteSelectionHint route = new RouteSelectionHint(
                com.nereusstream.delay.protocol.AdapterKindV1.fromWire(uint(next(reader, 4), 4)),
        ...
        final OxiaRouteSnapshotRecordV1 result =
                new OxiaRouteSnapshotRecordV1(revision, previousRevision, route, snapshot);
