...
public final class OxiaRouteSnapshotHead {
    public static final int VERSION = 1;

    private final long publishedRevision;
    private final byte[] eventDigest;

    public OxiaRouteSnapshotHead(final long publishedRevision, final byte[] eventDigest) {
    ...
    public static OxiaRouteSnapshotHead decode(final byte[] encoded) {
        ...
        final OxiaRouteSnapshotHead result = new OxiaRouteSnapshotHead(revision, digest);
