...
import com.nereusstream.delay.gateway.v1.GatewayAwaitAppliedRequestV1;
import com.nereusstream.delay.gateway.v1.GatewayCancelRequestV1;
import com.nereusstream.delay.gateway.v1.GatewayCommitLargeScheduleRequestV1;
import com.nereusstream.delay.gateway.v1.GatewayGetCommandResultRequestV1;
import com.nereusstream.delay.gateway.v1.GatewayGetMessageRequestV1;
...
import com.nereusstream.delay.gateway.v1.GatewayRescheduleRequestV1;
import com.nereusstream.delay.gateway.v1.GatewayRetryUncertainRequestV1;
...
public final class GatewayGrpcService extends DelayGatewayV1Grpc.DelayGatewayV1ImplBase {
    ...
    public void issuePayloadUploadHandle(
            final GatewayIssuePayloadUploadHandleRequestV1 request,
            final StreamObserver<com.nereusstream.delay.gateway.v1.GatewayPayloadUploadHandleResponseV1>
                    responseObserver) {
        if (payloadIngress == null) {
            fail(responseObserver, Status.Code.UNIMPLEMENTED);
            return;
        }
        final com.nereusstream.delay.gateway.GatewayIssuePayloadUploadHandleRequestV1 domain;
        try {
    ...
    public void attestPayloadUpload(
            ...
            final StreamObserver<com.nereusstream.delay.gateway.v1.GatewayPayloadAttestationResponseV1>
                    responseObserver) {
        if (payloadIngress == null) {
            fail(responseObserver, Status.Code.UNIMPLEMENTED);
            return;
        }
        final com.nereusstream.delay.gateway.GatewayAttestPayloadUploadRequestV1 domain;
        try {
    ...
    public void getCommandResult(
            ...
            final StreamObserver<com.nereusstream.delay.gateway.v1.GatewayCommandQueryResponseV1> responseObserver) {
        if (queryIngress == null) {
            fail(responseObserver, Status.Code.UNIMPLEMENTED);
            return;
        }
        final com.nereusstream.delay.gateway.GatewayGetCommandResultRequestV1 domain;
        try {
    ...
    public void awaitApplied(
        ...
        final com.nereusstream.delay.gateway.GatewayAwaitAppliedRequestV1 domain;
        try {
    ...
    public void getMessage(
            ...
            final StreamObserver<com.nereusstream.delay.gateway.v1.GatewayMessageQueryResponseV1> responseObserver) {
        if (queryIngress == null) {
            fail(responseObserver, Status.Code.UNIMPLEMENTED);
            return;
        }
        final com.nereusstream.delay.gateway.GatewayGetMessageRequestV1 domain;
        try {
    ...
    public void schedule(
            ...
            final StreamObserver<com.nereusstream.delay.gateway.v1.GatewaySubmissionOutcomeV1> responseObserver) {
        final com.nereusstream.delay.gateway.GatewayScheduleRequestV1 domain;
        try {
    ...
    public void retryUncertain(
            ...
            final StreamObserver<com.nereusstream.delay.gateway.v1.GatewaySubmissionOutcomeV1> responseObserver) {
        final com.nereusstream.delay.gateway.GatewayRetryUncertainRequestV1 domain;
        try {
            domain = new com.nereusstream.delay.gateway.GatewayRetryUncertainRequestV1(
    ...
    public void prepareLargeSchedule(
            ...
            final StreamObserver<com.nereusstream.delay.gateway.v1.GatewaySubmissionOutcomeV1> responseObserver) {
        final com.nereusstream.delay.gateway.GatewayPrepareLargeScheduleRequestV1 domain;
        try {
    ...
    public void commitLargeSchedule(
            ...
            final StreamObserver<com.nereusstream.delay.gateway.v1.GatewaySubmissionOutcomeV1> responseObserver) {
        final com.nereusstream.delay.gateway.GatewayCommitLargeScheduleRequestV1 domain;
        try {
    ...
    public void cancel(
            ...
            final StreamObserver<com.nereusstream.delay.gateway.v1.GatewaySubmissionOutcomeV1> responseObserver) {
        final com.nereusstream.delay.gateway.GatewayCancelRequestV1 domain;
        try {
    ...
    public void reschedule(
            ...
            final StreamObserver<com.nereusstream.delay.gateway.v1.GatewaySubmissionOutcomeV1> responseObserver) {
        final com.nereusstream.delay.gateway.GatewayRescheduleRequestV1 domain;
        try {
    ...
    private void invoke(
            final java.util.function.Supplier<
                            java.util.concurrent.CompletionStage<
                                    com.nereusstream.delay.gateway.GatewaySubmissionOutcomeV1>>
                    call,
            final StreamObserver<com.nereusstream.delay.gateway.v1.GatewaySubmissionOutcomeV1> responseObserver) {
        try {
    ...
    private static com.nereusstream.delay.gateway.GatewayScheduleRequestV1 decodeSchedule(
            final GatewayScheduleRequestV1 request) {
        ...
        return new com.nereusstream.delay.gateway.GatewayScheduleRequestV1(
    ...
    private static com.nereusstream.delay.gateway.GatewayCancelRequestV1 decodeCancel(
            final GatewayCancelRequestV1 request) {
        if (request.getDelayMessageId().isEmpty()) {
            throw new IllegalArgumentException("Gateway Cancel request is incomplete");
        }
        return new com.nereusstream.delay.gateway.GatewayCancelRequestV1(
                request.getIdempotencyKey().toByteArray(),
    ...
    private static com.nereusstream.delay.gateway.GatewayPrepareLargeScheduleRequestV1 decodePrepareLargeSchedule(
            final GatewayPrepareLargeScheduleRequestV1 request) {
        if (!request.hasRoute()
                || request.getScheduleIntentV1().isEmpty()
                || request.getPayloadSha256().isEmpty()
                || request.getPayloadProofTrustSetRefV1().isEmpty()
        ...
        return new com.nereusstream.delay.gateway.GatewayPrepareLargeScheduleRequestV1(
                request.getIdempotencyKey().toByteArray(),
                new RouteSelectionHint(
                        AdapterKindV1.fromWire(request.getRoute().getIngressAdapterKind()),
                        request.getRoute().getRouteAliasUtf8Nfc().toByteArray()),
                ...
                PayloadProofTrustSetRefV1.decode(
                        request.getPayloadProofTrustSetRefV1().toByteArray()),
                ProfileRefV1.decode(request.getObjectStoreProfileRefV1().toByteArray()),
                request.getRetryUntilEpochMs());
    }

    private static com.nereusstream.delay.gateway.GatewayCommitLargeScheduleRequestV1 decodeCommitLargeSchedule(
            final GatewayCommitLargeScheduleRequestV1 request) {
        ...
        return new com.nereusstream.delay.gateway.GatewayCommitLargeScheduleRequestV1(
                request.getIdempotencyKey().toByteArray(),
    ...
    private static com.nereusstream.delay.gateway.GatewayRescheduleRequestV1 decodeReschedule(
            final GatewayRescheduleRequestV1 request) {
        if (request.getDelayMessageId().isEmpty()) {
            throw new IllegalArgumentException("Gateway Reschedule request is incomplete");
        }
        return new com.nereusstream.delay.gateway.GatewayRescheduleRequestV1(
                request.getIdempotencyKey().toByteArray(),
                new DelayMessageId(request.getDelayMessageId().toByteArray()),
                MessagePreconditionV1.decode(request.getMessagePreconditionV1().toByteArray()),
    ...
    private static com.nereusstream.delay.gateway.GatewayIssuePayloadUploadHandleRequestV1
        ...
        return new com.nereusstream.delay.gateway.GatewayIssuePayloadUploadHandleRequestV1(
                PayloadReservationReceiptV1.decodePayload(
                        request.getPayloadReservationReceiptV1().toByteArray()),
                UploadHandleKindV1.fromWire(request.getUploadHandleKind()));
    }

    private static com.nereusstream.delay.gateway.GatewayAttestPayloadUploadRequestV1 decodeAttestPayloadUpload(
            final GatewayAttestPayloadUploadRequestV1 request) {
        if (request.getPayloadReservationReceiptV1().isEmpty()
        ...
        return new com.nereusstream.delay.gateway.GatewayAttestPayloadUploadRequestV1(
                PayloadReservationReceiptV1.decodePayload(
                        request.getPayloadReservationReceiptV1().toByteArray()),
                OpaquePayloadUploadHandleV1.decode(
                        request.getOpaquePayloadUploadHandleV1().toByteArray()));
    }

    private static com.nereusstream.delay.gateway.GatewayGetCommandResultRequestV1 decodeGetCommandResult(
            final GatewayGetCommandResultRequestV1 request) {
        if (request.hasCommandQueuedReceiptV1()) {
            return new com.nereusstream.delay.gateway.GatewayGetCommandResultRequestV1(
                    CommandQueuedReceiptV1.decodePayload(
                            request.getCommandQueuedReceiptV1().toByteArray()),
                    null);
        }
    ...
    private static com.nereusstream.delay.gateway.GatewayAwaitAppliedRequestV1 decodeAwaitApplied(
            final GatewayAwaitAppliedRequestV1 request) {
        ...
        return new com.nereusstream.delay.gateway.GatewayAwaitAppliedRequestV1(CommandQueuedReceiptV1.decodePayload(
                request.getCommandQueuedReceiptV1().toByteArray()));
    }

    private static com.nereusstream.delay.gateway.GatewayGetMessageRequestV1 decodeGetMessage(
            final GatewayGetMessageRequestV1 request) {
        if (request.hasDelayMessageId()) {
            return new com.nereusstream.delay.gateway.GatewayGetMessageRequestV1(
    ...
    private static void complete(
        ...
        final com.nereusstream.delay.gateway.v1.GatewaySubmissionOutcomeV1.Builder builder =
                com.nereusstream.delay.gateway.v1.GatewaySubmissionOutcomeV1.newBuilder();
    ...
    private static void complete(
            final StreamObserver<com.nereusstream.delay.gateway.v1.GatewayPayloadUploadHandleResponseV1>
                    responseObserver,
            final PayloadUploadHandleResponseV1 response,
            final Throwable failure) {
        if (failure != null || response == null) {
            fail(responseObserver, statusFor(failure));
            return;
        }
        responseObserver.onNext(com.nereusstream.delay.gateway.v1.GatewayPayloadUploadHandleResponseV1.newBuilder()
    ...
    private static void complete(
            final StreamObserver<com.nereusstream.delay.gateway.v1.GatewayPayloadAttestationResponseV1>
                    responseObserver,
            final PayloadAttestationResponseV1 response,
            final Throwable failure) {
        if (failure != null || response == null) {
            fail(responseObserver, statusFor(failure));
            return;
        }
        responseObserver.onNext(com.nereusstream.delay.gateway.v1.GatewayPayloadAttestationResponseV1.newBuilder()
    ...
    private static void complete(
            final StreamObserver<com.nereusstream.delay.gateway.v1.GatewayCommandQueryResponseV1> responseObserver,
            final CommandQueryResponseV1 response,
            final Throwable failure) {
        if (failure != null || response == null) {
            fail(responseObserver, statusFor(failure));
            return;
        }
        responseObserver.onNext(com.nereusstream.delay.gateway.v1.GatewayCommandQueryResponseV1.newBuilder()
    ...
    private static void completeStream(
            final StreamObserver<com.nereusstream.delay.gateway.v1.GatewayCommandQueryResponseV1> responseObserver,
            final List<CommandQueryResponseV1> responses,
            final Throwable failure) {
    ...
    private static void complete(
            final StreamObserver<com.nereusstream.delay.gateway.v1.GatewayMessageQueryResponseV1> responseObserver,
            final MessageQueryResponseV1 response,
            final Throwable failure) {
        if (failure != null || response == null) {
            fail(responseObserver, statusFor(failure));
            return;
        }
        responseObserver.onNext(com.nereusstream.delay.gateway.v1.GatewayMessageQueryResponseV1.newBuilder()
