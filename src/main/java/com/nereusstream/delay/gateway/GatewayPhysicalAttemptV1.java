...
public final class GatewayPhysicalAttemptV1 {
    ...
    public GatewayPhysicalAttemptV1(
            final int attemptNo,
    ...
    public static GatewayPhysicalAttemptV1 decode(final byte[] encoded) {
        ...
        final GatewayPhysicalAttemptStateV1 state =
                GatewayPhysicalAttemptStateV1.fromWire(uint(field(fields, index++, 3), 3));
        final byte[] outcomeBytes;
        ...
        final GatewayPhysicalAttemptV1 result = new GatewayPhysicalAttemptV1(
                attemptNo,
                physicalAttemptId,
                state,
                outcomeBytes,
