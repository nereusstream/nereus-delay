...
public final class GatewayPayloadIngressService {
    ...
    public GatewayPayloadIngressService(
            final GatewayPayloadAuthority payloadAuthority,
    ...
    private <T> CompletionStage<T> invoke(
            final AuthenticatedTenantContext tenant, final byte[] canonicalBody, final PayloadCall<T> call) {
