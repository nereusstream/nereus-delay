...
public final class WorkerCommandRuntime {
    ...
    public ClaimHandoffWorkClassExecutor.Submission submitClaim(final ClaimRequest request) {
        ...
        return claimExecutor.submit(
                exact.item(),
                exact.evidence(),
                exact.claimDeadlineEpochMs(),
    ...
    public PublishAdmissionWorkClassExecutor.Submission submitPublish(final PublishRequest request) {
        ...
        return publishExecutor.submit(
                ...
                exact.reservation(),
                exact.descriptor(),
                exact.readyCertificate(),
                exact.decisionTime(),
                exact.retryUntilEpochMs(),
                exact.signingKeyVersion(),
                exact.signingKey(),
                exact.ownerClock());
    }
     ...
     */
    public PublishAdmissionWorkClassExecutor.Submission submitPublish(
            final ClaimHandoffWorkClassExecutor.ClaimHandoffResult claimResult, final PublishPreparation preparation) {
        ...
        return submitPublish(
                completed.claim(),
                completed.reservation(),
                external.channel(),
                external.readyCertificate(),
                external.decisionTime(),
                external.retryUntilEpochMs(),
                external.signingKeyVersion(),
                external.signingKey(),
                external.ownerClock());
    }
