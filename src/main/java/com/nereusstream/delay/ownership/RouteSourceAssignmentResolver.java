...
public final class RouteSourceAssignmentResolver {
    ...
    public Resolved activeResolved(
            ...
            final byte[] assignmentId,
            final long assignmentEpoch) {
        final RouteSnapshot route = Objects.requireNonNull(
    ...
    public Resolved exactResolved(
        ...
        final RouteSnapshot route = routeProvider.exact(expected, Objects.requireNonNull(context, "context"));
    ...
    public record Resolved(RouteSnapshot routeSnapshot, SourceAssignment sourceAssignment) {
        public Resolved {
