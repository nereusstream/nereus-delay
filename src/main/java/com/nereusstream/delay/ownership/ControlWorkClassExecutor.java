...
public final class ControlWorkClassExecutor {
    ...
    public ControlWorkClassExecutor(
    ...
    public Submission submit(final SystemMutation mutation, final LongSupplier ownerClock) {
        ...
        final WorkClassTask task = new WorkClassTask(
                ...
                "control-mutation/" + Bytes.hex(Bytes.sha256(TASK_ID_DOMAIN, frame)),
                frame.length);
        ...
        try {
            ...
            switch (appended.disposition()) {
                ...
                case DEFINITIVELY_NOT_PERSISTED ->
                    submission.complete(ControlHandoffResult.definitelyNotPersisted(mutation));
    ...
    public record ControlHandoffResult(
        ...
        private static ControlHandoffResult persisted(final SystemMutation mutation, final SourcePosition position) {
            return new ControlHandoffResult(
