 ...
 */
public record SourceReplayOutcome(
        SourcePosition position, CommandResult commandResult, SystemMutationResult systemMutationResult) {
    public SourceReplayOutcome {
        ...
        if (systemMutationResult != null && !Arrays.equals(sourceBytes, systemMutationResult.appliedSourcePosition())) {
    ...
    public static SourceReplayOutcome systemMutation(final SourcePosition position, final SystemMutationResult result) {
