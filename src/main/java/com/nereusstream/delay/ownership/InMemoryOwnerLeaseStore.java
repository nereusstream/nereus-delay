...
public final class InMemoryOwnerLeaseStore implements OwnerLeaseStore {
    ...
    @Override
    public synchronized Optional<OwnerLease> acquire(
    ...
    @Override
    public synchronized Optional<OwnerLease> renew(
    ...
    @Override
    public synchronized Optional<OwnerLease> transition(
            final OwnerLease expected, final ShardLifecycleState nextState) {
    ...
    private static boolean same(final OwnerLease left, final OwnerLease right) {
        return left != null
                && right != null
                && left.shardId().equals(right.shardId())
