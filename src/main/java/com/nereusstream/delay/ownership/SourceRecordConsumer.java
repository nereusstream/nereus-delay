...
public interface SourceRecordConsumer extends AutoCloseable {
        ...
        public SourceAcknowledgement acknowledgement() {
            return (candidate, outcome) -> {
                ...
                return Objects.requireNonNull(
                        acknowledger.acknowledge(candidate, outcome), "source acknowledgement result");
            };
        }
    }
    ...
    interface Acknowledger {
        SourceAcknowledgement.AcknowledgementResult acknowledge(
                SourceReplayEntry entry, SourceReplayOutcome appliedOutcome);
    }
}
