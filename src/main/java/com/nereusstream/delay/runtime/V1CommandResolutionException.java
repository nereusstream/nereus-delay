...
/**
 * Fail-closed error returned by the local V1 Profile/Adapter/Lane resolver.
 *
 ...
 * legacy command.</p>
 */
public final class V1CommandResolutionException extends IllegalArgumentException {
    private static final long serialVersionUID = 1L;

    private final StableCode stableCode;

    public V1CommandResolutionException(final StableCode stableCode, final String message) {
