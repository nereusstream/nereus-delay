...
public record TerminalGenerationRecord(
        ...
        com.nereusstream.delay.protocol.StableCode terminalCode,
        long stateVersion,
    ...
    public TerminalGenerationRecord(
            ...
            final com.nereusstream.delay.protocol.StableCode terminalCode,
    ...
    public TerminalGenerationRecord {
        ...
        if (!messageId.routingId().shardId().equals(decodedSourcePosition.shardId())) {
            throw new IllegalArgumentException("terminal source position belongs to another shard");
        }
        ...
        for (int index = 0; index < sorted.size(); index++) {
            final AttemptObligationRef obligation =
                    Objects.requireNonNull(sorted.get(index), "null terminal obligation");
    ...
    public byte[] encode() {
        ...
        return Bytes.concat(
                ...
                new byte[] {(byte) status.wireValue()},
                Bytes.u32be(terminalCode.wireValue()),
                Bytes.u64be(stateVersion),
                new byte[] {(byte) (possibleDestinationDuplicate ? 1 : 0)},
                Bytes.lp32(appliedSourcePosition),
                Bytes.u32be(openObligations.size()),
                encodedObligations);
    }
    ...
    public static TerminalGenerationRecord decode(final byte[] encoded) {
        ...
        final com.nereusstream.delay.protocol.StableCode code =
                com.nereusstream.delay.protocol.StableCode.fromWire(readInt(input, "terminalCode"));
        ...
        final TerminalGenerationRecord result = new TerminalGenerationRecord(
