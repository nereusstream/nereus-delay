...
public interface V1ScheduleResolver {
    ResolvedSchedule resolveSchedule(
            ShardId shardId, DelayMessageId messageId, ScheduleIntentV1 intent, SourcePosition sourcePosition);

    ResolvedPrepare resolvePrepare(
            ShardId shardId, DelayMessageId messageId, PrepareLargeScheduleBodyV1 body, SourcePosition sourcePosition);
