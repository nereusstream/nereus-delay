...
public record CommandResult(
    ...
    public byte[] encode() {
        ...
        result.putInt(1)
                .put((byte) applyStatus.wireValue())
                .putInt(stableCode.wireValue())
                .putInt(generation)
                .putLong(stateVersion)
                .put((byte) (messageStatus == null ? 0 : messageStatus.wireValue()))
                .putInt(appliedSourcePosition.length)
                .put(appliedSourcePosition);
        return result.array();
    }
    ...
    public static CommandResult decode(final byte[] encoded) {
        ...
        final StableCode code = java.util.Arrays.stream(StableCode.values())
                ...
                .findFirst()
                .orElseThrow(() -> new IllegalArgumentException("unknown stable code: " + stableCode));
    ...
    public boolean equals(final Object other) {
        ...
        return applyStatus == that.applyStatus
