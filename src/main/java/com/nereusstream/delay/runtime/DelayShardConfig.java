...
public record DelayShardConfig(
    ...
    public DelayShardConfig(
            ...
            final long minDeliveryWindowMs,
            final long maxMessageLifetimeMs,
            final long maxPendingMessages,
            final long maxPendingBytes,
            final long maxLanes,
            final long inlinePayloadThresholdBytes,
        ...
        this(
                ...
                0,
                defaultOutcomeReserveBytes(maxPendingBytes),
                defaultOutcomeReserveRecords(boundedAdmissionCap(maxPendingMessages)),
                0,
                maxMessageLifetimeMs,
                0,
                0,
    ...
    public DelayShardConfig(
        ...
        this(
                ...
                maxUncertainRetries,
                defaultOutcomeReserveBytes(maxPendingBytes),
                defaultOutcomeReserveRecords(maxPublishAdmissions),
                0,
                maxMessageLifetimeMs,
                0,
                0,
    ...
    public DelayShardConfig(
            ...
            final int maxPublishAdmissions,
            final int maxUncertainRetries,
            final long maxOutcomeReserveBytes,
        ...
        this(
                ...
                maxPublishAdmissions,
                maxUncertainRetries,
                maxOutcomeReserveBytes,
                maxOutcomeReserveRecords,
                0,
                maxMessageLifetimeMs,
                0,
                0,
    ...
    public DelayShardConfig(
        ...
        this(
                ...
                maximumAdmissionMutationEnqueueAgeMs,
                0,
                0,
                0,
                0);
    ...
    public DelayShardConfig(
            ...
            final long maxIngressBrokerTimestampDivergenceMs,
            final long maximumAdmissionMutationEnqueueAgeMs,
            final long commandRetryWindowMs,
            final long maximumPreparationAgeMs,
            final long maximumUuidFutureSkewMs) {
        this(
                maxDelayHorizonMs,
                minDeliveryWindowMs,
                maxMessageLifetimeMs,
    ...
    public DelayShardConfig {
        ...
        final boolean strictIdentityPolicy =
                commandRetryWindowMs != 0 || maximumPreparationAgeMs != 0 || maximumUuidFutureSkewMs != 0;
