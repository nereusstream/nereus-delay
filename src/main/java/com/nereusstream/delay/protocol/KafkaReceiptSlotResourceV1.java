...
public final class KafkaReceiptSlotResourceV1 {
    ...
    public KafkaReceiptSlotResourceV1(
    ...
    public static KafkaReceiptSlotResourceV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields =
                QueryCodecSupport.read(encoded, "KafkaReceiptSlotResourceV1");
        QueryCodecSupport.requireNumbers(fields, new int[] {1, 2, 3, 4, 5, 6}, "KafkaReceiptSlotResourceV1");
