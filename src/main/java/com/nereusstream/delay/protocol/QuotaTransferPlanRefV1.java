...
public final class QuotaTransferPlanRefV1 {
    ...
    public static QuotaTransferPlanRefV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields = QueryCodecSupport.read(encoded, "QuotaTransferPlanRefV1");
    ...
    public boolean equals(final Object other) {
        return other instanceof QuotaTransferPlanRefV1 that
