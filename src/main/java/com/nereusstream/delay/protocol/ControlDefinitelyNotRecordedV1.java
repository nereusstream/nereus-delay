...
public final class ControlDefinitelyNotRecordedV1 {
    ...
    public ControlDefinitelyNotRecordedV1(
            final byte[] preparedDigest, final ControlNonPersistenceProofV1 proof, final StableErrorV1 error) {
    ...
    public static ControlDefinitelyNotRecordedV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields =
                QueryCodecSupport.read(encoded, "ControlDefinitelyNotRecordedV1");
