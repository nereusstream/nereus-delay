...
public final class SloTimeEndpoint {
    ...
    public SloTimeEndpointKind kind() {
        return kind;
    }
    ...
    public static SloTimeEndpoint decode(final byte[] encoded) {
        final var fields = QueryCodecSupport.read(encoded, "SloTimeEndpoint");
        QueryCodecSupport.requireNumbers(fields, new int[] {1, 2, 3, 4}, "SloTimeEndpoint");
        final SloTimeEndpoint result = new SloTimeEndpoint(
                SloTimeEndpointKind.fromWire(QueryCodecSupport.uint(fields.get(0), 1)),
        ...
        QueryCodecSupport.requireCanonical(encoded, result.canonicalBytes(), "SloTimeEndpoint");
        return result;
    }
    ...
    public boolean equals(final Object other) {
        return other instanceof SloTimeEndpoint that
                && kind == that.kind
