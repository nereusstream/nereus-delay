...
public final class CompatibleControlSnapshotV1 {
    ...
    public CompatibleControlSnapshotV1(
    ...
    private CompatibleControlSnapshotV1(
            final ShardSubjectV1 shard,
            final List<ProtocolTupleV1> protocolTuples,
            final List<ProfileRefV1> profiles,
            final QuotaGrantRefV1 initialQuotaGrant,
    ...
    public static CompatibleControlSnapshotV1 decode(final byte[] encoded) {
        ...
        final CompatibleControlSnapshotV1 result =
                new CompatibleControlSnapshotV1(shard, tuples, profiles, grant, digest);
