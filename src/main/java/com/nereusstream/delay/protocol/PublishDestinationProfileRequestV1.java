...
public final class PublishDestinationProfileRequestV1 implements ControlOperationRequestBranchV1 {
    ...
    public PublishDestinationProfileRequestV1(
            final ProfileSemanticEnvelopeV1 profile, final CredentialBindingV1 credentialBinding) {
    ...
    public static PublishDestinationProfileRequestV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields =
                QueryCodecSupport.read(encoded, "PublishDestinationProfileRequestV1");
        ...
        QueryCodecSupport.requireCanonical(encoded, result.canonicalBytes(), "PublishDestinationProfileRequestV1");
        return result;
    }
