...
public final class AcknowledgementV1 {
    ...
    public AcknowledgementV1(
            final AcknowledgementKindV1 kind, final byte[] acknowledgementHash, final byte[] ticketScopeHash) {
    ...
    public boolean equals(final Object other) {
        return other instanceof AcknowledgementV1 that
                && kind == that.kind
