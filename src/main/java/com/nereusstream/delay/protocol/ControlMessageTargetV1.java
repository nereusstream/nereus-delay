...
public final class ControlMessageTargetV1 {
    ...
    public static ControlMessageTargetV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields = QueryCodecSupport.read(encoded, "ControlMessageTargetV1");
    ...
    public boolean equals(final Object other) {
        return other instanceof ControlMessageTargetV1 that
