...
public final class CanonicalLaneTupleV1 {
    ...
    static void requireProfileProjection(
            final byte[] encoded, final ProfileRefV1 destination, final ProfileRefV1 capability) {
    ...
    private static Projection parse(final byte[] encoded) {
        ...
        return new Projection(
                ...
                new ProfileRefV1(capabilityId, capabilityVersion, capabilityHash, ProfileKindV1.DELIVERY_CAPABILITY));
    }
    ...
    public record Projection(
            BrokerResourceIdentityV1 targetResource,
