...
public final class ControlOperationReceiptV1 {
    ...
    private ControlOperationReceiptV1(
    ...
    public static ControlOperationReceiptV1 create(
            final byte[] operationId,
            final byte[] requestHash,
            final byte[] authenticatedScopeHash,
            final byte[] targetSnapshotHash,
        ...
        final byte[] fields = canonicalFields(
                ...
                registeredAt,
                queryUntilEpochMs);
        return new ControlOperationReceiptV1(
                operationId,
                requestHash,
                authenticatedScopeHash,
                targetSnapshotHash,
    ...
    public static ControlOperationReceiptV1 createWithQueryWindow(
            final byte[] operationId,
            final byte[] requestHash,
            final byte[] authenticatedScopeHash,
            final byte[] targetSnapshotHash,
    ...
    public static ControlOperationReceiptV1 decodePayload(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields =
                QueryCodecSupport.read(encoded, "ControlOperationReceiptV1");
        QueryCodecSupport.requireNumbers(fields, new int[] {1, 2, 3, 4, 5, 6, 7, 8, 9}, "ControlOperationReceiptV1");
        ...
        final ControlOperationReceiptV1 result = new ControlOperationReceiptV1(
