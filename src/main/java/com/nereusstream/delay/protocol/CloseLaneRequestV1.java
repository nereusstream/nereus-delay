...
public final class CloseLaneRequestV1 implements ControlOperationRequestBranchV1 {
    ...
    public CloseLaneRequestV1(
            final ControlReasonV1 reason,
            final ClosePolicyV1 closePolicy,
        ...
        if (allowOrderBreak
                && (!acknowledgements.has(AcknowledgementKindV1.ORDER_LOSS)
    ...
    public static CloseLaneRequestV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields = QueryCodecSupport.read(encoded, "CloseLaneRequestV1");
    ...
    public boolean equals(final Object other) {
        return other instanceof CloseLaneRequestV1 that
