...
public final class ControlRegistrationBindingV1 {
    ...
    public static void validate(
            final PreparedControlOperationV1 prepared, final ControlRegistrationOutcomeMessageV1 outcome) {
    ...
    private static void validateReceipt(
            final PreparedControlOperationV1 prepared, final ControlOperationReceiptV1 receipt) {
