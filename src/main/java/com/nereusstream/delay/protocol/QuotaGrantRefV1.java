...
public final class QuotaGrantRefV1 {
    ...
    public QuotaGrantRefV1(
            final byte[] grantId, final long grantVersion, final PublishAdmissionBody.ChargeVector limit) {
    ...
    public boolean equals(final Object other) {
        return other instanceof QuotaGrantRefV1 that
