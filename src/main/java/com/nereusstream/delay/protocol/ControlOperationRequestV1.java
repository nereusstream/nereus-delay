...
public final class ControlOperationRequestV1 {
    ...
    public ControlOperationRequestV1(final ControlOperationKindV1 kind, final ControlOperationRequestBranchV1 branch) {
    ...
    public static ControlOperationRequestV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields =
                QueryCodecSupport.read(encoded, "ControlOperationRequestV1");
        if (fields.size() != 1) {
        ...
        final ControlOperationRequestV1 result = new ControlOperationRequestV1(
                kind, decodeBranch(kind, QueryCodecSupport.nested(field, field.number())));
    ...
    public static ControlOperationRequestV1 stopNewSchedules(final ControlReasonV1 reason) {
        return new ControlOperationRequestV1(
                ControlOperationKindV1.STOP_NEW_SCHEDULES, new StopNewSchedulesRequestV1(reason));
    }
    ...
    public static ControlOperationRequestV1 laneGate(
            final ControlOperationKindV1 kind, final LaneGateRequestV1 branch) {
    ...
    public static ControlOperationRequestV1 getCheckpointCatalog() {
        return new ControlOperationRequestV1(
                ControlOperationKindV1.GET_CHECKPOINT_CATALOG, GetCheckpointCatalogRequestV1.instance());
    }
    ...
    public static ControlOperationRequestV1 publishDestinationProfile(final PublishDestinationProfileRequestV1 branch) {
    ...
    public static ControlOperationRequestV1 rotateEquivalentSecret(final RotateEquivalentSecretRequestV1 branch) {
        return new ControlOperationRequestV1(ControlOperationKindV1.ROTATE_EQUIVALENT_SECRET_REFERENCE, branch);
    }

    private static ControlOperationRequestBranchV1 decodeBranch(
            final ControlOperationKindV1 kind, final byte[] encoded) {
        return switch (kind) {
    ...
    private static void validateBranch(
            final ControlOperationKindV1 kind, final ControlOperationRequestBranchV1 branch) {
        final boolean valid =
                switch (kind) {
                    ...
                    case DEPRECATE_DESTINATION_PROFILE_VERSION ->
                        branch instanceof DeprecateDestinationProfileRequestV1;
    ...
    public boolean equals(final Object other) {
        return other instanceof ControlOperationRequestV1 that && kind == that.kind && branch.equals(that.branch);
    }
