...
public final class IngressCredentialBindingRefV1 {
    ...
    public IngressCredentialBindingRefV1(
    ...
    public static IngressCredentialBindingRefV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields =
                QueryCodecSupport.read(encoded, "IngressCredentialBindingRefV1");
    ...
    public boolean equals(final Object other) {
        return other instanceof IngressCredentialBindingRefV1 that
