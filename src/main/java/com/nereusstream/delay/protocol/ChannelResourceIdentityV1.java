...
public final class ChannelResourceIdentityV1 {
    ...
    public ChannelResourceIdentityV1(
    ...
    public static ChannelResourceIdentityV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields =
                QueryCodecSupport.read(encoded, "ChannelResourceIdentityV1");
    ...
    private void validateAdapterAndChannel() {
        final boolean targetMatches =
                (adapterKind == AdapterKindV1.KAFKA && targetResource.kind() == BrokerResourceIdentityV1.Kind.KAFKA)
        ...
        if ((channelKind == ChannelKindV1.PULSAR_DEDUP_PRODUCER || channelKind == ChannelKindV1.PULSAR_NATIVE_DELAYED)
                && adapterKind != AdapterKindV1.PULSAR) {
