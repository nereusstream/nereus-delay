...
public final class ForceCheckpointRequestV1 implements ControlOperationRequestBranchV1 {
    ...
    public static ForceCheckpointRequestV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields = QueryCodecSupport.read(encoded, "ForceCheckpointRequestV1");
        QueryCodecSupport.requireNumbers(fields, new int[] {1}, "ForceCheckpointRequestV1");
        final ForceCheckpointRequestV1 result =
                new ForceCheckpointRequestV1(ControlReasonV1.decode(QueryCodecSupport.nested(fields.get(0), 1)));
