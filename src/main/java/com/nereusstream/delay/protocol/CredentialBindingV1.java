...
public final class CredentialBindingV1 {
    ...
    public static CredentialBindingV1 create(
            final ProfileRefV1 profile,
            final long secretGeneration,
            final byte[] secretReference,
            final CredentialEquivalenceAttestationV1 equivalenceAttestation) {
        ...
        return new CredentialBindingV1(
                profile,
                secretGeneration,
                reference,
                referenceHash,
    ...
    public static CredentialBindingV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields = QueryCodecSupport.read(encoded, "CredentialBindingV1");
        ...
        final CredentialBindingV1 result = new CredentialBindingV1(
