...
public final class SubmissionOutcomeMessageV1 {
    ...
    private SubmissionOutcomeMessageV1(
            final SubmissionOutcomeKindV1 kind,
        ...
        if (branches != 1
                || (kind == SubmissionOutcomeKindV1.MANAGED) != (managed != null)
                || (kind == SubmissionOutcomeKindV1.NATIVE_RECEIPT) != (nativeReceipt != null)
                || (kind == SubmissionOutcomeKindV1.NATIVE_DEFINITELY_NOT_QUEUED) != (nativeDefinitelyNotQueued != null)
    ...
    public static SubmissionOutcomeMessageV1 managed(final EnqueueOutcomeMessageV1 outcome) {
        return new SubmissionOutcomeMessageV1(
                SubmissionOutcomeKindV1.MANAGED, Objects.requireNonNull(outcome, "outcome"), null, null, null);
    }

    public static SubmissionOutcomeMessageV1 nativeReceipt(final NativeDeliveryReceiptV1 receipt) {
        return new SubmissionOutcomeMessageV1(
                SubmissionOutcomeKindV1.NATIVE_RECEIPT, null, Objects.requireNonNull(receipt, "receipt"), null, null);
    }

    public static SubmissionOutcomeMessageV1 nativeDefinitelyNotQueued(final NativeDefinitelyNotQueuedV1 outcome) {
        return new SubmissionOutcomeMessageV1(
                SubmissionOutcomeKindV1.NATIVE_DEFINITELY_NOT_QUEUED,
                null,
                null,
    ...
    public static SubmissionOutcomeMessageV1 nativeUncertain(final NativeEnqueueUncertainV1 outcome) {
        return new SubmissionOutcomeMessageV1(
                SubmissionOutcomeKindV1.NATIVE_ENQUEUE_UNCERTAIN,
                null,
                null,
                null,
                Objects.requireNonNull(outcome, "outcome"));
    ...
    public static SubmissionOutcomeMessageV1 decode(final byte[] encoded) {
        ...
        final SubmissionOutcomeKindV1 kind = SubmissionOutcomeKindV1.fromWire(QueryCodecSupport.uint(fields.get(0), 1));
        final SubmissionOutcomeMessageV1 result =
                switch (fields.get(1).number()) {
                    ...
                    case 11 -> {
                        ...
                        yield nativeReceipt(
                                NativeDeliveryReceiptV1.decodePayload(QueryCodecSupport.nested(fields.get(1), 11)));
                    }
                    case 12 -> {
                    ...
                    case 13 -> {
                        ...
                        yield nativeUncertain(
                                NativeEnqueueUncertainV1.decode(QueryCodecSupport.nested(fields.get(1), 13)));
                    }
    ...
    public boolean equals(final Object other) {
        return other instanceof SubmissionOutcomeMessageV1 that
                && kind == that.kind
