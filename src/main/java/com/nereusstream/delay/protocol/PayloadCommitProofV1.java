...
public final class PayloadCommitProofV1 implements PayloadCommitProofView {
    ...
    public static PayloadCommitProofV1 signed(
            final byte[] reservationId,
            final byte[] tenantRoutingScope,
            final byte[] routeIncarnationUuid,
            final int partition,
        ...
        final PayloadCommitProofV1 unsigned = new PayloadCommitProofV1(
                reservationId,
                tenantRoutingScope,
        ...
        return new PayloadCommitProofV1(
                reservationId,
                tenantRoutingScope,
                routeIncarnationUuid,
                partition,
    ...
    public static PayloadCommitProofV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields = QueryCodecSupport.read(encoded, "PayloadCommitProofV1");
        ...
        final PayloadCommitProofV1 result = new PayloadCommitProofV1(
                reservationId,
                tenantRoutingScope,
                route,
                partition,
