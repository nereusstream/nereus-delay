...
public final class V1ScheduleBinding {
    ...
    public void requireClaimLaneProjection(final ClaimMaterializationV1 materialization) {
        CanonicalLaneTupleV1.requireClaimProjection(
                canonicalLaneTuple, Objects.requireNonNull(materialization, "materialization"));
    }

    @Override
    public boolean equals(final Object other) {
        return other instanceof V1ScheduleBinding that
    ...
    public static V1ScheduleBinding decode(final byte[] encoded) {
        ...
        final V1ScheduleBinding result = new V1ScheduleBinding(
                commandType, new DelayMessageId(message), new DestinationLaneId(lane), tuple, body);
