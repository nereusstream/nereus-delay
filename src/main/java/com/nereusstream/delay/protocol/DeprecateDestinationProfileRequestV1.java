...
public final class DeprecateDestinationProfileRequestV1 implements ControlOperationRequestBranchV1 {
    ...
    public static DeprecateDestinationProfileRequestV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields =
                QueryCodecSupport.read(encoded, "DeprecateDestinationProfileRequestV1");
        ...
        QueryCodecSupport.requireCanonical(encoded, result.canonicalBytes(), "DeprecateDestinationProfileRequestV1");
        return result;
    }
