...
public final class ControlTargetStateViewV1 {
    ...
    public ControlTargetStateViewV1(
            final long targetIndex,
            final TargetMarkerStateV1 markerState,
    ...
    private ControlTargetStateViewV1(
            final long targetIndex,
            final TargetMarkerStateV1 markerState,
            final StableCode stableCode,
            final long targetRevision,
    ...
    public boolean equals(final Object other) {
        return other instanceof ControlTargetStateViewV1 that
