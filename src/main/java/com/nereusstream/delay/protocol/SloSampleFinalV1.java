...
public final class SloSampleFinalV1 {
    ...
    public void validateAgainst(final SloSampleStartV1 start) {
        ...
        if (exclusionReason != null
                && (start.objective() != SloObjectiveNameV1.DUE_ADMISSION_LAG
     ...
     */
    public static SloSampleFinalV1 merge(
            final SloSampleFinalV1 current, final SloSampleFinalV1 incoming, final SloThresholdDirectionV1 direction) {
        ...
        final DueExclusionReasonV1 exclusion =
    ...
    public static SloSampleFinalV1 decode(final byte[] encoded) {
        ...
        final SloSampleFinalV1 result = new SloSampleFinalV1(
                ...
                fields.size() == 12 ? DueExclusionReasonV1.fromWire(QueryCodecSupport.uint(fields.get(7), 8)) : null,
