...
public final class ActivationBarrierV1 {
    ...
    private ActivationBarrierV1(
        ...
        if (kind == Kind.EMPTY
                && resource.kind() == BrokerResourceIdentityV1.Kind.KAFKA
        ...
        if (kind == Kind.EMPTY
                && resource.kind() == BrokerResourceIdentityV1.Kind.PULSAR
                && (guardedSourceConnectionGeneration == null || this.resourceGuardAttestationDigest == null)) {
    ...
    public static ActivationBarrierV1 empty(
            final BrokerResourceIdentityV1 resource,
            final int partition,
            final Long guardedSourceConnectionGeneration,
            final byte[] resourceGuardAttestationDigest) {
        return new ActivationBarrierV1(
                Kind.EMPTY,
                resource,
                partition,
    ...
    public static ActivationBarrierV1 kafka(
            final BrokerResourceIdentityV1 resource,
            final int partition,
            final long nextOffsetExclusive,
            final long observedLsoExclusive) {
    ...
    public static ActivationBarrierV1 pulsar(
            final BrokerResourceIdentityV1 resource,
            final int partition,
            final long ledgerId,
            final long entryId,
    ...
    public boolean equals(final Object other) {
        return other instanceof ActivationBarrierV1 that
                && kind == that.kind
