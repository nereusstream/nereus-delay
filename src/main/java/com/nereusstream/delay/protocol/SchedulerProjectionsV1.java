...
public final class SchedulerProjectionsV1 {
    ...
    public static final class ReadyDiscoveryCursor {
        ...
        public ReadyDiscoveryCursor(
            ...
            this.digest = SchedulerProjectionsV1.digest(
                    "nereus-delay-scheduler-ready-discovery-cursor-v1\0", fieldsOneToFive());
        }
        ...
        public static ReadyDiscoveryCursor decode(final byte[] encoded) {
            ...
            requireDigest(
                    result.digest, result.fieldsOneToFive(), "nereus-delay-scheduler-ready-discovery-cursor-v1\0");
    ...
    public static final class Round {
        ...
        public static Round decode(final byte[] encoded) {
            ...
            final Round result = new Round(
                    uint(fields.get(1), 2),
                    OwnerIdentityV1.decode(bytes(fields.get(2), 3)),
                    bool(fields.get(3), 4),
    ...
    public static final class LastServedMap {
        ...
        public LastServedMap(final List<LastServedEntry> entries) {
            ...
            this.digest =
                    SchedulerProjectionsV1.digest("nereus-delay-scheduler-last-served-map-v1\0", fieldsOneAndTwo());
        }
