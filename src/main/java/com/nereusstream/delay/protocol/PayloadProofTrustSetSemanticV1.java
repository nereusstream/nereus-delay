...
public final class PayloadProofTrustSetSemanticV1 {
    ...
    public PayloadProofTrustSetSemanticV1(final long version, final List<PayloadProofVerifierKeyV1> keys) {
        if (version == 0) {
    ...
    public static PayloadProofTrustSetSemanticV1 decode(final byte[] encoded) {
        ...
        final PayloadProofTrustSetSemanticV1 result =
                new PayloadProofTrustSetSemanticV1(QueryCodecSupport.uint64Bits(fields.get(0), 1), keys);
    ...
    private static List<PayloadProofVerifierKeyV1> sortedUnique(final List<PayloadProofVerifierKeyV1> values) {
    ...
    public boolean equals(final Object other) {
        return other instanceof PayloadProofTrustSetSemanticV1 that
