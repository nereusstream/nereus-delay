...
public final class CommandBodies {
    ...
    public static byte[] scheduleV1(
            final DelayMessageId delayMessageId, final long retryUntilEpochMs, final ScheduleIntentV1 intent) {
    ...
    public static byte[] prepareLargeV1(
        ...
        return new PrepareLargeScheduleBodyV1(
                        delayMessageId,
                        retryUntilEpochMs,
    ...
    public static byte[] commitLargeV1(
            final DelayMessageId delayMessageId,
            final long retryUntilEpochMs,
            final byte[] reservationId,
            final PayloadCommitProofV1 proof) {
        return new CommitLargeScheduleBodyV1(delayMessageId, retryUntilEpochMs, reservationId, proof).canonicalBytes();
    }
    ...
    public static byte[] rescheduleV1(
            final DelayMessageId delayMessageId,
            final long retryUntilEpochMs,
            final MessagePreconditionV1 precondition,
            final long deliverAt,
            final long expireAt) {
        return new RescheduleCommandBodyV1(delayMessageId, retryUntilEpochMs, precondition, deliverAt, expireAt)
                .canonicalBytes();
    }
