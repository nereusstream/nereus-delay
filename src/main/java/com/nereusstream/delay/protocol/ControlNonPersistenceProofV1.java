...
public final class ControlNonPersistenceProofV1 {
    ...
    private ControlNonPersistenceProofV1(
            final ControlNonPersistenceProofKindV1 kind,
    ...
    public static ControlNonPersistenceProofV1 create(
            final ControlNonPersistenceProofKindV1 kind,
            final byte[] operationId,
            final byte[] preparedDigest,
            final byte[] oxiaTransactionSha256,
        ...
        return new ControlNonPersistenceProofV1(
                kind,
                operationId,
                preparedDigest,
    ...
    public static ControlNonPersistenceProofV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields =
                QueryCodecSupport.read(encoded, "ControlNonPersistenceProofV1");
        ...
        final ControlNonPersistenceProofKindV1 kind =
                ControlNonPersistenceProofKindV1.fromWire(QueryCodecSupport.uint(fields.get(0), 1));
        ...
        final ControlNonPersistenceProofV1 result =
                new ControlNonPersistenceProofV1(kind, operationId, preparedDigest, transaction, response, digest);
    ...
    private static void validatePresence(
            final ControlNonPersistenceProofKindV1 kind, final byte[] transaction, final byte[] response) {
    ...
    public boolean equals(final Object other) {
        return other instanceof ControlNonPersistenceProofV1 that
                && kind == that.kind
