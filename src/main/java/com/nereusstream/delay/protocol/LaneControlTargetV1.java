...
public final class LaneControlTargetV1 {
    ...
    public LaneControlTargetV1(
            final byte[] laneId, final byte[] laneIncarnation, final long expectedLaneControlVersion) {
    ...
    public static LaneControlTargetV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields = QueryCodecSupport.read(encoded, "LaneControlTargetV1");
        QueryCodecSupport.requireNumbers(fields, new int[] {1, 2, 3}, "LaneControlTargetV1");
        final LaneControlTargetV1 result = new LaneControlTargetV1(
        ...
        QueryCodecSupport.requireCanonical(encoded, result.canonicalBytes(), "LaneControlTargetV1");
        return result;
    }

    @Override
    public boolean equals(final Object other) {
        return other instanceof LaneControlTargetV1 that
