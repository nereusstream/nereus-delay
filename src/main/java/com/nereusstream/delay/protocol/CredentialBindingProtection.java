...
public final class CredentialBindingProtection {
    public static final int HASH_LENGTH = 32;
    private static final byte[] DIGEST_DOMAIN = Bytes.utf8("nereus-delay-credential-binding-protection\0");
    ...
    public CredentialBindingProtection(
        ...
        this.managedChannelProtectionUntilEpochMs =
                nonNegative(managedChannelProtectionUntilEpochMs, "managedChannelProtectionUntilEpochMs");
        this.objectStoreLeaseProtectionUntilEpochMs =
                nonNegative(objectStoreLeaseProtectionUntilEpochMs, "objectStoreLeaseProtectionUntilEpochMs");
        this.nativeCapabilityProtectionUntilEpochMs =
                nonNegative(nativeCapabilityProtectionUntilEpochMs, "nativeCapabilityProtectionUntilEpochMs");
        this.uploadHandleProtectionUntilEpochMs =
                nonNegative(uploadHandleProtectionUntilEpochMs, "uploadHandleProtectionUntilEpochMs");
        ...
        if (!Bytes.constantTimeEquals(this.protectionDigest, digestForFields())) {
            throw new IllegalArgumentException("CredentialBindingProtection digest mismatch");
        }
    }

    public static CredentialBindingProtection create(
            final ProfileRef profile,
            final long secretGeneration,
            final byte[] bindingDigest,
            final long managedChannelProtectionUntilEpochMs,
        ...
        final byte[] digest = digestForFields(
                ...
                protectionRevision);
        return new CredentialBindingProtection(
                profile,
                secretGeneration,
                bindingDigest,
                managedChannelProtectionUntilEpochMs,
    ...
    public static CredentialBindingProtection forBinding(
    ...
    public static CredentialBindingProtection decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields =
                QueryCodecSupport.read(encoded, "CredentialBindingProtection");
        QueryCodecSupport.requireNumbers(fields, new int[] {1, 2, 3, 4, 5, 6, 7, 8, 9}, "CredentialBindingProtection");
        final CredentialBindingProtection result = new CredentialBindingProtection(
        ...
        QueryCodecSupport.requireCanonical(encoded, result.canonicalBytes(), "CredentialBindingProtection");
        return result;
    }
    ...
    public boolean equals(final Object other) {
        return other instanceof CredentialBindingProtection that
