...
public final class BrokerResourceIdentityV1 {
    ...
    private BrokerResourceIdentityV1(
            final KafkaBrokerResourceIdentityV1 kafka, final PulsarBrokerResourceIdentityV1 pulsar) {
    ...
    public boolean equals(final Object other) {
        return other instanceof BrokerResourceIdentityV1 that
