...
public final class SecretRotationResult {
    ...
    public static SecretRotationResult decode(final byte[] encoded) {
        final var fields = QueryCodecSupport.read(encoded, "SecretRotationResult");
        QueryCodecSupport.requireNumbers(fields, new int[] {1, 2, 3, 4, 5, 6}, "SecretRotationResult");
        final SecretRotationResult result = new SecretRotationResult(
        ...
        QueryCodecSupport.requireCanonical(encoded, result.canonicalBytes(), "SecretRotationResult");
        return result;
    }
    ...
    public boolean equals(final Object other) {
        return other instanceof SecretRotationResult that
