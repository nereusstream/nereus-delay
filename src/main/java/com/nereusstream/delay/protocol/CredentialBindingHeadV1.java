...
public final class CredentialBindingHeadV1 {
    ...
    private static final byte[] DIGEST_DOMAIN = Bytes.utf8("nereus-delay-credential-binding-head-v1\0");
    ...
    public CredentialBindingHeadV1(
    ...
    public static CredentialBindingHeadV1 create(
            final ProfileRefV1 profile,
            final long secretGeneration,
            final byte[] bindingDigest,
            final long headRevision) {
    ...
    public static CredentialBindingHeadV1 forBinding(final CredentialBindingV1 binding, final long headRevision) {
    ...
    public static CredentialBindingHeadV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields = QueryCodecSupport.read(encoded, "CredentialBindingHeadV1");
