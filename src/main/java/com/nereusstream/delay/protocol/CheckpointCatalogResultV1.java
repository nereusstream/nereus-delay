...
public final class CheckpointCatalogResultV1 {
    ...
    public CheckpointCatalogResultV1(
            ...
            final List<CheckpointSummaryV1> summaries) {
    ...
    private static List<CheckpointSummaryV1> sortedUnique(
            final List<CheckpointSummaryV1> values, final ShardSubjectV1 shard) {
