...
public record PayloadCommitProof(
        ...
        byte[] proofId,
        byte[] signature)
        implements PayloadCommitProofView {
    ...
    public int hashCode() {
        return Objects.hash(
                ...
                Arrays.hashCode(objectStoreProfileHash),
    ...
    public byte[] canonicalBytes() {
        return Bytes.concat(
                ...
                routeIncarnationUuid,
                Bytes.u32beBits(partition),
                delayMessageId.bytes(),
                reservationId,
                objectStoreProfileHash,
                Bytes.lp32(container),
                Bytes.lp32(objectKey),
                Bytes.lp32(immutableObjectVersion),
                Bytes.lp32(etag),
                Bytes.u64be(length),
                payloadSha256,
                Bytes.i64be(notAfterEpochMs),
                proofId,
                signature);
    }
    ...
    public static PayloadCommitProof signed(
        ...
        final byte[] proofId = computeProofId(
                trustSetVersion,
                routeIncarnationUuid,
                partition,
                delayMessageId,
    ...
    public static PayloadCommitProof decode(final byte[] encoded) {
        ...
        final PayloadCommitProof decoded = new PayloadCommitProof(
                trustSetVersion,
                proofKeyVersion,
                route,
                partition,
    ...
    private static byte[] computeProofId(
        ...
        return Bytes.sha256(
                ...
                Bytes.lp32(container),
                Bytes.lp32(objectKey),
                Bytes.lp32(objectVersion),
                Bytes.lp32(etag),
                Bytes.u64be(length),
                sha,
                Bytes.i64be(notAfter));
    }
