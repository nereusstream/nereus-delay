...
public final class ReplayDeadLetterBody {
    ...
    private ReplayDeadLetterBody(
        ...
        if (expectedStateVersion < 0 || deliverAtEpochMs < 0 || expireAtEpochMs < deliverAtEpochMs) {
    ...
    public static ReplayDeadLetterBody decode(final byte[] canonicalBody) {
        ...
        return new ReplayDeadLetterBody(
                controlRef,
                messageId,
                generation,
                stateVersion,
