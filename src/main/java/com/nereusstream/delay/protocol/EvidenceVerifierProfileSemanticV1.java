...
public final class EvidenceVerifierProfileSemanticV1 implements ProfileSemanticBodyV1 {
    ...
    public EvidenceVerifierProfileSemanticV1(
    ...
    public static EvidenceVerifierProfileSemanticV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields =
                QueryCodecSupport.read(encoded, "EvidenceVerifierProfileSemanticV1");
        QueryCodecSupport.requireNumbers(fields, new int[] {1, 2, 3, 4, 5, 6, 7}, "EvidenceVerifierProfileSemanticV1");
    ...
    public boolean equals(final Object other) {
        return other instanceof EvidenceVerifierProfileSemanticV1 that
