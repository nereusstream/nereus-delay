...
public final class PulsarPhysicalPartitionIdentity {
    ...
    public PulsarPhysicalPartitionIdentity(
            final int partition,
    ...
    public static PulsarPhysicalPartitionIdentity decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields =
                QueryCodecSupport.read(encoded, "PulsarPhysicalPartitionIdentity");
        QueryCodecSupport.requireNumbers(fields, new int[] {1, 2, 3, 4}, "PulsarPhysicalPartitionIdentity");
        final PulsarPhysicalPartitionIdentity result = new PulsarPhysicalPartitionIdentity(
        ...
        QueryCodecSupport.requireCanonical(encoded, result.canonicalBytes(), "PulsarPhysicalPartitionIdentity");
        return result;
    }

    @Override
    public boolean equals(final Object other) {
        return other instanceof PulsarPhysicalPartitionIdentity that
