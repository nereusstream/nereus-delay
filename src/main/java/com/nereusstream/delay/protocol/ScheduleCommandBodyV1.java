...
public final class ScheduleCommandBodyV1 {
    ...
    public static ScheduleCommandBodyV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields = QueryCodecSupport.read(encoded, "ScheduleCommandBodyV1");
    ...
    public boolean equals(final Object other) {
        return other instanceof ScheduleCommandBodyV1 that
