...
public final class ControlTypedResultV1 {
    ...
    public static ControlTypedResultV1 decode(final byte[] encoded) {
        ...
        final ControlResultKindV1 kind =
                ControlResultKindV1.fromWire(fields.get(0).number());
        final ControlTypedResultV1 result =
                new ControlTypedResultV1(kind, fields.get(0).rawValue());
    ...
    public boolean equals(final Object other) {
        return other instanceof ControlTypedResultV1 that && kind == that.kind && Arrays.equals(payload, that.payload);
    }
