...
public final class ExternalDeliveryIdentityV1 {
    ...
    public static ExternalDeliveryIdentityV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields =
                QueryCodecSupport.read(encoded, "ExternalDeliveryIdentityV1");
        QueryCodecSupport.requireNumbers(fields, new int[] {fields.get(0).number()}, "ExternalDeliveryIdentityV1");
        final ExternalDeliveryIdentityV1 result =
