...
public final class ControlOperationQueryResponseV1 {
    ...
    private ControlOperationQueryResponseV1(
            final ControlOperationQueryResultV1 resultKind,
    ...
    public static ControlOperationQueryResponseV1 current(final CurrentControlOperationV1 current) {
        return new ControlOperationQueryResponseV1(
                ControlOperationQueryResultV1.CURRENT, Objects.requireNonNull(current, "current"), null);
    }
    ...
    public static ControlOperationQueryResponseV1 decode(final byte[] encoded) {
        ...
        final ControlOperationQueryResultV1 result =
                ControlOperationQueryResultV1.fromWire(QueryCodecSupport.uint32(fields.get(1), 2));
        final int branchField = branchField(result);
        final byte[] branch = QueryCodecSupport.nested(fields.get(2), branchField);
        final ControlOperationQueryResponseV1 decoded =
                switch (result) {
