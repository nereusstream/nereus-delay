...
public final class LaneQuotaUsageEntryV1 {
    ...
    private static final byte[] DIGEST_DOMAIN = Bytes.utf8("nereus-delay-lane-quota-usage-entry-v1\0");
    ...
    public static LaneQuotaUsageEntryV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields = QueryCodecSupport.read(encoded, "LaneQuotaUsageEntryV1");
    ...
    public boolean equals(final Object other) {
        return other instanceof LaneQuotaUsageEntryV1 that
