 ...
 */
public record ControlRegistrationProjectionV1(ControlOperationReceiptV1 receipt, CurrentControlOperationV1 current) {
    ...
    public static ControlRegistrationProjectionV1 initial(
