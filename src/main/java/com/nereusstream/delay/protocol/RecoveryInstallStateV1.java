...
public final class RecoveryInstallStateV1 {
    ...
    private static final byte[] DIGEST_DOMAIN = Bytes.utf8("nereus-delay-recovery-install-state-v1\0");
    ...
    public RecoveryInstallStateV1(
            final RecoveryInstallPhaseV1 phase, final byte[] storeIncarnation, final byte[] checkpointId) {
    ...
    public static RecoveryInstallStateV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields = QueryCodecSupport.read(encoded, "RecoveryInstallStateV1");
    ...
    public boolean equals(final Object other) {
        return other instanceof RecoveryInstallStateV1 that && Arrays.equals(canonicalBytes(), that.canonicalBytes());
    }
