...
public final class EvidenceCursorV1 implements Comparable<EvidenceCursorV1> {
    ...
    private EvidenceCursorV1(
            final EvidenceKindV1 evidenceKind,
    ...
    public static EvidenceCursorV1 kafka(
            final byte[] destinationLaneId,
            final byte[] laneIncarnation,
            final byte[] topicUuid,
            final int physicalPartition,
    ...
    public static EvidenceCursorV1 pulsar(
            final byte[] destinationLaneId,
            final byte[] laneIncarnation,
            final byte[] resourceToken,
            final int physicalPartition,
    ...
    public static EvidenceCursorV1 decode(final byte[] encoded) {
        ...
        if (fields.get(7).number() == 10) {
            ...
            final List<CanonicalProtobuf.Reader.Field> cursor =
                    QueryCodecSupport.read(QueryCodecSupport.nested(fields.get(7), 10), "KafkaReceiptCursorV1");
            ...
            final List<CanonicalProtobuf.Reader.Field> cursor =
                    QueryCodecSupport.read(QueryCodecSupport.nested(fields.get(7), 11), "PulsarJournalCursorV1");
