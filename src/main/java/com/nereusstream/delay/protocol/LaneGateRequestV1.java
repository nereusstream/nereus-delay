...
public final class LaneGateRequestV1 implements ControlOperationRequestBranchV1 {
    ...
    public static LaneGateRequestV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields = QueryCodecSupport.read(encoded, "LaneGateRequestV1");
        QueryCodecSupport.requireNumbers(fields, new int[] {1}, "LaneGateRequestV1");
        final LaneGateRequestV1 result =
                new LaneGateRequestV1(ControlReasonV1.decode(QueryCodecSupport.nested(fields.get(0), 1)));
