...
public final class ProfileControlResultV1 {
    ...
    public ProfileControlResultV1(
            final ProfileRefV1 profile, final ProfileAcceptanceV1 acceptance, final Long currentSecretGeneration) {
    ...
    public boolean equals(final Object other) {
        return other instanceof ProfileControlResultV1 that
