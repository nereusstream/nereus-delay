...
public final class UnknownMessageViewV1 implements QueryResponseBranchV1 {
    ...
    public static UnknownMessageViewV1 decode(final byte[] encoded) {
        ...
        final UnknownMessageViewV1 result =
                new UnknownMessageViewV1(FirstScheduleEligibilityV1.fromWire(QueryCodecSupport.uint(fields.get(0), 1)));
    ...
    public boolean equals(final Object other) {
        return other instanceof UnknownMessageViewV1 that && firstScheduleEligibility == that.firstScheduleEligibility;
    }
