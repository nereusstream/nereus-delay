...
public final class PulsarMetadata {
    ...
    public static PulsarMetadata decode(final byte[] encoded) {
        ...
        final PulsarMetadata result = new PulsarMetadata(partitionKey, keyEncoding, orderingKey, properties);
        QueryCodecSupport.requireCanonical(encoded, result.canonicalBytes(), "PulsarMetadata");
        return result;
    }

    @Override
    public boolean equals(final Object other) {
        if (!(other instanceof PulsarMetadata that)) {
            return false;
        }
