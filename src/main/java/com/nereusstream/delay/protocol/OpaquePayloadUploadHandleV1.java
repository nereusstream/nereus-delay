...
public final class OpaquePayloadUploadHandleV1 {
    ...
    private OpaquePayloadUploadHandleV1(
    ...
    public static OpaquePayloadUploadHandleV1 create(
            final byte[] reservationId,
            final ProfileRefV1 objectStoreProfile,
            final UploadHandleKindV1 kind,
            final long expiresAtEpochMs,
            final byte[] capabilityEnvelope) {
        return new OpaquePayloadUploadHandleV1(
                reservationId,
                objectStoreProfile,
                kind,
                expiresAtEpochMs,
    ...
    public static OpaquePayloadUploadHandleV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields =
                QueryCodecSupport.read(encoded, "OpaquePayloadUploadHandleV1");
        QueryCodecSupport.requireNumbers(fields, new int[] {1, 2, 3, 4, 5, 6, 7}, "OpaquePayloadUploadHandleV1");
