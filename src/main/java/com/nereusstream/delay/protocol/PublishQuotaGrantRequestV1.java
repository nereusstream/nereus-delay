...
public final class PublishQuotaGrantRequestV1 implements ControlOperationRequestBranchV1 {
    ...
    public PublishQuotaGrantRequestV1(final QuotaGrantRefV1 quotaGrant, final QuotaTransferPlanRefV1 transferPlan) {
    ...
    public static PublishQuotaGrantRequestV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields =
                QueryCodecSupport.read(encoded, "PublishQuotaGrantRequestV1");
        if (fields.size() < 1
                || fields.size() > 2
        ...
        final PublishQuotaGrantRequestV1 result = new PublishQuotaGrantRequestV1(
                ...
                fields.size() == 2 ? QuotaTransferPlanRefV1.decode(QueryCodecSupport.nested(fields.get(1), 2)) : null);
    ...
    public boolean equals(final Object other) {
        return other instanceof PublishQuotaGrantRequestV1 that
