...
public final class EvidenceVerifierProfileSemantic implements ProfileSemanticBody {
    ...
    public EvidenceVerifierProfileSemantic(
            final int verifierKind,
            final int keyVersion,
            final byte[] publicKey,
            final byte[] authenticatedScopeHash,
            final long notBeforeEpochMs,
    ...
    public ProfileKind profileKind() {
        return ProfileKind.EVIDENCE_VERIFIER;
    }
    ...
    public static EvidenceVerifierProfileSemantic decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields =
                QueryCodecSupport.read(encoded, "EvidenceVerifierProfileSemantic");
        QueryCodecSupport.requireNumbers(fields, new int[] {1, 2, 3, 4, 5, 6, 7}, "EvidenceVerifierProfileSemantic");
        final EvidenceVerifierProfileSemantic result = new EvidenceVerifierProfileSemantic(
        ...
        QueryCodecSupport.requireCanonical(encoded, result.canonicalBytes(), "EvidenceVerifierProfileSemantic");
        return result;
    }

    @Override
    public boolean equals(final Object other) {
        return other instanceof EvidenceVerifierProfileSemantic that
                && verifierKind == that.verifierKind
                ...
                && notBeforeEpochMs == that.notBeforeEpochMs
