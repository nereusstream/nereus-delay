...
public final class DefinitelyNotQueuedV1 {
    ...
    public DefinitelyNotQueuedV1(
            final CommandQueuedReceiptV1.PreparedCommandRef command,
            final NonPersistenceProofV1 proof,
    ...
    public boolean equals(final Object other) {
        return other instanceof DefinitelyNotQueuedV1 that
    ...
    private static StableErrorV1 requireCommandError(
            final StableErrorV1 error, final CommandQueuedReceiptV1.PreparedCommandRef command) {
