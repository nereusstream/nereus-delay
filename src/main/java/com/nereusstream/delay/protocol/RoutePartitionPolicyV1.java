...
public final class RoutePartitionPolicyV1 {
    ...
    public RoutePartitionPolicyV1(
            final int partition,
            final ActivationBarrierV1 activationBarrier,
            final QuotaGrantRefV1 quotaGrant,
    ...
    public static RoutePartitionPolicyV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields = QueryCodecSupport.read(encoded, "RoutePartitionPolicyV1");
    ...
    public boolean equals(final Object other) {
        return other instanceof RoutePartitionPolicyV1 that
