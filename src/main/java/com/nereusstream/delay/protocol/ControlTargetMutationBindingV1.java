...
public final class ControlTargetMutationBindingV1 {
    ...
    static SystemMutationType expectedMutationType(
            final ControlOperationKindV1 operationKind, final ControlTargetKindV1 targetKind) {
        return switch (operationKind) {
            case REPLAY_DEAD_LETTER ->
                requireTargetKind(targetKind, ControlTargetKindV1.MESSAGE, SystemMutationType.REPLAY_DEAD_LETTER);
            case RESOLVE_UNCERTAIN ->
                requireTargetKind(targetKind, ControlTargetKindV1.MESSAGE, SystemMutationType.RESOLVE_UNCERTAIN);
    ...
    private static SystemMutationType requireTargetKind(
            final ControlTargetKindV1 actual, final ControlTargetKindV1 expected, final SystemMutationType type) {
        if (actual != expected) {
    ...
    private static void validateApplyTarget(
            final ControlOperationKindV1 operationKind,
    ...
    private static void validateReplayTarget(
            final ControlOperationRequestV1 request, final ControlTargetRefV1 target, final ReplayDeadLetterBody body) {
    ...
    private static void validateResolveTarget(
            final ControlOperationRequestV1 request, final ControlTargetRefV1 target, final ResolveUncertainBody body) {
