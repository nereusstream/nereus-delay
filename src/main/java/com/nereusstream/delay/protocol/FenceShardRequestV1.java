...
public final class FenceShardRequestV1 implements ControlOperationRequestBranchV1 {
    ...
    public static FenceShardRequestV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields = QueryCodecSupport.read(encoded, "FenceShardRequestV1");
        QueryCodecSupport.requireNumbers(fields, new int[] {1}, "FenceShardRequestV1");
        final FenceShardRequestV1 result =
                new FenceShardRequestV1(ControlReasonV1.decode(QueryCodecSupport.nested(fields.get(0), 1)));
