...
public final class PulsarBrokerResourceIdentityV1 {
    ...
    public PulsarBrokerResourceIdentityV1(
    ...
    public static PulsarBrokerResourceIdentityV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> outer = QueryCodecSupport.read(encoded, "BrokerResourceIdentityV1");
        QueryCodecSupport.requireNumbers(outer, new int[] {2}, "BrokerResourceIdentityV1");
        final List<CanonicalProtobuf.Reader.Field> fields =
                QueryCodecSupport.read(QueryCodecSupport.nested(outer.get(0), 2), "PulsarResourceIdentityV1");
