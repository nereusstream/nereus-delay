...
public final class CheckpointResource {
    ...
    public byte[] exactResourceCanonicalBytes() {
        return CanonicalProtobuf.message(
                output -> CanonicalProtobuf.bytes(output, ResourceKind.CHECKPOINT.wireValue(), canonicalBytes()));
    }

    public static CheckpointResource decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields = QueryCodecSupport.read(encoded, "CheckpointResource");
        QueryCodecSupport.requireNumbers(fields, new int[] {1, 2, 3, 4, 5, 6, 7, 8}, "CheckpointResource");
        final CheckpointResource result = new CheckpointResource(
        ...
        QueryCodecSupport.requireCanonical(encoded, result.canonicalBytes(), "CheckpointResource");
        return result;
    }
    ...
    public boolean equals(final Object other) {
        return other instanceof CheckpointResource that
