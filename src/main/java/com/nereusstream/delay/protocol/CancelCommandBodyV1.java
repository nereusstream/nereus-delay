...
public final class CancelCommandBodyV1 {
    ...
    public static CancelCommandBodyV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields = QueryCodecSupport.read(encoded, "CancelCommandBodyV1");
    ...
    public boolean equals(final Object other) {
        return other instanceof CancelCommandBodyV1 that
