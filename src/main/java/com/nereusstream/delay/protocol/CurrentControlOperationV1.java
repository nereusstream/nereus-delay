...
public final class CurrentControlOperationV1 {
    ...
    public CurrentControlOperationV1(
            ...
            final List<ControlTargetStateViewV1> targetStates,
        ...
        if ((state == ControlOperationStateV1.SUCCEEDED || state == ControlOperationStateV1.SUCCEEDED_WITH_OUTSTANDING)
                && typedResult == null) {
    ...
    public boolean equals(final Object other) {
        return other instanceof CurrentControlOperationV1 that
