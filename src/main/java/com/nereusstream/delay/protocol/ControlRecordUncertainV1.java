...
public final class ControlRecordUncertainV1 {
    ...
    public ControlRecordUncertainV1(final byte[] operationId, final byte[] preparedDigest, final StableErrorV1 error) {
    ...
    public static ControlRecordUncertainV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields = QueryCodecSupport.read(encoded, "ControlRecordUncertainV1");
    ...
    public boolean equals(final Object other) {
        return other instanceof ControlRecordUncertainV1 that
