...
public final class IngressCredentialBindingRef {
    ...
    public IngressCredentialBindingRef(
            final byte[] bindingId,
        ...
        this.resolvedCredentialFingerprintDigest =
                nonZero(resolvedCredentialFingerprintDigest, "resolvedCredentialFingerprintDigest");
    ...
    public static IngressCredentialBindingRef decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields =
                QueryCodecSupport.read(encoded, "IngressCredentialBindingRef");
        QueryCodecSupport.requireNumbers(fields, new int[] {1, 2, 3, 4, 5}, "IngressCredentialBindingRef");
        final IngressCredentialBindingRef result = new IngressCredentialBindingRef(
        ...
        QueryCodecSupport.requireCanonical(encoded, result.canonicalBytes(), "IngressCredentialBindingRef");
        return result;
    }

    @Override
    public boolean equals(final Object other) {
        return other instanceof IngressCredentialBindingRef that
                && generation == that.generation
                && Arrays.equals(bindingId, that.bindingId)
