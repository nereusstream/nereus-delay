...
public final class ActiveLaneStateV1 {
    ...
    public ActiveLaneStateV1(
            ...
            final LaneRuntimeBlockReasonV1 runtimeBlockReason,
            ...
            final LaneCircuitStateV1 circuitState,
            ...
            final LaneRetirementProgressV1 retirement) {
        ...
        final long minimumNextEligibleAt = Math.max(
                ...
                Math.max(
                        circuitState == LaneCircuitStateV1.OPEN ? this.circuitOpenUntilEpochMs : 0,
     ...
     */
    public ActiveLaneStateV1 withLocalProjection(
    ...
    public static ActiveLaneStateV1 decode(final byte[] encoded) {
        ...
        final ActiveLaneStateV1 result = new ActiveLaneStateV1(
                laneId,
                laneIncarnation,
                gate,
                readiness,
    ...
    public boolean equals(final Object other) {
        return other instanceof ActiveLaneStateV1 that
