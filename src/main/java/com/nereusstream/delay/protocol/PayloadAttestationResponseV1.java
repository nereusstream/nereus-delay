...
public final class PayloadAttestationResponseV1 {
    ...
    private PayloadAttestationResponseV1(
            final PayloadAttestationOutcomeV1 outcome, final PayloadCommitProofV1 proof, final StableErrorV1 error) {
    ...
    public static PayloadAttestationResponseV1 attested(final PayloadCommitProofV1 proof) {
        return new PayloadAttestationResponseV1(
                PayloadAttestationOutcomeV1.ATTESTED, Objects.requireNonNull(proof, "proof"), null);
    }

    public static PayloadAttestationResponseV1 error(
            final PayloadAttestationOutcomeV1 outcome, final StableErrorV1 error) {
    ...
    public static PayloadAttestationResponseV1 decode(final byte[] encoded) {
        ...
        final PayloadAttestationOutcomeV1 outcome =
                PayloadAttestationOutcomeV1.fromWire(QueryCodecSupport.uint(fields.get(0), 1));
    ...
    public boolean equals(final Object other) {
        return other instanceof PayloadAttestationResponseV1 that
