...
public final class ProfileSemanticEnvelopeV1 {
    ...
    public ProfileSemanticEnvelopeV1(
    ...
    private ProfileSemanticEnvelopeV1(
            final ProfileKindV1 profileKind,
            final byte[] profileId,
            final long version,
            final ProfileSemanticBodyV1 body,
    ...
    public static ProfileSemanticEnvelopeV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields =
                QueryCodecSupport.read(encoded, "ProfileSemanticEnvelopeV1");
        if (fields.size() != 7) {
        ...
        final ProfileSemanticEnvelopeV1 result = new ProfileSemanticEnvelopeV1(
                kind,
    ...
    public boolean equals(final Object other) {
        return other instanceof ProfileSemanticEnvelopeV1 that
