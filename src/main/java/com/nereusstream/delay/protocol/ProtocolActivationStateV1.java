...
public final class ProtocolActivationStateV1 {
    ...
    private ProtocolActivationStateV1(
            final ShardSubjectV1 shard, final List<Activation> activations, final byte[] stateDigest) {
    ...
    public ProtocolActivationStateV1 activate(
    ...
    public static ProtocolActivationStateV1 decode(final byte[] encoded) {
        ...
        final List<CanonicalProtobuf.Reader.Field> fields =
                QueryCodecSupport.read(encoded, "ProtocolActivationStateV1");
    ...
    private static List<Activation> sortedActivations(final List<Activation> values) {
        ...
        result.sort(Comparator.comparing(
                activation -> activation.tuple().canonicalBytes(), ProtocolActivationStateV1::compareBytes));
    ...
    public static final class Activation {
        ...
        public static Activation decode(final byte[] encoded) {
            final List<CanonicalProtobuf.Reader.Field> fields =
                    QueryCodecSupport.read(encoded, "ProtocolActivationStateV1.Activation");
            QueryCodecSupport.requireNumbers(fields, new int[] {1, 2, 3, 4, 5}, "ProtocolActivationStateV1.Activation");
