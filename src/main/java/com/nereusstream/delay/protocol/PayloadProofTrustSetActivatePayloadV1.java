...
public final class PayloadProofTrustSetActivatePayloadV1 {
    ...
    public static PayloadProofTrustSetActivatePayloadV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields =
                QueryCodecSupport.read(encoded, "PayloadProofTrustSetActivatePayloadV1");
        ...
        QueryCodecSupport.requireCanonical(encoded, result.canonicalBytes(), "PayloadProofTrustSetActivatePayloadV1");
        return result;
    }
