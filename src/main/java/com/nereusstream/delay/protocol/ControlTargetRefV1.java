...
public final class ControlTargetRefV1 {
    ...
    public static ControlTargetRefV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields = QueryCodecSupport.read(encoded, "ControlTargetRefV1");
        ...
        final ControlTargetRefV1 result = new ControlTargetRefV1(
    ...
    private static Object decodeTarget(final ControlTargetKindV1 kind, final CanonicalProtobuf.Reader.Field field) {
        return switch (kind) {
    ...
    public boolean equals(final Object other) {
        return other instanceof ControlTargetRefV1 that
