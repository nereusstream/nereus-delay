...
public final class RecoveryCandidateRefV1 {
    ...
    private static final byte[] DIGEST_DOMAIN = Bytes.utf8("nereus-delay-recovery-candidate-ref-v1\0");
    ...
    public RecoveryCandidateRefV1(
            final RecoveryCandidateKindV1 kind,
    ...
    public static RecoveryCandidateRefV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields = QueryCodecSupport.read(encoded, "RecoveryCandidateRefV1");
        ...
        final RecoveryCandidateKindV1 kind = RecoveryCandidateKindV1.fromWire(QueryCodecSupport.uint(fields.get(0), 1));
        final RecoveryCandidateRefV1 result = new RecoveryCandidateRefV1(
                kind,
    ...
    public boolean equals(final Object other) {
        return other instanceof RecoveryCandidateRefV1 that && Arrays.equals(canonicalBytes(), that.canonicalBytes());
    }
