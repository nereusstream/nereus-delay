...
public final class ResourceDeleteConfirmedBody {
    ...
    private ResourceDeleteConfirmedBody(
            final RetireIntentRef intent,
    ...
    public static ResourceDeleteConfirmedBody decode(final byte[] canonicalBody) {
        ...
        final TrustedUtcIntervalEvidence confirmedAt = TrustedUtcIntervalEvidence.decode(nested(field(fields, 13), 13));
    ...
    public record RetireIntentRef(
            byte[] mutationId, byte[] mutationHash, byte[] resourceIdentityHash, long expectedResourceStateVersion) {
    ...
    public record ExternalDeleteEvidence(
        ...
        private static ExternalDeleteEvidence decode(final byte[] encoded) {
            ...
            final ExternalDeleteEvidence result = new ExternalDeleteEvidence(
                    ...
                    DeleteOutcome.fromWire(unsigned(fields.get(2), 3)),
                    immutableVersion,
                    etag,
