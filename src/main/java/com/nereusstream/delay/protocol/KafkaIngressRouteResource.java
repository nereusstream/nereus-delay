...
public final class KafkaIngressRouteResource implements IngressRouteResource {
    ...
    public KafkaIngressRouteResource(
            final String authenticatedClusterId,
            final String canonicalPhysicalTopic,
    ...
    public static KafkaIngressRouteResource decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> outer = QueryCodecSupport.read(encoded, "IngressRouteResource");
        QueryCodecSupport.requireNumbers(outer, new int[] {1}, "IngressRouteResource");
        final List<CanonicalProtobuf.Reader.Field> fields =
                QueryCodecSupport.read(QueryCodecSupport.nested(outer.get(0), 1), "KafkaIngressRouteResource");
        QueryCodecSupport.requireNumbers(fields, new int[] {1, 2, 3, 4}, "KafkaIngressRouteResource");
        final KafkaIngressRouteResource result = new KafkaIngressRouteResource(
    ...
    public boolean equals(final Object other) {
        return other instanceof KafkaIngressRouteResource that
