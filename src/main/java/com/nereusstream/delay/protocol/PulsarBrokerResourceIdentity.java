...
public final class PulsarBrokerResourceIdentity {
    ...
    public PulsarBrokerResourceIdentity(
    ...
    private byte[] canonicalPulsarFields() {
        return CanonicalProtobuf.message(output -> {
            CanonicalProtobuf.bytes(
                    output, 1, authenticatedClusterId.getBytes(java.nio.charset.StandardCharsets.UTF_8));
    ...
    public static PulsarBrokerResourceIdentity decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> outer = QueryCodecSupport.read(encoded, "BrokerResourceIdentity");
        QueryCodecSupport.requireNumbers(outer, new int[] {2}, "BrokerResourceIdentity");
        final List<CanonicalProtobuf.Reader.Field> fields =
                QueryCodecSupport.read(QueryCodecSupport.nested(outer.get(0), 2), "PulsarResourceIdentity");
        QueryCodecSupport.requireNumbers(fields, new int[] {1, 2, 3, 4}, "PulsarResourceIdentity");
        final PulsarBrokerResourceIdentity result = new PulsarBrokerResourceIdentity(
    ...
    public boolean equals(final Object other) {
        if (!(other instanceof PulsarBrokerResourceIdentity that)) {
            return false;
        }
    ...
    public int hashCode() {
        return Objects.hash(
                ...
                Arrays.hashCode(resourceIncarnation),
                physicalTopic,
