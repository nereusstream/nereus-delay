...
public final class PayloadProofVerifierKeyV1 {
    ...
    public PayloadProofVerifierKeyV1(
    ...
    public static PayloadProofVerifierKeyV1 fromPublicKey(
            final int keyVersion,
        ...
        return new PayloadProofVerifierKeyV1(
                keyVersion,
    ...
    public static PayloadProofVerifierKeyV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields =
                QueryCodecSupport.read(encoded, "PayloadProofVerifierKeyV1");
    ...
    public boolean equals(final Object other) {
        return other instanceof PayloadProofVerifierKeyV1 that
