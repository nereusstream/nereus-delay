...
public final class CredentialBindingProtectionV1 {
    ...
    private static final byte[] DIGEST_DOMAIN = Bytes.utf8("nereus-delay-credential-binding-protection-v1\0");
    ...
    public CredentialBindingProtectionV1(
    ...
    public static CredentialBindingProtectionV1 create(
            final ProfileRefV1 profile,
            final long secretGeneration,
            final byte[] bindingDigest,
            final long managedChannelProtectionUntilEpochMs,
        ...
        final byte[] digest = digestForFields(
                ...
                protectionRevision);
        return new CredentialBindingProtectionV1(
                profile,
                secretGeneration,
                bindingDigest,
                managedChannelProtectionUntilEpochMs,
    ...
    public static CredentialBindingProtectionV1 forBinding(
    ...
    public static CredentialBindingProtectionV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields =
                QueryCodecSupport.read(encoded, "CredentialBindingProtectionV1");
        QueryCodecSupport.requireNumbers(
                fields, new int[] {1, 2, 3, 4, 5, 6, 7, 8, 9}, "CredentialBindingProtectionV1");
