...
public final class RecoveryFloorRefV1 {
    ...
    private static final byte[] DIGEST_DOMAIN = Bytes.utf8("nereus-delay-recovery-floor-ref-v1\0");
    ...
    public boolean equals(final Object other) {
        return other instanceof RecoveryFloorRefV1 that && Arrays.equals(canonicalBytes(), that.canonicalBytes());
    }
