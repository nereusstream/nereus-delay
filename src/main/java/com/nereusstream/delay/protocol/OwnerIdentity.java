...
/** Canonical Registry {@code OwnerIdentity}. */
public final class OwnerIdentity {
    ...
    public static OwnerIdentity decode(final byte[] encoded) {
        final var fields = QueryCodecSupport.read(encoded, "OwnerIdentity");
        QueryCodecSupport.requireNumbers(fields, new int[] {1, 2, 3, 4}, "OwnerIdentity");
        final OwnerIdentity result = new OwnerIdentity(
        ...
        QueryCodecSupport.requireCanonical(encoded, result.canonicalBytes(), "OwnerIdentity");
        return result;
    }

    @Override
    public boolean equals(final Object other) {
        return other instanceof OwnerIdentity that
    ...
    public int hashCode() {
        return Objects.hash(
                Arrays.hashCode(deploymentId),
                Arrays.hashCode(workerRunId),
                ownerEpoch,
