...
public final class NativeCapabilitySnapshotV1 {
    ...
    private NativeCapabilitySnapshotV1(
    ...
    public static NativeCapabilitySnapshotV1 create(
            final ProfileRefV1 destination,
            final ProfileRefV1 capability,
            final PulsarBrokerResourceIdentityV1 target,
            final int physicalPartition,
        ...
        return new NativeCapabilitySnapshotV1(
                destination,
                capability,
                target,
                physicalPartition,
    ...
    public static NativeCapabilitySnapshotV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields =
                QueryCodecSupport.read(encoded, "NativeCapabilitySnapshotV1");
        ...
        final byte[] expectedDigest = Bytes.sha256(
                Bytes.utf8("nereus-delay-native-capability-snapshot-v1\0"),
                canonicalFields(
                        destination,
                        capability,
                        target,
        ...
        final NativeCapabilitySnapshotV1 result = new NativeCapabilitySnapshotV1(
                destination,
                capability,
                target,
                partition,
    ...
    private static byte[] canonicalFields(
            ...
            final long notAfterEpochMs,
            final int issuerSigningKeyVersion) {
        final NativeCapabilitySnapshotV1 fields = new NativeCapabilitySnapshotV1(
                destination,
                capability,
                target,
                physicalPartition,
    ...
    private static byte[] signatureDigest(final byte[] snapshotDigest, final int signingKeyVersion) {
        return Bytes.sha256(
                Bytes.utf8("nereus-delay-native-capability-snapshot-signature-v1\0"),
                snapshotDigest,
