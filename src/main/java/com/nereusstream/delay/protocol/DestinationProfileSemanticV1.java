...
public final class DestinationProfileSemanticV1 implements ProfileSemanticBodyV1 {
    ...
    public DestinationProfileSemanticV1(
        ...
        if ((adapterKind == AdapterKindV1.KAFKA && targetResource.kind() != BrokerResourceIdentityV1.Kind.KAFKA)
    ...
    public static DestinationProfileSemanticV1 decode(final byte[] encoded) {
        ...
        int cursor = index;
        final ProfileRefV1 capability = ProfileRefV1.decode(QueryCodecSupport.nested(fields.get(cursor++), 7));
    ...
    public boolean equals(final Object other) {
        return other instanceof DestinationProfileSemanticV1 that
    ...
    private static List<Integer> validatePartitions(
            final List<Integer> values, final int count, final TargetPartitionPolicyV1 policy) {
