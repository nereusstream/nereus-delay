...
/** Canonical typed value for the Registry PayloadObjectResource branch. */
public final class PayloadObjectResource {
    ...
    public static PayloadObjectResource decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields = QueryCodecSupport.read(encoded, "PayloadObjectResource");
        if (fields.size() != 6 && fields.size() != 7) {
            throw new IllegalArgumentException("PayloadObjectResource has an unexpected field count");
        }
        QueryCodecSupport.requireNumbers(
                fields,
                fields.size() == 6 ? new int[] {1, 2, 3, 4, 6, 7} : new int[] {1, 2, 3, 4, 5, 6, 7},
                "PayloadObjectResource");
        int index = 0;
        ...
        final PayloadObjectResource result =
                new PayloadObjectResource(profile, container, objectKey, immutableVersion, etag, length, payloadSha256);
        QueryCodecSupport.requireCanonical(encoded, result.canonicalBytes(), "PayloadObjectResource");
        return result;
    }
    ...
    public boolean equals(final Object other) {
        return other instanceof PayloadObjectResource that
