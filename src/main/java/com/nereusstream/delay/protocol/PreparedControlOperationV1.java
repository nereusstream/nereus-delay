...
public final class PreparedControlOperationV1 {
    ...
    private PreparedControlOperationV1(
    ...
    public static PreparedControlOperationV1 prepare(
            final byte[] operationId,
            final ControlOperationKindV1 kind,
            final ControlAuthorV1 author,
            final ControlOperationRequestV1 request,
        ...
        return new PreparedControlOperationV1(
                operationId,
                kind,
                author,
                request,
    ...
    public CurrentControlOperationV1 initialCurrentOperation() {
        final List<ControlTargetStateViewV1> states = targets.stream()
                .map(target -> new ControlTargetStateViewV1(
                        target.targetIndex(), TargetMarkerStateV1.PENDING, StableCode.OK, 0, null))
                .toList();
    ...
    public static PreparedControlOperationV1 decode(final byte[] encoded) {
        ...
        final ControlOperationKindV1 kind = ControlOperationKindV1.fromWire(QueryCodecSupport.uint(fields.get(2), 3));
        ...
        switch (kind) {
            ...
            case PUBLISH_DESTINATION_PROFILE_VERSION, DEPRECATE_DESTINATION_PROFILE_VERSION -> {
                ...
                validateProfileTarget(
                        kind,
                        request,
                        findSingle(values, ControlTargetKindV1.PROFILE).profile());
            }
            case PUBLISH_QUOTA_GRANT -> {
                ...
                if (!branch.quotaGrant()
                        .equals(findSingle(values, ControlTargetKindV1.QUOTA_GRANT)
                                .quotaGrant())) {
    ...
    public static byte[] requestHash(final ControlOperationKindV1 kind, final ControlOperationRequestV1 request) {
        Objects.requireNonNull(kind, "kind");
        Objects.requireNonNull(request, "request");
        if (request.kind() != kind) {
    ...
    private static void requireOnlyKinds(final List<ControlTargetRefV1> values, final ControlTargetKindV1... allowed) {
    ...
    private static void requireCount(
            final List<ControlTargetRefV1> values,
    ...
    private static void requireMutationPresence(
            final List<ControlTargetRefV1> values, final ControlTargetKindV1 kind, final boolean required) {
        for (ControlTargetRefV1 value : values) {
            if (value.targetKind() != kind) {
                continue;
            }
    ...
    private static ControlTargetRefV1 findSingle(
            final List<ControlTargetRefV1> values, final ControlTargetKindV1 kind) {
        for (ControlTargetRefV1 value : values) {
            if (value.targetKind() == kind) {
                return value;
            }
        ...
        switch (kind) {
            case PUBLISH_DESTINATION_PROFILE_VERSION -> {
                final PublishDestinationProfileRequestV1 branch =
                        branch(request, PublishDestinationProfileRequestV1.class);
            ...
            case DEPRECATE_DESTINATION_PROFILE_VERSION -> {
                expected = branch(request, DeprecateDestinationProfileRequestV1.class)
                        .profile();
                if (target.expectedSecretGeneration() != null) {
            ...
            case ROTATE_EQUIVALENT_SECRET_REFERENCE -> {
                final RotateEquivalentSecretRequestV1 branch = branch(request, RotateEquivalentSecretRequestV1.class);
    ...
    public boolean equals(final Object other) {
        return other instanceof PreparedControlOperationV1 that
                && kind == that.kind
