...
public final class CheckpointControlResult {
    ...
    public CheckpointControlResult(
    ...
    public static CheckpointControlResult decode(final byte[] encoded) {
        final var fields = QueryCodecSupport.read(encoded, "CheckpointControlResult");
        QueryCodecSupport.requireNumbers(fields, new int[] {1, 2, 3, 4}, "CheckpointControlResult");
        ...
        QueryCodecSupport.requireCanonical(encoded, result.canonicalBytes(), "CheckpointControlResult");
        return result;
    }
    ...
    public boolean equals(final Object other) {
        return other instanceof CheckpointControlResult that
