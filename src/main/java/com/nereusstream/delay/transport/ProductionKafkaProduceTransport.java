...
public final class ProductionKafkaProduceTransport implements CommandTransport {
    ...
    public ProductionKafkaProduceTransport(
            final KafkaCommandTransportKey key,
    ...
    public record Configuration(
            int acks, boolean idempotenceEnabled, boolean autoTopicCreationDisabled, String tlsIdentity) {
