...
public final class NativePreparationSnapshotV1 {
    ...
    public NativePreparationSnapshotV1(
        ...
        if (destinationBody.adapterKind() != com.nereusstream.delay.protocol.AdapterKindV1.PULSAR
                || capabilityBody.adapterKind() != com.nereusstream.delay.protocol.AdapterKindV1.PULSAR
                || (capabilityBody.timingCapabilityBits()
                                & com.nereusstream.delay.protocol.TimingCapabilityV1.PULSAR_AUTO_FAST)
                        == 0
                || !destinationBody
                        .targetResource()
                        .pulsar()
                        .equals(new PulsarBrokerResourceIdentityV1(
    ...
    private static ProfileSemanticEnvelopeV1 requireKind(
            final ProfileSemanticEnvelopeV1 value, final ProfileKindV1 kind, final String name) {
