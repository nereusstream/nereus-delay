...
public record PulsarSendResult(
    ...
    public PulsarSendResult {
        ...
        if (disposition == Disposition.PERSISTED) {
            ...
            if (stableCode != 0
                    ...
                    || (!batched && (batchIndex != 0 || batchSize != 1))
            ...
            if (stableCode <= 0
                    ...
                    || physicalTopic != null
                    || physicalTopicCreationTimestamp != -1
                    || partition != -1
                    || ledgerId != -1
                    || entryId != -1
                    || batchIndex != -1
    ...
    public PulsarSendResult(
            ...
            final long brokerEntryTimestampEpochMs,
    ...
    public static PulsarSendResult persisted(
    ...
    public static PulsarSendResult definitelyNotPersisted(
    ...
    public static PulsarSendResult unknown(
            final PhysicalEnqueueAttemptId physicalAttemptId, final int stableCode, final byte[] evidence) {
        return new PulsarSendResult(
                Disposition.UNKNOWN,
                null,
