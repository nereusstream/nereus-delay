...
public final class ObjectStoreProviderOwnershipTracker {
    ...
    public ObjectStoreProviderOwnershipTracker(final Clock clock, final long maximumProviderOwnershipLifetimeMs) {
    ...
    public synchronized Observation observe() {
        ...
        final byte[] digest = observationDigest(
                acceptingNewOperations,
                activeOperationCount,
                observedAtEpochMs,
                uncertainUntilEpochMs,
                lastOperationClosedAtEpochMs,
    ...
    public synchronized Observation requireLocallyQuiescent() {
        ...
        if (!observation.locallyQuiescent()) {
            throw new IllegalStateException("Object Store provider ownership is not locally quiescent: " + observation);
        }
        return observation;
    }
    ...
    private static byte[] observationDigest(
            final boolean acceptingNewOperations,
        ...
        return Bytes.sha256(
                ...
                Bytes.u64be(uncertainUntilEpochMs),
                Bytes.i64be(lastOperationClosedAtEpochMs),
                Bytes.u64be(maximumProviderOwnershipLifetimeMs),
    ...
    public record Observation(
            boolean acceptingNewOperations,
        ...
        public boolean locallyQuiescent() {
            return !acceptingNewOperations && activeOperationCount == 0 && observedAtEpochMs >= uncertainUntilEpochMs;
        }
