...
public final class WorkerNativeResourceLedger {
    ...
    public WorkerNativeResourceLedger(final long maxRocksDbNativeBytes, final long maxOtherNativeBytes) {
    ...
    public synchronized Snapshot snapshot() {
        return new Snapshot(
                rocksDbNativeUsage, otherNativeBytes, reservations.size(), maxRocksDbNativeBytes, maxOtherNativeBytes);
    }
    ...
    private static NativeResourceUsage subtract(final NativeResourceUsage left, final NativeResourceUsage right) {
        try {
    ...
    public record Snapshot(
            NativeResourceUsage rocksDbUsage,
