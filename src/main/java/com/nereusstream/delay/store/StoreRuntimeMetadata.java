...
public record StoreRuntimeMetadata(
    ...
    public StoreRuntimeMetadata {
        lastIngressFenceProofId =
                optionalIdentity(lastIngressFenceProofId, FENCE_PROOF_ID_LENGTH, "lastIngressFenceProofId");
    ...
    public boolean equals(final Object other) {
        return other instanceof StoreRuntimeMetadata that && Arrays.equals(canonicalBytes(), that.canonicalBytes());
    }
    ...
    public StoreRuntimeMetadata withCleanCloseMarker(final boolean clean) {
        return new StoreRuntimeMetadata(
                lastIngressFenceProofId, lastCheckpointId, lastOpenedOwnerEpoch, clean, evidenceCursors);
    }
    ...
    public StoreRuntimeMetadata withLastIngressFenceProofId(final byte[] proofId) {
        return new StoreRuntimeMetadata(
                proofId, lastCheckpointId, lastOpenedOwnerEpoch, cleanCloseMarker, evidenceCursors);
    }
    ...
    private static byte[] fixedIdentity(
