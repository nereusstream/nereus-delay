...
public final class CheckpointPublicationCoordinator {
    ...
    public CheckpointPublicationCoordinator(
    ...
    public CheckpointPublicationCoordinator(
            final CheckpointUploadCoordinator uploadCoordinator, final RecoveryCatalogAuthority catalog) {
    ...
    private static CheckpointUploadCoordinator uploadCoordinator(
            final SharedRocksDbResources resources,
            final CheckpointUploadIntentAuthority intentAuthority,
            final RecoveryCatalogAuthority catalog) {
    ...
    private static void requireAtomicPublicationPair(
            final CheckpointUploadIntentAuthority intentAuthority, final RecoveryCatalogAuthority catalog) {
