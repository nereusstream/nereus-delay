...
public final class LocalStatePathGuard {
            ...
            if (Files.isSymbolicLink(cursor)) {
                ...
                try {
                    ...
                    throw new IOException(
                            description + " contains an unresolved symbolic-link component: " + cursor, failure);
                }
     ...
     */
    public static byte[] readRegularFileNoFollow(final Path path, final long maxBytes, final String description)
            throws IOException {
        Objects.requireNonNull(path, "path");
        Objects.requireNonNull(description, "description");
