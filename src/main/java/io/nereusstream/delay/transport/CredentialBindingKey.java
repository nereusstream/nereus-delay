...
public record CredentialBindingKey(long generation, Digest32 bindingDigest,
    ...
    public CredentialBindingKey {
        ...
        resolvedCredentialFingerprint = Objects.requireNonNull(resolvedCredentialFingerprint,
