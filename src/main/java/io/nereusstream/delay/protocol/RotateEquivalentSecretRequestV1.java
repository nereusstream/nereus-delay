...
public final class RotateEquivalentSecretRequestV1 implements ControlOperationRequestBranchV1 {
    ...
    public RotateEquivalentSecretRequestV1(final ProfileRefV1 profile, final long expectedSecretGeneration,
                                           final long newSecretGeneration, final byte[] newSecretReference,
        ...
        this.newSecretReference = boundedNonEmpty(newSecretReference,
                CredentialBindingV1.MAX_SECRET_REFERENCE_BYTES, "newSecretReference");
    ...
    public CredentialBindingV1 newBinding() {
        return CredentialBindingV1.create(profile, newSecretGeneration, newSecretReference,
                equivalenceAttestation);
    }
    ...
    public static RotateEquivalentSecretRequestV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields = QueryCodecSupport.read(encoded,
                "RotateEquivalentSecretRequestV1");
    ...
    @Override
    public int hashCode() {
        return Objects.hash(profile, expectedSecretGeneration, newSecretGeneration,
                Arrays.hashCode(newSecretReference), Arrays.hashCode(newSecretReferenceSha256),
                equivalenceAttestation, Arrays.hashCode(expectedBindingDigest), expectedBindingHeadRevision);
    }
