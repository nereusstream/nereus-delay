...
public final class CommittedPayloadDescriptorV1 {
    ...
    public CommittedPayloadDescriptorV1(final ProfileRefV1 objectStoreProfile, final byte[] container,
                                        final byte[] objectKey, final byte[] immutableObjectVersion,
                                        final byte[] etag, final long length, final byte[] payloadSha256,
                                        final byte[] reservationId, final byte[] proofId) {
    ...
    public static CommittedPayloadDescriptorV1 decode(final byte[] encoded) {
        ...
        final CommittedPayloadDescriptorV1 result = new CommittedPayloadDescriptorV1(profile, container, objectKey,
                objectVersion, etag, length, hash, reservation, proof);
    ...
    public boolean equals(final Object other) {
        return other instanceof CommittedPayloadDescriptorV1 that && length == that.length
