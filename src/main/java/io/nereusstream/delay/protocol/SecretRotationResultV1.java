...
public final class SecretRotationResultV1 {
    ...
    public SecretRotationResultV1(final ProfileRefV1 profile, final long secretGeneration,
                                  final byte[] secretReferenceDigest, final byte[] credentialBindingDigest,
                                  final long bindingHeadRevision, final byte[] bindingHeadDigest) {
    ...
    public static SecretRotationResultV1 decode(final byte[] encoded) {
        ...
        final SecretRotationResultV1 result = new SecretRotationResultV1(
                ...
                QueryCodecSupport.uint(fields.get(1), 2), QueryCodecSupport.fixed(fields.get(2), 3, 32),
                QueryCodecSupport.fixed(fields.get(3), 4, 32), QueryCodecSupport.uint64Bits(fields.get(4), 5),
    ...
    public boolean equals(final Object other) {
        return other instanceof SecretRotationResultV1 that && secretGeneration == that.secretGeneration
                && bindingHeadRevision == that.bindingHeadRevision && profile.equals(that.profile)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(profile, secretGeneration, Arrays.hashCode(secretReferenceDigest),
                Arrays.hashCode(credentialBindingDigest), bindingHeadRevision, Arrays.hashCode(bindingHeadDigest));
    }
}
