...
public final class RescheduleCommandBodyV1 {
    ...
    public RescheduleCommandBodyV1(final DelayMessageId delayMessageId, final long retryUntilEpochMs,
                                   final MessagePreconditionV1 precondition, final long newDeliverAtEpochMs,
    ...
    public static RescheduleCommandBodyV1 decode(final byte[] encoded) {
        ...
        final RescheduleCommandBodyV1 result = new RescheduleCommandBodyV1(
                ...
                QueryCodecSupport.uint(fields.get(4), 11), QueryCodecSupport.uint(fields.get(5), 12));
    ...
    public boolean equals(final Object other) {
        return other instanceof RescheduleCommandBodyV1 that && retryUntilEpochMs == that.retryUntilEpochMs
                && newDeliverAtEpochMs == that.newDeliverAtEpochMs && newExpireAtEpochMs == that.newExpireAtEpochMs
                && delayMessageId.equals(that.delayMessageId) && precondition.equals(that.precondition);
    }

    @Override
    public int hashCode() {
        return Objects.hash(delayMessageId, retryUntilEpochMs, precondition, newDeliverAtEpochMs,
                newExpireAtEpochMs);
    }
}
