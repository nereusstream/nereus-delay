...
/** Canonical typed value for the Registry KafkaReceiptSlotResourceV1 branch. */
public final class KafkaReceiptSlotResourceV1 {
    ...
    public KafkaReceiptSlotResourceV1(final String authenticatedClusterId, final UUID receiptTopicUuid,
                                      final RouteIncarnation routeIncarnation, final int shardPartition,
                                      final int receiptLaneSlot, final long slotGeneration) {
    ...
    public static KafkaReceiptSlotResourceV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields = QueryCodecSupport.read(encoded,
                "KafkaReceiptSlotResourceV1");
        QueryCodecSupport.requireNumbers(fields, new int[]{1, 2, 3, 4, 5, 6},
                "KafkaReceiptSlotResourceV1");
        final KafkaReceiptSlotResourceV1 result = new KafkaReceiptSlotResourceV1(
        ...
        QueryCodecSupport.requireCanonical(encoded, result.canonicalBytes(), "KafkaReceiptSlotResourceV1");
        return result;
    }

    private static byte[] uuidBytes(final UUID value) {
        return ByteBuffer.allocate(ID_LENGTH).putLong(value.getMostSignificantBits())
    ...
    public boolean equals(final Object other) {
        return other instanceof KafkaReceiptSlotResourceV1 that
    ...
    @Override
    public int hashCode() {
        return Objects.hash(authenticatedClusterId, receiptTopicUuid, routeIncarnation, shardPartition,
                receiptLaneSlot, slotGeneration);
    }
}
