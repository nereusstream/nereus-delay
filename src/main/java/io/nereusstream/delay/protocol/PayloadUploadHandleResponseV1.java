...
public final class PayloadUploadHandleResponseV1 {
    ...
    private PayloadUploadHandleResponseV1(final PayloadUploadHandleOutcomeV1 outcome,
    ...
    public static PayloadUploadHandleResponseV1 issued(final OpaquePayloadUploadHandleV1 handle) {
        return new PayloadUploadHandleResponseV1(PayloadUploadHandleOutcomeV1.ISSUED,
                Objects.requireNonNull(handle, "handle"), null);
    }

    public static PayloadUploadHandleResponseV1 error(final PayloadUploadHandleOutcomeV1 outcome,
                                                       final StableErrorV1 error) {
    ...
    public static PayloadUploadHandleResponseV1 decode(final byte[] encoded) {
        ...
        final PayloadUploadHandleOutcomeV1 outcome = PayloadUploadHandleOutcomeV1.fromWire(
    ...
    public boolean equals(final Object other) {
        return other instanceof PayloadUploadHandleResponseV1 that && outcome == that.outcome
                && Objects.equals(issued, that.issued) && Objects.equals(error, that.error);
    }
