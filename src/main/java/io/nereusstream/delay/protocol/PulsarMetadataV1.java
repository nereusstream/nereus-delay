...
public final class PulsarMetadataV1 {
    ...
    public PulsarMetadataV1(final byte[] partitionKey, final KeyEncoding keyEncoding,
                            final byte[] orderingKey, final List<Property> properties) {
        ...
        for (int index = 1; index < copy.size(); index++) {
            final int comparison = compareKey(copy.get(index - 1).keyUtf8(), copy.get(index).keyUtf8());
            if (comparison >= 0) {
    ...
    public static PulsarMetadataV1 decode(final byte[] encoded) {
        ...
        while (index < fields.size()) {
            if (fields.get(index).number() != 4) {
                throw new IllegalArgumentException("unexpected Pulsar metadata field " + fields.get(index).number());
            }
    ...
    public boolean equals(final Object other) {
        ...
        return Arrays.equals(partitionKey, that.partitionKey) && keyEncoding == that.keyEncoding
                && Arrays.equals(orderingKey, that.orderingKey) && properties.equals(that.properties);
    }
    ...
    public static final class Property {
        ...
        private static Property decode(final byte[] encoded) {
            ...
            final Property result = new Property(QueryCodecSupport.bytes(fields.get(0), 1),
        ...
        @Override
        public boolean equals(final Object other) {
            return other instanceof Property that && Arrays.equals(keyUtf8, that.keyUtf8)
