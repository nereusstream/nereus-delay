...
/** Canonical typed value for the Registry LocalStoreResourceV1 branch. */
public final class LocalStoreResourceV1 {
    ...
    public LocalStoreResourceV1(final ShardSubjectV1 shard, final byte[] storeIncarnation,
                                final byte[] dbIdentity, final byte[] absoluteRootPolicyDigest) {
        ...
        this.absoluteRootPolicyDigest = fixed(absoluteRootPolicyDigest, HASH_LENGTH,
                "absoluteRootPolicyDigest");
    }
    ...
    public byte[] exactResourceCanonicalBytes() {
        return CanonicalProtobuf.message(output ->
                CanonicalProtobuf.bytes(output, ResourceKind.LOCAL_STORE.wireValue(), canonicalBytes()));
    }

    public static LocalStoreResourceV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields = QueryCodecSupport.read(encoded,
                "LocalStoreResourceV1");
        QueryCodecSupport.requireNumbers(fields, new int[]{1, 2, 3, 4}, "LocalStoreResourceV1");
        final LocalStoreResourceV1 result = new LocalStoreResourceV1(
        ...
        QueryCodecSupport.requireCanonical(encoded, result.canonicalBytes(), "LocalStoreResourceV1");
        return result;
    }
    ...
    public boolean equals(final Object other) {
        return other instanceof LocalStoreResourceV1 that
    ...
    @Override
    public int hashCode() {
        return Objects.hash(shard, Arrays.hashCode(storeIncarnation), Arrays.hashCode(dbIdentity),
