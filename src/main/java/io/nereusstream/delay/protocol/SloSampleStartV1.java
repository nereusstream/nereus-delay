...
public final class SloSampleStartV1 {
    ...
    public SloSampleStartV1(final byte[] objectiveDigest, final SloObjectiveNameV1 objective,
                            ...
                            final SloSampleEventIdentityV1 eventIdentity, final SloTimeEndpointV1 start,
                            final Long timeoutAtEpochMs) {
        this(objectiveDigest, objective, population, path, eventIdentity,
                Bytes.sha256(SAMPLE_ID_DOMAIN, objectiveDigest,
                        Bytes.lp32(eventIdentity.canonicalBytes())), start, timeoutAtEpochMs, null);
    }

    private SloSampleStartV1(final byte[] objectiveDigest, final SloObjectiveNameV1 objective,
                             final SloPopulationV1 population, final SloPathV1 path,
                             final SloSampleEventIdentityV1 eventIdentity, final byte[] sampleId,
                             final SloTimeEndpointV1 start, final Long timeoutAtEpochMs,
    ...
    public static SloSampleStartV1 decode(final byte[] encoded) {
        ...
        final SloSampleStartV1 result = new SloSampleStartV1(
                QueryCodecSupport.fixed(fields.get(1), 2, HASH_LENGTH), objective,
                ...
                SloTimeEndpointV1.decode(QueryCodecSupport.nested(fields.get(7), 8)), timeout,
