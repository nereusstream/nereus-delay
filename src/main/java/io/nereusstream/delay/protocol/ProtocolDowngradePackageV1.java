...
public final class ProtocolDowngradePackageV1 {
    ...
    private static final byte[] DIGEST_DOMAIN = Bytes.utf8(
            "nereus-delay-protocol-downgrade-package-v1\0");
    ...
    public ProtocolDowngradePackageV1(final ProtocolTupleV1 fallbackTuple,
    ...
    @Override
    public int hashCode() {
        return Objects.hash(fallbackTuple, activatedTuple, Arrays.hashCode(canonicalSchemaHash),
                Arrays.hashCode(activationStateDigest), Arrays.hashCode(writerBinaryDigest),
                Arrays.hashCode(readerBinaryDigest), Arrays.hashCode(packageDigest));
    }
}
