...
/**
 * Deterministic V1 full-jitter projection used by retry decisions.
 *
 ...
 */
public final class RetryJitterV1 {
    public static final int MESSAGE_PUBLISH = 1;
    public static final int DLQ_EXPORT = 2;
    private static final byte[] DOMAIN = Bytes.utf8("nereus-delay-retry-v1");

    private RetryJitterV1() {
    }
