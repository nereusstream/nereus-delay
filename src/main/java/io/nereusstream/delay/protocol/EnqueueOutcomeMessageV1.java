...
public final class EnqueueOutcomeMessageV1 {
    ...
    private EnqueueOutcomeMessageV1(final EnqueueOutcomeKindV1 kind, final CommandQueuedReceiptV1 queued,
                                    final DefinitelyNotQueuedV1 definitelyNotQueued,
                                    final EnqueueUncertainV1 uncertain) {
        this.kind = Objects.requireNonNull(kind, "kind");
        final int branches = (queued == null ? 0 : 1) + (definitelyNotQueued == null ? 0 : 1)
                + (uncertain == null ? 0 : 1);
        if (branches != 1 || (kind == EnqueueOutcomeKindV1.QUEUED) != (queued != null)
    ...
    public static EnqueueOutcomeMessageV1 queued(final CommandQueuedReceiptV1 receipt) {
        return new EnqueueOutcomeMessageV1(EnqueueOutcomeKindV1.QUEUED, Objects.requireNonNull(receipt, "receipt"),
                null, null);
    }

    public static EnqueueOutcomeMessageV1 definitelyNotQueued(final DefinitelyNotQueuedV1 outcome) {
        return new EnqueueOutcomeMessageV1(EnqueueOutcomeKindV1.DEFINITELY_NOT_QUEUED, null,
    ...
    public static EnqueueOutcomeMessageV1 uncertain(final EnqueueUncertainV1 outcome) {
        return new EnqueueOutcomeMessageV1(EnqueueOutcomeKindV1.ENQUEUE_UNCERTAIN, null, null,
    ...
    public static EnqueueOutcomeMessageV1 decode(final byte[] encoded) {
        ...
        final EnqueueOutcomeMessageV1 result = switch (fields.get(1).number()) {
            case 10 -> {
            ...
            case 11 -> {
                ...
                yield definitelyNotQueued(DefinitelyNotQueuedV1.decode(QueryCodecSupport.nested(fields.get(1), 11)));
            }
            case 12 -> {
    ...
    public boolean equals(final Object other) {
        return other instanceof EnqueueOutcomeMessageV1 that && kind == that.kind
