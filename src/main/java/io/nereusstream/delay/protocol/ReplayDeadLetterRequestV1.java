...
public final class ReplayDeadLetterRequestV1 implements ControlOperationRequestBranchV1 {
    ...
    public ReplayDeadLetterRequestV1(final long deliverAt, final long expireAt,
    ...
    public static ReplayDeadLetterRequestV1 decode(final byte[] encoded) {
        ...
        final ReplayDeadLetterRequestV1 result = new ReplayDeadLetterRequestV1(
                QueryCodecSupport.uint(fields.get(0), 1), QueryCodecSupport.uint(fields.get(1), 2),
    ...
    public boolean equals(final Object other) {
        return other instanceof ReplayDeadLetterRequestV1 that && deliverAt == that.deliverAt
                && expireAt == that.expireAt && allowPossibleDuplicate == that.allowPossibleDuplicate
                && retryPolicy.equals(that.retryPolicy) && acknowledgements.equals(that.acknowledgements);
    }
