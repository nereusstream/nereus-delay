...
public final class ActiveMessageViewV1 implements QueryResponseBranchV1 {
    ...
    public ActiveMessageViewV1(final int generation, final long stateVersion, final MessageGenerationStateV1 state,
    ...
    public boolean equals(final Object other) {
        ...
        return generation == that.generation && stateVersion == that.stateVersion
                ...
                && binding.equals(that.binding) && payloadAvailability == that.payloadAvailability;
    }

    @Override
    public int hashCode() {
        return Objects.hash(generation, stateVersion, state, deliverAtEpochMs, expireAtEpochMs, binding,
                payloadAvailability, possibleDestinationDuplicate);
    }
}
