...
public final class PulsarJournalGenerationResourceV1 {
    ...
    public PulsarJournalGenerationResourceV1(final BrokerResourceIdentityV1 journalResource,
                                             final int partition, final long evidenceGeneration) {
    ...
    public static PulsarJournalGenerationResourceV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields = QueryCodecSupport.read(encoded,
                "PulsarJournalGenerationResourceV1");
