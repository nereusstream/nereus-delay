...
public final class CheckpointSummaryV1 {
    ...
    public CheckpointSummaryV1(final byte[] checkpointId, final byte[] manifestSha256,
                               final SourcePosition appliedSourcePosition, final long catalogGeneration,
    ...
    public static CheckpointSummaryV1 decode(final byte[] encoded) {
        final var fields = QueryCodecSupport.read(encoded, "CheckpointSummaryV1");
        QueryCodecSupport.requireNumbers(fields, new int[]{1, 2, 3, 4, 5}, "CheckpointSummaryV1");
        final CheckpointSummaryV1 result = new CheckpointSummaryV1(
    ...
    public boolean equals(final Object other) {
        return other instanceof CheckpointSummaryV1 that
                && catalogGeneration == that.catalogGeneration && recoveryFloor == that.recoveryFloor
    ...
    @Override
    public int hashCode() {
        return Objects.hash(Arrays.hashCode(checkpointId), Arrays.hashCode(manifestSha256),
                appliedSourcePosition, catalogGeneration, recoveryFloor);
    }
}
