...
public final class TargetPartitionHashV1 {
     ...
     */
    public static long partition(final ProfileRefV1 destinationProfile, final int targetPartitionCount,
        ...
        final byte[] digest = Bytes.sha256(HASH_DOMAIN, Bytes.lp32(destinationProfile.profileId()),
                Bytes.u64beBits(destinationProfile.version()), Bytes.lp32(routingBytes));
