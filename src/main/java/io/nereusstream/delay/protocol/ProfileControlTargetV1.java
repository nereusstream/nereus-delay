...
public final class ProfileControlTargetV1 {
    ...
    public ProfileControlTargetV1(final ProfileRefV1 profile, final long expectedSecretGeneration,
                                  final byte[] expectedBindingDigest, final long expectedBindingHeadRevision) {
        this(profile, Long.valueOf(expectedSecretGeneration), expectedBindingDigest,
                Long.valueOf(expectedBindingHeadRevision));
    }

    private ProfileControlTargetV1(final ProfileRefV1 profile, final Long expectedSecretGeneration,
                                   final byte[] expectedBindingDigest, final Long expectedBindingHeadRevision) {
        this.profile = Objects.requireNonNull(profile, "profile");
        final boolean any = expectedSecretGeneration != null || expectedBindingDigest != null
                || expectedBindingHeadRevision != null;
        if (any != (expectedSecretGeneration != null && expectedBindingDigest != null
                && expectedBindingHeadRevision != null)) {
    ...
    public boolean equals(final Object other) {
        return other instanceof ProfileControlTargetV1 that && profile.equals(that.profile)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(profile, expectedSecretGeneration, Arrays.hashCode(expectedBindingDigest),
