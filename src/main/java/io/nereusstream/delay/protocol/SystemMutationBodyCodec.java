...
public final class SystemMutationBodyCodec {
    ...
    private static Spec[] specs(final SystemMutationType type) {
        return switch (type) {
            ...
            case PUBLISH_ADMISSION -> new Spec[]{
                    ...
                    fixed(14, 16, true), fixed(15, DelayMessageId.LENGTH, true), varint(16), fixed(17, 32, true),
                    fixed(18, 32, true), nested(19), fixed(20, 32, true), nested(21), nested(22), nested(23),
                    nested(24), nested(25)};
            case PUBLISH_OUTCOME -> new Spec[]{
                    fixed(10, 32, true), varint(11), varint(12), varint(13), optionalNested(14), nested(15),
                    nested(16), nested(17)};
            case EXPIRE_GENERATION -> new Spec[]{fixed(10, DelayMessageId.LENGTH, true), varint(11), varint(12),
                    nested(13)};
            case EVIDENCE_RESOLUTION -> new Spec[]{
                    fixed(10, 32, true), nested(11), nested(12), varint(13), varint(14), varint(15), nested(16),
                    nested(17), nested(18)};
            ...
            case CLAIM_RESULT -> new Spec[]{
                    fixed(10, 32, true), fixed(11, DelayMessageId.LENGTH, true), varint(12), fixed(13, 32, true),
                    fixed(14, 16, true), nested(15), varint(16), varint(17), nested(18), nested(20)};
            case DLQ_EXPORT_RESULT -> new Spec[]{
                    fixed(10, 32, true), fixed(11, DelayMessageId.LENGTH, true), varint(12), varint(13),
                    fixed(14, 32, true), varint(15), varint(16), varint(17), varint(18), optionalNested(19),
                    nested(20), nested(21), nested(22), varint(23), varint(24)};
        };
    }
    ...
    private static void validateField(final CanonicalProtobuf.Reader.Field field, final Spec spec) {
        ...
        if (spec.nested()) {
            if (value.length == 0) {
                throw new IllegalArgumentException("nested System Mutation body field " + spec.number()
                        + " must not be empty");
            }
