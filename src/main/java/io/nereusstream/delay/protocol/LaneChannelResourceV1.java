...
public final class LaneChannelResourceV1 {
    ...
    public byte[] exactResourceCanonicalBytes() {
        return CanonicalProtobuf.message(output ->
                CanonicalProtobuf.bytes(output, ResourceKind.LANE_CHANNEL.wireValue(), canonicalBytes()));
    }
    ...
    public static LaneChannelResourceV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields = QueryCodecSupport.read(encoded,
                "LaneChannelResourceV1");
        QueryCodecSupport.requireNumbers(fields, new int[]{1}, "LaneChannelResourceV1");
        final LaneChannelResourceV1 result = new LaneChannelResourceV1(
                ChannelResourceIdentityV1.decode(QueryCodecSupport.nested(fields.get(0), 1)));
