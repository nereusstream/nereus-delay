...
public final class PulsarPhysicalPartitionIdentityV1 {
    ...
    public PulsarPhysicalPartitionIdentityV1(final int partition, final String physicalTopic,
    ...
    public static PulsarPhysicalPartitionIdentityV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields = QueryCodecSupport.read(encoded,
                "PulsarPhysicalPartitionIdentityV1");
    ...
    @Override
    public int hashCode() {
        return Objects.hash(partition, physicalTopic, Arrays.hashCode(resourceIncarnation),
