...
public final class ControlRegistrationOutcomeMessageV1 {
    ...
    public static ControlRegistrationOutcomeMessageV1 recorded(final ControlOperationReceiptV1 receipt) {
        return new ControlRegistrationOutcomeMessageV1(ControlRegistrationOutcomeV1.RECORDED,
                Objects.requireNonNull(receipt, "receipt"));
    }

    public static ControlRegistrationOutcomeMessageV1 definitelyNotRecorded(
            final ControlDefinitelyNotRecordedV1 value) {
        return new ControlRegistrationOutcomeMessageV1(ControlRegistrationOutcomeV1.DEFINITELY_NOT_RECORDED,
                Objects.requireNonNull(value, "value"));
    }

    public static ControlRegistrationOutcomeMessageV1 recordUncertain(final ControlRecordUncertainV1 value) {
        return new ControlRegistrationOutcomeMessageV1(ControlRegistrationOutcomeV1.RECORD_UNCERTAIN,
                Objects.requireNonNull(value, "value"));
    }
    ...
    public byte[] canonicalBytes() {
        return CanonicalProtobuf.message(output -> {
            ...
            final int field = switch (outcome) {
                case RECORDED -> 10;
                case DEFINITELY_NOT_RECORDED -> 11;
                case RECORD_UNCERTAIN -> 12;
            };
            final byte[] value = switch (branch) {
    ...
    public static ControlRegistrationOutcomeMessageV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields = QueryCodecSupport.read(encoded,
                "ControlRegistrationOutcomeMessageV1");
        ...
        final ControlRegistrationOutcomeV1 outcome = ControlRegistrationOutcomeV1.fromWire(
                QueryCodecSupport.uint(fields.get(0), 1));
        final int expectedField = switch (outcome) {
            case RECORDED -> 10;
            case DEFINITELY_NOT_RECORDED -> 11;
            case RECORD_UNCERTAIN -> 12;
        };
        ...
        final Object branch = switch (outcome) {
            case RECORDED -> ControlOperationReceiptV1.decodePayload(
                    QueryCodecSupport.nested(fields.get(1), expectedField));
            case DEFINITELY_NOT_RECORDED -> ControlDefinitelyNotRecordedV1.decode(
                    QueryCodecSupport.nested(fields.get(1), expectedField));
            case RECORD_UNCERTAIN -> ControlRecordUncertainV1.decode(
                    QueryCodecSupport.nested(fields.get(1), expectedField));
        };
    ...
    private static void validateBranch(final ControlRegistrationOutcomeV1 outcome, final Object branch) {
        final boolean valid = switch (outcome) {
    ...
    public boolean equals(final Object other) {
        return other instanceof ControlRegistrationOutcomeMessageV1 that && outcome == that.outcome
