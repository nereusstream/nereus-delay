...
public final class LaneTerminalGuardV1 {
    ...
    public LaneTerminalGuardV1(final byte[] laneIncarnation, final long laneControlVersion,
                               final SourcePosition terminalSourcePosition, final ProfileRefV1 destinationProfile,
                               final ProfileRefV1 capabilityProfile, final byte[] canonicalLaneTuple,
                               final byte[] retirementIntentId, final long retirementMutationSequence) {
    ...
    private LaneTerminalGuardV1(final DestinationLaneId laneId, final byte[] laneIncarnation,
                                final long laneControlVersion, final SourcePosition terminalSourcePosition,
                                final ProfileRefV1 destinationProfile, final ProfileRefV1 capabilityProfile,
                                final byte[] canonicalLaneTuple, final byte[] tupleDigest,
                                final byte[] retirementIntentId, final long retirementMutationSequence,
    ...
    public static LaneTerminalGuardV1 decode(final byte[] encoded) {
        ...
        if (QueryCodecSupport.uint32(fields.get(0), 1) != VERSION
                || QueryCodecSupport.uint32(fields.get(3), 4) != 5) {
        ...
        final DestinationLaneId laneId = new DestinationLaneId(QueryCodecSupport.fixed(fields.get(1), 2,
        ...
        final LaneTerminalGuardV1 result = new LaneTerminalGuardV1(laneId,
    ...
    public boolean equals(final Object other) {
        return other instanceof LaneTerminalGuardV1 that && laneControlVersion == that.laneControlVersion
    ...
    @Override
    public int hashCode() {
        return Objects.hash(laneId, Arrays.hashCode(laneIncarnation), laneControlVersion,
                terminalSourcePosition, destinationProfile, capabilityProfile, Arrays.hashCode(canonicalLaneTuple),
                Arrays.hashCode(canonicalLaneTupleSha256), Arrays.hashCode(retirementIntentId),
                retirementMutationSequence, Arrays.hashCode(guardDigest));
    }
}
