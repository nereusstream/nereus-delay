...
public final class InitialRouteControlActivatePayloadV1 {
    ...
    public InitialRouteControlActivatePayloadV1(final List<ProtocolTupleV1> protocolTuples,
    ...
    public static InitialRouteControlActivatePayloadV1 decode(final byte[] encoded) {
        final List<CanonicalProtobuf.Reader.Field> fields = QueryCodecSupport.read(encoded,
                "InitialRouteControlActivatePayloadV1", true);
        ...
        if (index + 2 != fields.size() || fields.get(index).number() != 3
        ...
        QueryCodecSupport.requireCanonical(encoded, result.canonicalBytes(),
                "InitialRouteControlActivatePayloadV1");
        return result;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(protocolTuples, profiles, initialQuotaGrant,
                Arrays.hashCode(initialControlSnapshotHash));
    }
    ...
    private static List<ProtocolTupleV1> sortedTuples(final List<ProtocolTupleV1> values) {
        ...
        result.sort(Comparator.comparing(ProtocolTupleV1::canonicalBytes,
                InitialRouteControlActivatePayloadV1::compareBytes));
