...
public final class PublicEvidenceRefV1 {
    ...
    public PublicEvidenceRefV1(final PublishEvidenceKindV1 evidenceType, final byte[] evidenceId,
    ...
    public boolean equals(final Object other) {
        ...
        return evidenceType == that.evidenceType && verificationStatus == that.verificationStatus
