...
public final class RouteControlResultV1 {
    ...
    public RouteControlResultV1(final byte[] routeUuid, final RouteLifecycleV1 lifecycle,
    ...
    public boolean equals(final Object other) {
        return other instanceof RouteControlResultV1 that && controlVersion == that.controlVersion
                && lifecycle == that.lifecycle && Arrays.equals(routeUuid, that.routeUuid);
    }
