...
public final class ControlReasonV1 {
    ...
    public ControlReasonV1(final ControlReasonKindV1 kind, final byte[] ticketReferenceHash,
                           final byte[] boundedDetailHash) {
    ...
    public boolean equals(final Object other) {
        return other instanceof ControlReasonV1 that && kind == that.kind
