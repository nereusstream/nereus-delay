...
public final class DrainShardRequestV1 implements ControlOperationRequestBranchV1 {
    ...
    public DrainShardRequestV1(final ControlReasonV1 reason, final long maxDrainWaitMs,
                               final boolean requestFinalCheckpoint) {
    ...
    public static DrainShardRequestV1 decode(final byte[] encoded) {
        ...
        final DrainShardRequestV1 result = new DrainShardRequestV1(
                ...
                QueryCodecSupport.uint(fields.get(1), 2), QueryCodecSupport.bool(fields.get(2), 3));
    ...
    public boolean equals(final Object other) {
        return other instanceof DrainShardRequestV1 that && maxDrainWaitMs == that.maxDrainWaitMs
                && requestFinalCheckpoint == that.requestFinalCheckpoint && reason.equals(that.reason);
    }
