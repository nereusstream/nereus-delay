 ...
 */
public final class ReservedPublishMetadataV1 {
    ...
    public ReservedPublishMetadataV1(final RouteIncarnation routeIncarnation, final long shardPartition,
                                     ...
                                     final long deliverAtEpochMs, final DeliveryMode deliveryMode) {
        ...
        this.destinationProfileSemanticHash = fixed(destinationProfileSemanticHash,
                "destinationProfileSemanticHash");
        this.capabilityProfileSemanticHash = fixed(capabilityProfileSemanticHash,
    ...
    public static ReservedPublishMetadataV1 decode(final byte[] encoded) {
        final var fields = QueryCodecSupport.read(encoded, "ReservedPublishMetadataV1");
        QueryCodecSupport.requireNumbers(fields, new int[]{1, 2, 3, 4, 5, 6, 7, 8, 9},
                "ReservedPublishMetadataV1");
        final ReservedPublishMetadataV1 result = new ReservedPublishMetadataV1(
        ...
        QueryCodecSupport.requireCanonical(encoded, result.canonicalBytes(), "ReservedPublishMetadataV1");
        return result;
    }
    ...
    public boolean equals(final Object other) {
        if (!(other instanceof ReservedPublishMetadataV1 that)) {
            return false;
        }
        return shardPartition == that.shardPartition && generation == that.generation
                && deliverAtEpochMs == that.deliverAtEpochMs && routeIncarnation.equals(that.routeIncarnation)
                && messageId.equals(that.messageId) && deliveryMode == that.deliveryMode
    ...
    @Override
    public int hashCode() {
        return Objects.hash(routeIncarnation, shardPartition, messageId, generation,
                Arrays.hashCode(publishAttemptId), Arrays.hashCode(destinationProfileSemanticHash),
                Arrays.hashCode(capabilityProfileSemanticHash), deliverAtEpochMs, deliveryMode);
    }
}
