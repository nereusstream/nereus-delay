...
public final class CapacityVectorV1 {
    ...
    public static CapacityVectorV1 decode(final byte[] encoded) {
        ...
        for (int index = 0; index < CapacityDimensionV1.COUNT; index++) {
            ...
            final List<CanonicalProtobuf.Reader.Field> amount = QueryCodecSupport.read(
                    amountField.rawValue(), "CapacityAmountV1");
    ...
    public boolean equals(final Object other) {
        return other instanceof CapacityVectorV1 that && Arrays.equals(amounts, that.amounts)
