...
public final class ShardControlResultV1 {
    ...
    public ShardControlResultV1(final ShardSubjectV1 shard, final ShardLifecycleStateV1 lifecycle,
    ...
    public boolean equals(final Object other) {
        return other instanceof ShardControlResultV1 that && shard.equals(that.shard)
                && lifecycle == that.lifecycle && Objects.equals(ownerEpoch, that.ownerEpoch)
