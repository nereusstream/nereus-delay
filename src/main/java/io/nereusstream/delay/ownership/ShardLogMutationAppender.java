...
public interface ShardLogMutationAppender {
    ...
    record AppendOutcome(AppendDisposition disposition, SourcePosition sourcePosition,
        ...
        public static AppendOutcome persisted(final SourcePosition position,
            ...
            return new AppendOutcome(AppendDisposition.PERSISTED, Objects.requireNonNull(position, "position"),
