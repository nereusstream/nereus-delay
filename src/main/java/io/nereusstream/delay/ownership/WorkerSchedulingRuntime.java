...
public final class WorkerSchedulingRuntime {
    ...
    public WorkerSchedulingRuntime(final WorkClassExecutionRegistry workClasses,
        ...
        this.dueExecutor = new DueSchedulerWorkClassExecutor(this.workClasses, this.ownedShard,
    ...
    public static WorkerSchedulingRuntime openForActiveOwner(
        ...
        final PersistentLaneScheduler scheduler = PersistentLaneScheduler.forActiveOwner(
                Objects.requireNonNull(store, "store"), Objects.requireNonNull(owner, "owner"),
                Objects.requireNonNull(activeLanes, "activeLanes"));
        final WorkerSchedulingRuntime runtime = new WorkerSchedulingRuntime(workClasses, ownedShard,
                authority, scheduler);
     ...
     */
    public DueTurn runDueTurn(final TrustedUtcIntervalEvidence evidence,
        ...
        final List<WorkClassTask> completed = workClasses.runTurn(new SchedulerBudget(
                1, submission.task().bytes(), Long.MAX_VALUE));
     ...
     */
    public List<ScheduleWorkItem> pollReady(final TrustedUtcIntervalEvidence evidence,
                                            final SchedulerBudget budget,
                                            final LongSupplier ownerClock) {
        return ownedShard.pollReadyAuthoritativelyStrict(authority, scheduler,
                Objects.requireNonNull(evidence, "evidence"),
    ...
    public record DueTurn(WorkClassTask task, List<WorkClassTask> completedTasks,
                          List<ScheduleWorkItem> discoveredItems) {
        public DueTurn {
