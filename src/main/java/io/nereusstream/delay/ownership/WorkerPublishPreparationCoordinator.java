 ...
 */
public final class WorkerPublishPreparationCoordinator
        implements WorkerShardRuntime.PublishPreparationProvider {
    ...
    public WorkerPublishPreparationCoordinator(final OwnedDelayShard ownedShard,
        ...
        this.prerequisiteAuthority = Objects.requireNonNull(prerequisiteAuthority,
    ...
    public Optional<WorkerCommandRuntime.PublishPreparation> prepare(
        ...
        if (exactResult.kind() != ClaimHandoffWorkClassExecutor.ResultKind.CLAIMED
                || exactResult.claim() == null || exactResult.reservation() == null) {
        ...
        if (lane == null || lane.admissionGate() != AdmissionGate.OPEN
    ...
    private static void validateClaimBinding(final ClaimRecord claim,
        ...
        if (!claim.materialization().targetResource().equals(channel.targetResource())
                ...
                || !channel.targetResource().equals(certificate.activationBarrier().resource())
                || channel.physicalPartition() != certificate.activationBarrier().partition()) {
    ...
    public record PreparationRequest(ClaimRecord claim,
