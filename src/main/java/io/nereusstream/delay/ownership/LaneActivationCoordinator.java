...
public final class LaneActivationCoordinator {
    ...
    public LaneActivationCoordinator(final OwnedDelayShard ownedShard,
     ...
     */
    public LaneRecord activate(final DestinationLaneId laneId, final long nowEpochMs,
        ...
        final LaneActivationPrerequisites prerequisites = Objects.requireNonNull(
                Objects.requireNonNull(prerequisiteAuthority, "prerequisiteAuthority").prepare(request),
    ...
    public record ActivationRequest(DestinationLaneId laneId,
        ...
        public ActivationRequest {
            ...
            laneIncarnation = io.nereusstream.delay.protocol.Bytes.copy(
                    Objects.requireNonNull(laneIncarnation, "laneIncarnation"));
            owner = Objects.requireNonNull(owner, "owner");
            storeIncarnation = io.nereusstream.delay.protocol.Bytes.copy(
        ...
        public byte[] laneIncarnation() {
            return io.nereusstream.delay.protocol.Bytes.copy(laneIncarnation);
        }

        @Override
        public byte[] storeIncarnation() {
            return io.nereusstream.delay.protocol.Bytes.copy(storeIncarnation);
        }
    }
}
