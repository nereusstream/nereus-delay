...
public final class OxiaSyncControlOperationBackend implements OxiaControlOperationAuthority.CasBackend {
    ...
    public ControlOperationQueryResponseV1 register(final ControlOperationReceiptV1 receipt,
        ...
        try {
            ...
            return observed == null ? ControlOperationQueryResponseV1.integrityError()
    ...
    public ControlOperationQueryResponseV1 advance(final ControlOperationReceiptV1 receipt,
        ...
        if (expectedRevision <= 0 || expectedRevision == Long.MAX_VALUE) {
            return expectedRevision <= 0 ? ControlOperationQueryResponseV1.invalidReceipt()
    ...
    private static ControlOperationQueryResponseV1 classifyRegistration(final Entry existing,
    ...
    private static void validateTransition(final CurrentControlOperationV1 current,
                                           final CurrentControlOperationV1 next) {
        try {
    ...
    private static boolean exact(final Entry entry, final ControlOperationReceiptV1 receipt,
    ...
    private static byte[] encode(final ControlOperationReceiptV1 receipt,
                                 final CurrentControlOperationV1 current) {
