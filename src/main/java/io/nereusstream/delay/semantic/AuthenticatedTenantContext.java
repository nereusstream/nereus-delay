...
public final class AuthenticatedTenantContext {
    ...
    public AuthenticatedTenantContext(final byte[] authenticatedTenantScopeHash, final byte[] tenantRoutingScope,
    ...
    @Override
    public int hashCode() {
        return Objects.hash(Arrays.hashCode(authenticatedTenantScopeHash), Arrays.hashCode(tenantRoutingScope),
