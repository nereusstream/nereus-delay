...
public final class LargeSchedulePreparationV1 {
    ...
    public LargeSchedulePreparationV1(final ScheduleIntentV1 intentWithoutPayload,
        ...
        io.nereusstream.delay.protocol.Bytes.requireLength(payloadSha256, 32, "payloadSha256");
        this.payloadSha256 = io.nereusstream.delay.protocol.Bytes.copy(payloadSha256);
    ...
    public byte[] payloadSha256() {
        return io.nereusstream.delay.protocol.Bytes.copy(payloadSha256);
    }
    ...
    public boolean equals(final Object other) {
        return other instanceof LargeSchedulePreparationV1 that
                ...
                && reservationTtlMs == that.reservationTtlMs && trustSet.equals(that.trustSet)
                && objectStoreProfile.equals(that.objectStoreProfile);
    }

    @Override
    public int hashCode() {
        return Objects.hash(intentWithoutPayload, expectedPayloadLength, Arrays.hashCode(payloadSha256),
                reservationTtlMs, trustSet, objectStoreProfile);
    }
}
