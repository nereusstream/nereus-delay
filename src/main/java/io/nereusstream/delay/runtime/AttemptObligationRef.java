...
public final class AttemptObligationRef {
    ...
    public AttemptObligationRef(final byte[] publishAttemptId, final int generation,
        ...
        this.refDigest = digest(this.publishAttemptId, generation, ledgerState, this.encodedInflightKey,
                this.inflightKeySha256);
    }

    private AttemptObligationRef(final byte[] publishAttemptId, final int generation,
                                 final AttemptLedgerState ledgerState, final byte[] encodedInflightKey,
                                 final byte[] inflightKeySha256, final byte[] refDigest) {
    ...
    public static AttemptObligationRef decode(final byte[] encoded) {
        ...
        final AttemptObligationRef result = new AttemptObligationRef(id, (int) generation, state, key, keyHash,
                digest);
    ...
    private static byte[] digest(final byte[] id, final int generation, final AttemptLedgerState state,
    ...
    public boolean equals(final Object other) {
        ...
        return generation == that.generation && ledgerState == that.ledgerState
