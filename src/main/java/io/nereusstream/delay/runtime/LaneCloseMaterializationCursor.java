...
public final class LaneCloseMaterializationCursor {
    ...
    public LaneCloseMaterializationCursor(final DestinationLaneId laneId, final byte[] laneIncarnation,
                                          final long closeVersion, final byte[] closeSourcePosition,
                                          final Phase phase, final byte[] lastKey,
        ...
        if (transferredPendingMessages < 0 || transferredPendingBytes < 0
                || transferredReservationMessages < 0 || transferredReservationBytes < 0) {
    ...
    public LaneCloseMaterializationCursor advance(final byte[] nextLastKey) {
        return new LaneCloseMaterializationCursor(laneId, laneIncarnation, closeVersion, closeSourcePosition,
                phase, nextLastKey, transferredPendingMessages, transferredPendingBytes,
                transferredReservationMessages, transferredReservationBytes);
    }
    ...
    public LaneCloseMaterializationCursor nextPhase() {
        ...
        return new LaneCloseMaterializationCursor(laneId, laneIncarnation, closeVersion, closeSourcePosition,
                Phase.RESERVATIONS, null, transferredPendingMessages, transferredPendingBytes,
                transferredReservationMessages, transferredReservationBytes);
    }
    ...
    public static LaneCloseMaterializationCursor decode(final byte[] encoded) {
        ...
        final LaneCloseMaterializationCursor result = new LaneCloseMaterializationCursor(
                new DestinationLaneId(fixed(lane, 32, "laneId")), fixed(incarnation, 16, "laneIncarnation"),
                closeVersion, source, phase, lastKey, transferredPendingMessages, transferredPendingBytes,
                transferredReservationMessages, transferredReservationBytes);
