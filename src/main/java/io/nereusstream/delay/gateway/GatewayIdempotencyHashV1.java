...
public final class GatewayIdempotencyHashV1 {
    ...
    public static Digest32 retryRequestHash(final Digest32 keyHash,
                                             final PhysicalEnqueueAttemptId expectedPrior,
                                             final PhysicalEnqueueAttemptId retryRequestId) {
        return new Digest32(Bytes.sha256(Bytes.utf8("nereus-delay-gateway-retry-request-v1\0"),
                keyHash.bytes(), expectedPrior.bytes(), retryRequestId.bytes()));
    }
}
