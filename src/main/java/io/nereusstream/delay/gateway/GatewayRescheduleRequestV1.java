...
public record GatewayRescheduleRequestV1(byte[] idempotencyKey, DelayMessageId delayMessageId,
                                         MessagePreconditionV1 messagePrecondition, long deliverAtEpochMs,
    ...
    public GatewayRescheduleRequestV1 {
        ...
        if (deliverAtEpochMs < 0 || expireAtEpochMs < 0 || retryUntilEpochMs < 0
