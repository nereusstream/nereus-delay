...
final class GatewayAdmissionRecordV1 {
    ...
    static GatewayAdmissionRecordV1 decode(final byte[] encoded) {
        ...
        if (fields.size() < 4 || field(fields, 0, 1).wireType() != 0
                || field(fields, 1, 2).wireType() != 2 || field(fields, 2, 3).wireType() != 0) {
    ...
    static final class Lease {
        ...
        Lease(final byte[] leaseId, final GatewayIngressOperationV1 operation,
              final long estimatedRequestBytes, final long expiresAtEpochMs) {
