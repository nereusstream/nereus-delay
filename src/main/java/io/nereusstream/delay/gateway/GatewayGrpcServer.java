...
public final class GatewayGrpcServer implements AutoCloseable {
    ...
    public static GatewayGrpcServer create(final ServerBuilder<?> serverBuilder,
    ...
    public static GatewayGrpcServer mutualTls(final int port, final Path certificateChain,
                                              final Path privateKey, final Path trustedClientCertificates,
                                              final GatewayGrpcService service) throws IOException {
