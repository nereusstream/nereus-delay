...
public record GatewayRetryUncertainRequestV1(byte[] originalIdempotencyKey,
                                             PhysicalEnqueueAttemptId expectedPriorPhysicalAttemptId,
                                             PhysicalEnqueueAttemptId retryRequestId) {
    public GatewayRetryUncertainRequestV1 {
        ...
        expectedPriorPhysicalAttemptId = Objects.requireNonNull(expectedPriorPhysicalAttemptId,
