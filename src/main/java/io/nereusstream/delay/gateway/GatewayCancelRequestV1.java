...
public record GatewayCancelRequestV1(byte[] idempotencyKey, DelayMessageId delayMessageId,
                                     MessagePreconditionV1 messagePrecondition, long retryUntilEpochMs) {
