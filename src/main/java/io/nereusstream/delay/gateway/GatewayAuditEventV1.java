 ...
 */
public record GatewayAuditEventV1(GatewayIngressOperationV1 operation, Digest32 gatewayKeyHash,
                                  Digest32 requestBodyHash, GatewayAuditPhaseV1 phase,
                                  Digest32 outcomeHash, long observedAtEpochMs) {
    ...
    public static GatewayAuditEventV1 completed(final GatewayIngressOperationV1 operation,
                                                final Digest32 gatewayKeyHash,
                                                final Digest32 requestBodyHash,
                                                final byte[] outcomeBytes,
                                                final long observedAtEpochMs) {
        return new GatewayAuditEventV1(operation, gatewayKeyHash, requestBodyHash,
                GatewayAuditPhaseV1.COMPLETED, new Digest32(Bytes.sha256(outcomeBytes)), observedAtEpochMs);
    }
}
