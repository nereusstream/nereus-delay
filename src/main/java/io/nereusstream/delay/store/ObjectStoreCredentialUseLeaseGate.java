...
public final class ObjectStoreCredentialUseLeaseGate {
    ...
    public void requireBeforeProviderCall() {
        ...
        if (!Bytes.constantTimeEquals(current.loadedCredentialFingerprintDigest(),
    ...
    public synchronized void replace(final CredentialBindingProtectionV1 protection,
                                     final CredentialUseLeaseV1 lease,
                                     final byte[] loadedCredentialFingerprintDigest) {
    ...
    private record Projection(CredentialBindingProtectionV1 protection, CredentialUseLeaseV1 lease,
                              byte[] loadedCredentialFingerprintDigest) {
        private Projection {
            Objects.requireNonNull(protection, "protection");
            Objects.requireNonNull(lease, "lease");
            loadedCredentialFingerprintDigest = fixed(loadedCredentialFingerprintDigest,
