...
final class OxiaSessionBoundRecoveryPinStore {
    ...
    RecoveryPinV1 create(final RecoveryPinV1 pin, final Runnable validateRequest,
                         final LongSupplier currentCatalogGeneration) {
            ...
            try {
                if (!client.delete(pinRecordKey, Set.of(DeleteOption.IfVersionIdEquals(
                    ...
                    throw new IllegalStateException(
                            "RecoveryPin delete returned false while the pin remained active");
                }
    ...
    private static void requireCatalogGeneration(final RecoveryPinV1 pin,
                                                 final LongSupplier currentCatalogGeneration) {
