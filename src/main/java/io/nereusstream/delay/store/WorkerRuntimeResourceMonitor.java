...
public final class WorkerRuntimeResourceMonitor implements AutoCloseable {
    ...
    public static WorkerRuntimeResourceMonitor start(final Path rootPath,
                                                     final Duration interval,
                                                     final SharedRocksDbResources resources) {
        Objects.requireNonNull(rootPath, "rootPath");
        Objects.requireNonNull(resources, "resources");
        final WorkerRuntimeResourceMonitor monitor = new WorkerRuntimeResourceMonitor(interval,
                () -> WorkerRuntimeResourceProbe.observe(rootPath), resources::revalidateRuntime,
                resources::recordRuntimeProbeFailure, daemonThreadExecutor());
        monitor.start();
        return monitor;
    }
     ...
     */
    WorkerRuntimeResourceMonitor(final Duration interval,
    ...
    public synchronized void start() {
        ...
        scheduledProbe = executor.scheduleWithFixedDelay(this::runScheduledProbe, 0, intervalNanos,
