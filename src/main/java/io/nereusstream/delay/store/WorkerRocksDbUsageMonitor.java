...
public final class WorkerRocksDbUsageMonitor implements AutoCloseable {
    ...
    private final AtomicReference<List<RocksDbUsageSnapshot>> lastObservation =
    ...
    public static WorkerRocksDbUsageMonitor start(final Duration interval,
        ...
        final WorkerRocksDbUsageMonitor monitor = new WorkerRocksDbUsageMonitor(interval, probe, failureConsumer,
    ...
    WorkerRocksDbUsageMonitor(final Duration interval,
                              final Supplier<List<RocksDbUsageSnapshot>> probe,
                              final Consumer<Throwable> failureConsumer,
