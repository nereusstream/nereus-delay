...
public final class RenewableS3CompatibleCheckpointObjectStoreAdapter
    ...
    public RenewableS3CompatibleCheckpointObjectStoreAdapter(
        ...
        if (maximumLeaseTtlMs <= 0 || maximumAttestationAgeMs <= 0 || renewBeforeMs <= 0
        ...
        this.renewalEvidenceSupplier = Objects.requireNonNull(renewalEvidenceSupplier,
    ...
    void renewIfNeeded() {
        ...
        final CredentialBindingHeadV1 head = Objects.requireNonNull(authority.resolveHead(profile.ref()),
                "Object Store Profile has no renewal Head");
        ...
        final CredentialBindingV1 currentBinding = Objects.requireNonNull(authority.resolveBinding(profile.ref(),
                head.secretGeneration()), "Object Store Profile has no renewal binding");
        ...
        final OxiaObjectStoreCredentialLeaseActivator.ObjectStoreCredentialMaterial material =
                Objects.requireNonNull(materialResolver.resolve(currentProfile, currentBinding),
                        "Object Store renewal material");
        ...
        final TrustedUtcIntervalEvidence evidence = Objects.requireNonNull(renewalEvidenceSupplier.get(),
                "Object Store renewal evidence");
        ...
        final CredentialUseLeaseV1 renewedLease = Objects.requireNonNull(authority.issueCredentialUseLease(
                profile.ref(), CredentialUseKindV1.OBJECT_STORE_ADAPTER, holderScopeDigest,
                binding.secretGeneration(), binding.bindingDigest(), material.resolvedCredentialFingerprintDigest(),
                evidence, validUntil, head.headRevision()), "Object Store renewed credential lease");
        final CredentialBindingProtectionV1 protection = Objects.requireNonNull(authority.resolveProtection(
                profile.ref(), renewedLease.secretGeneration()), "Object Store renewed protection");
