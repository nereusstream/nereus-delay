...
therefore remain `release_status=NOT_READY`; no V1 promotion or release
...
full-V1 `PASS_CERTIFIED` inputs passed.
...
`/Users/liusinan/.Trash/nereus-delay-cleanup-20260822-full-v1` after `.git`
