...
4. [Target 身份与索引契约](05-Target身份与索引契约.md)：B1 已固定的物理身份、key、queue/domain/head/work/Message/runtime/Expiry 编码及拒绝边界。
...
摘要、generation 历史、完整可逆 work、消息定位和 SourcePosition 边界已有独立向量；
完整 Message/runtime/Expiry 编码已加入；ORDER_STATE、ref/mutation 对象及激活仍未完成。当前进展不等于 Target 新架构或完整方案完成。
