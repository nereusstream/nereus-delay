...
4. [Target 身份与索引契约](05-Target身份与索引契约.md)：B1 已固定的物理身份、key、queue/domain/head/work/locator 编码及拒绝边界。
...
完整 Message/Expiry/ORDER_STATE、ref 对象及激活仍未完成。当前进展不等于 Target 新架构或完整方案完成。
