...
An operator may choose a documented disaster override that accepts data loss or duplicates, but it creates a new Route Incarnation and visible audit boundary. It is not normal recovery and cannot reuse old receipts as though continuity were proven.
