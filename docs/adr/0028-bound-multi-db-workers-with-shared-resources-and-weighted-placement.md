...
Nereus Delay accepts the costs of independent WALs, MANIFESTs, file sets, memtables, and inability to group-sync across DBs. Only benchmark evidence may justify a future fixed `ShardBundle`, and that Bundle must become the explicit ownership/checkpoint/restore/migration unit.
