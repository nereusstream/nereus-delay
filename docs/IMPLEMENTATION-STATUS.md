...
are covered by `WorkerRuntimeResourceMonitorTest`. Native bucket attribution,
per-work-class reserve enforcement and full write-time admission authority
