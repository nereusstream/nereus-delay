...
| Recovery Set/Floor, catalog and restore replay | In progress (typed and crash-durable local catalog/Floor subset) | release blocker; Oxia catalog/session pin, immutable publication, source/evidence replay and activation CAS remain |
