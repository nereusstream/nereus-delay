...
| System Mutation envelope, type registry, canonical hash/ID and Ed25519 signature | Implemented (outer envelope/common-body subset) | `SystemMutationType`, `SystemMutation`, `AuthorIdentity`, `ProtocolCodecTest`; canonical owner/control/fence/service branches and body fields 1–3/10+ prefix consistency are covered; operation-specific mutation bodies, signing-key trust/ACL checks and source-ordered application remain pending |
