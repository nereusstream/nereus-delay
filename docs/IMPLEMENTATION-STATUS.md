...
Lane counter restore validates the complete registered subset before applying
any entry, so a malformed later counter cannot partially restore an earlier Lane
