...
through the canonical codec and checkpoint `createdAt` JSON; other auxiliary
uint64/time fields plus real Broker adapter proof remain release blockers.
