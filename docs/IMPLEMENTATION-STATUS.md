...
| Registry-shaped `ScheduleIntentV1` | Implemented (canonical codec plus resolver-backed local apply; external authority pending) | `ScheduleIntentV1`, `ScheduleCommandBodyV1`, `CommandBodies.scheduleV1/decodeScheduleV1`, `PreparedCommand.scheduleV1`, `CommandCodec.encode/decode*V1`, `V1ScheduleResolver`, `V1CommandResolutionException`, `V1ScheduleBinding`, `KeyCodec.idV1ScheduleBinding`, `DelayShard`, `ScheduleIntentV1Test`, `ClientCommandBodyV1Test`, `PreparedCommandV1Test`, `V1ScheduleBindingTest`, `DelayShardTest`; exact field order/oneof/presence, common fields 1–3, outer/body message identity/type/retry binding, tuple-derived Lane, resolver-required fail-closed route snapshot, inline payload projection, canonical body/tuple binding persistence and reopen checks are covered; source-position Profile/Retry activation, full historical binding and production profile/adapter authority remain pending, and the current compatibility `PayloadReference` projection requires a non-null descriptor etag |
