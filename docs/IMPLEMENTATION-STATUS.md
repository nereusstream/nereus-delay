...
covers the guard. The legacy constructor remains an embedded compatibility seam;
production wiring still must supply the required §21 envelope, and evidence-gap
classification, Start reconstruction from Message/Admission authority, collector
