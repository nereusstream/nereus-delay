...
reservation identity's legal source-ordered lifecycle transition. A previously
...
cover this bounded adapter behavior. It does not close the full durable
reservation-binding migration needed to reconstruct the original Prepare
anchor after an adapter/service restart.
