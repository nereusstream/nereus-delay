...
explicit probe/wiring seam: automatic probe scheduling, native bucket
attribution, per-work-class reserve enforcement and full write-time admission
authority remain separate release gates.
