...
subject. The source-ordered control applier still fail-closes the evidence
attachment branches until their full result and retry/charge projection is
available.
