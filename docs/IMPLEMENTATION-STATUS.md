...
| NDR1 receipt frame | Implemented (payload codecs pending) | `ReceiptFrame`, `ReceiptKind`, registry zero-payload vector and flags/length/kind/CRC/Base64url rejection tests; queued/applied/native/control payload schemas remain pending |
