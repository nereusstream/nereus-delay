...
multi-Broker failover, checkpoint publication, multi-shard placement or V1
...
remains `PARTIAL`, and V1 remains `NOT READY`.
...
9 remain `OPEN`, Gate 8 remains `PARTIAL`, and V1 remains `NOT READY` pending
...
`/Users/liusinan/.Trash/nereus-delay-cleanup-20260822-full-v1` after a `.git`
