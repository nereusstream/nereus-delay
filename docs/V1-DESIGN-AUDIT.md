...
Delay commit `a73faf3e836ada67931f709d46214dde7caf3ad0` adds a real-client
...
captures the first guarded SUBSCRIBE position and stable attestation, derives
...
post-barrier source ACK. It does not promote the result to production Route
